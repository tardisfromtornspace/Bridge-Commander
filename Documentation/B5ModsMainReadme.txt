...
===Mods required===
* Foundation, Nanofx2, Submenu v 3.0, QBAutostart, DS9FX, Galaxy Charts and Kobayashi Maru mod, the latest version the better (*** Kobayashi Maru already has those ***), you will also probably need the GalaxyCharts Warp AI fix as well (KM may NOT have that one pre-installed).

* All the babylon 5 mods (https://www.gamefront.com/games/bridge-commander/category/babylon5 mostly) mentioned above, on reverse order (NONE of the ones called "Remastered"). The following is a repeated list from above:
  - Fighter Launchable Babylon 5 (https://www.gamefront.com/games/bridge-commander/file/fighter-launchable-b5-station) by TiqHud, Brad Bowermaster, Wok, Crook, Cordanilus and MScott.
  - Thunderbolt (https://www.gamefront.com/games/bridge-commander/file/thunderbolt) by TiqHud, Wok, Bravo Int.
  - Aurora Class Starfury (https://www.gamefront.com/games/bridge-commander/file/aurora-class-starfury) by MadJohn, Crook and the http://www.b5tech.net team and the Homeworld mod teams.
  - Minbari Sharlin (https://www.gamefront.com/games/bridge-commander/file/minbari-sharlin-class-dreadnought) by Maryam, baz1701 and limey98 and Dalek. NOTE: NOT MSR1701's version.
  - B5 Centauri Vorchan (https://www.gamefront.com/games/bridge-commander/file/b5-centauri-vorchan) by TiqHud, Wok, Jackal and Captain Russel.
  - B5 Centauri Warship (latter also known as Centauri Primus, https://www.gamefront.com/games/bridge-commander/file/b5-centauri-warship) by TiqHud, Wok, Jackal and Captain Russel.
  - Babylon 5 - Bluestar (https://www.gamefront.com/games/bridge-commander/file/babylon-5-bluestar) by Nadab Göksu, Kier Darby, Thunderchild, DamoclesX, TiqHud, aobob, junky58 and BCU people (the latest 4 are beta testers).
  - Babylon 5 Whitestar (https://www.gamefront.com/games/bridge-commander/file/babylon-5-whitestar) by Nadab Göksu, Kier Darby, Thunderchild, DamoclesX, TiqHud, aobob, junky58 and BCU people (the latest 4 are beta testers).
  - Narn - ThNor (https://www.gamefront.com/games/bridge-commander/file/narn-thnor-1) by TiqHud, Wok, Lord Malek and the original Babylon 5 visual effects artists mentioned before.
  - Narn G'quan (https://www.gamefront.com/games/bridge-commander/file/narn-g-quan-1) by TiqHud, stresspuppy, Queball.
  - Drakh Raider (https://www.gamefront.com/games/bridge-commander/file/drakh-raider) by TiqHud, Wok, Jackal Tiger, Nadab, Lord Malek and the original Babylon 5 visual effects artists mentioned before.
  - Omega Class Destroyer (https://www.gamefront.com/games/bridge-commander/file/omega-class-destroyer) by MadJohn and Spooky.
  - B5 Warlock (https://www.gamefront.com/games/bridge-commander/file/b5-warlock) by DamoclesX and Durandal.
  - Babylon5 Victory (https://www.gamefront.com/games/bridge-commander/file/babylon5-victory) by DamoclesX and Durandal.
  - Shadow Battlecrab (https://www.gamefront.com/games/bridge-commander/file/shadow-battlecrab) by Sci-Fi DreamYards, Cpt. LC Amaral, Maverick, Executioner_de.
  - Centauri Sentri fighter (no hardpoints, https://www.gamefront.com/games/bridge-commander/file/centauri-sentri-fighter) by Wok and Bravo Int.
  - Vorlon Fighter (no hardpoints, https://www.gamefront.com/games/bridge-commander/file/vorlon-fighter) by Wok, Jackal and the B5 Sci-fi show.

** You will need them downloaded (NOT installed yet, read the instalation guide). Please note that at the time I downloaded the mods from NexusMods, so the content may have been different (they shoulldn't be for the most part, but if any issues arise, do not hesitate to contact me), **but** some of them conflicted with each other due to Caps issue (i.e. EAOmega - eaomega), certain shuttle quirks and BCMMods affected certain filenames and inner files, which back when I was a newbie took me 3 years to fix, made that unadvisable. What I recommend to do is to do the following: 
** -- 1st - get those mods downloaded and unzipped/unpacked on a temp folder ("TEMP FOLDER A"), grab ONLY the data and sfx folders, make sure they follow the proper folder names, case-sensitive (i.e. they should be called "Icons", not "icons" nor "icon", example on the G'Quan where that bug happened), icon names, model names and sound names (some, when legally allowed, seen inside this super-pack. They are meant to be placeholders so the correct case-sensitive names work).
** -- 2nd - then, after ensuring all the files are there, copy the unzipped super-pack to another temp folder (let's call it "temp folder SuP").
** -- 3rd - then copy the data and sfx fixed folders from those mods (from "TEMP FOLDER A") to "temp folder SuP",
