...
Author:
	...
	Model/Textures: WickedZombie45

	Design: Atolm & WickedZombie45

	Demon Renegade Studios

Ship Name: Slaughter - Orion Vagabond Class Heavy Cruiser
...
Race: Orion/Pirate/Non-Aligned/Miscellaneous
...
7.) If you're going to use a ship in a mod, do not delete the readme file or remove it from the ship's folder. Various mod makers tend to do this and simply list the modders in one big readme. This tends to remove any clear source of credits for an individual ship and should the ship fall into other's hands, it creates more confusion. I don't include readmes just for tradition's sake and the purpose for them is to make sure there's a traceable credit history for whoever is involved in the ship's creation.

8.) All work on this site is property of the respective owners. If anyone attempts to steal or take credit for work they did not do, I will hunt you down and feed you to a pack of bloodthirsty wolves.
...
Star Trek, Star Fleet Command, Star Trek: Deep Space Nine, Star Trek: The Next Generation, Star Trek: Voyager, Star Trek: Enterprise (and the various logo devices used in them) are copyright Paramount Pictures, as are the characters, related images, and sound from the productions.

These files are not supported or affiliated with Interplay Productions or Activision. While most who have used these files have had no problems, we will not be held accountable for any damage done to your computer by use of these files or techniques. USE AT YOUR OWN RISK! These files are freeware. They are not to be sold or used in any for-profit venture.

All works on this site are the intellectual property of their respective creators and are subject to legal protection under copyright. It is not to be used, altered, or redistributed without their consent.