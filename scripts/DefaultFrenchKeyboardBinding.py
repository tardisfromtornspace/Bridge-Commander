...
def Initialize():
		...
		App.g_kKeyboardBinding.BindKey(App.WC_A_GRAVE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 0)
		App.g_kKeyboardBinding.BindKey(App.WC_AMPERSAND, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 1.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_E_ACUTE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 2.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_DOUBLE_QUOTE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 3.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_QUOTE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 4.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_OPEN_PAREN, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 5.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_MINUS, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 6.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_E_GRAVE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 7.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_UNDERSCORE, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 8.0/9.0)
		App.g_kKeyboardBinding.BindKey(App.WC_C_CEDILLA, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_SET_IMPULSE, App.KeyboardBinding.GET_FLOAT_EVENT, 9.0/9.0)

		App.g_kKeyboardBinding.BindKey(App.WC_1, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_SET_ALERT_LEVEL, App.KeyboardBinding.GET_INT_EVENT, App.CharacterClass.EST_ALERT_GREEN)
		App.g_kKeyboardBinding.BindKey(App.WC_2, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_SET_ALERT_LEVEL, App.KeyboardBinding.GET_INT_EVENT, App.CharacterClass.EST_ALERT_YELLOW)
		App.g_kKeyboardBinding.BindKey(App.WC_3, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_SET_ALERT_LEVEL, App.KeyboardBinding.GET_INT_EVENT, App.CharacterClass.EST_ALERT_RED)
		...
		App.g_kKeyboardBinding.BindKey(App.WC_W, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_ZOOM_TARGET, App.KeyboardBinding.GET_BOOL_EVENT, 1)
		App.g_kKeyboardBinding.BindKey(App.WC_W, App.TGKeyboardEvent.KS_KEYUP, App.ET_INPUT_ZOOM_TARGET, App.KeyboardBinding.GET_BOOL_EVENT, 0)

		App.g_kKeyboardBinding.BindKey(App.WC_Z, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_TURN_UP, App.KeyboardBinding.GET_BOOL_EVENT, 1)
		App.g_kKeyboardBinding.BindKey(App.WC_Z, App.TGKeyboardEvent.KS_KEYUP, App.ET_INPUT_TURN_UP, App.KeyboardBinding.GET_BOOL_EVENT, 0)

		App.g_kKeyboardBinding.BindKey(App.WC_Q, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_TURN_LEFT, App.KeyboardBinding.GET_BOOL_EVENT, 1)
		App.g_kKeyboardBinding.BindKey(App.WC_Q, App.TGKeyboardEvent.KS_KEYUP, App.ET_INPUT_TURN_LEFT, App.KeyboardBinding.GET_BOOL_EVENT, 0)
		...
		App.g_kKeyboardBinding.BindKey(App.WC_A, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_ROLL_LEFT, App.KeyboardBinding.GET_BOOL_EVENT, 1)
		App.g_kKeyboardBinding.BindKey(App.WC_A, App.TGKeyboardEvent.KS_KEYUP, App.ET_INPUT_ROLL_LEFT, App.KeyboardBinding.GET_BOOL_EVENT, 0)
		...
		App.g_kKeyboardBinding.BindKey(App.WC_M, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_TOGGLE_SCORE_WINDOW, 0, 0)
		App.g_kKeyboardBinding.BindKey(App.WC_U_GRAVE, App.TGKeyboardEvent.KS_NORMAL, App.ET_INPUT_TOGGLE_CHAT_WINDOW, App.KeyboardBinding.GET_BOOL_EVENT, 0)
		App.g_kKeyboardBinding.BindKey(App.WC_ASTERISK, App.TGKeyboardEvent.KS_NORMAL, App.ET_INPUT_TOGGLE_CHAT_WINDOW, App.KeyboardBinding.GET_BOOL_EVENT, 1)
		...
		App.g_kKeyboardBinding.BindKey(App.WC_COMMA, App.TGKeyboardEvent.KS_KEYDOWN, App.ET_INPUT_TOGGLE_MAP_MODE, 0, 0)
