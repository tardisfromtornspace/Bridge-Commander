...
def CreateAI(pShip, pTargetGroup):
	...
	pScript.SetDestinationPlacementName("Galor2Enter")
	...
	pBasicAttackTargets = AI.Compound.BasicAttack.CreateAI(pShip, pTargetGroup, Easy_Difficulty = 0.46, Difficulty = 1.0, Hard_Difficulty = 1.0)
