...
def CreateAI(pShip, pTargetGroup, sPlacementName):
	...
	pBasicAttack_2 = AI.Compound.BasicAttack.CreateAI(pShip, pTargetGroup, Easy_Difficulty = 0.22, Difficulty = 0.5, Hard_Difficulty = 0.81)
	...
	import AI.Compound.BasicAttack
	pBasicAttack = AI.Compound.BasicAttack.CreateAI(pShip, pTargetGroup, Easy_Difficulty = 0.26, Difficulty = 0.54, Hard_Difficulty = 0.8)
