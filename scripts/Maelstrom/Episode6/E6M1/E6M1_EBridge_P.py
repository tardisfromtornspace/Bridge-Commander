...
def LoadPlacements(sSetName):
	...
	# Position "FelixCam2"
	kThis = App.Waypoint_Create("FelixCam2", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-35.847111, -142.071396, 45.705269)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.088195, 0.995815, -0.023966)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.016983, 0.022553, 0.999601)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	# End position "FelixCam2"
	
	# Position "FelixCam3"
	kThis = App.Waypoint_Create("FelixCam3", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-48.738678, -104.867973, 57.024654)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.607580, 0.788453, -0.095851)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.038692, 0.091155, 0.995085)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	# End position "FelixCam3"
	...
	# Position "SaffiCam2"
	kThis = App.Waypoint_Create("SaffiCam2", sSetName, None)
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-15.232619, 58.820660, 56.776627)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.955182, 0.290389, -0.057461)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.047776, 0.040338, 0.998043)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	# End position "SaffiCam2"
