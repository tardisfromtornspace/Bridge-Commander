...
def CreateAI(pShip, pTargetGroup):
	...
	#########################################
	# Creating PlainAI InterceptPlayer at (163, 150)
	...
	#########################################
	#########################################
	# Creating ConditionalAI PlayerNotInRange at (158, 219)
	## Conditions:
	...
	#########################################
	#########################################
	# Creating CompoundAI BasicAttackTargets at (301, 209)
	import AI.Compound.BasicAttack
	pBasicAttackTargets = AI.Compound.BasicAttack.CreateAI(pShip, pTargetGroup, Easy_Difficulty = 0.43, Difficulty = 1.0, Hard_Difficulty = 1.0)
	# Done creating CompoundAI BasicAttackTargets
	#########################################
	#########################################
	# Creating SequenceAI MainSequence at (116, 278)
