...
def CreateAI(pShip, sTargetName):
	...
	pScript.SetInSystemWarpDistance(fDistance = 428.0)
	# Done creating PlainAI Intercept
	#########################################
	#########################################
	# Creating ConditionalAI NotCloseToTarget at (70, 173)
	## Conditions:
	...
	#########################################
	#########################################
	# Creating PlainAI FaceTowardTarget at (236, 171)
