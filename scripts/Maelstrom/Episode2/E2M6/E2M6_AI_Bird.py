...
def CreateAI(pShip, sPlacementName, pTargetGroup):
	...
	#########################################
	#########################################
	# Creating CompoundAI CloakAttack at (110, 56)
	...
	pOneCardInBiranu2.SetContainedAI(pCloakAttack)
	...
	#########################################
	#########################################
	# Creating PlainAI WarpToBiranu1 at (309, 142)
	...
	#########################################
	#########################################
	# Creating ConditionalAI TimeToWarp at (310, 191)
	## Conditions:
	#### Condition Timer10
	...
	#########################################
	#########################################
	# Creating CompoundAI CloakAttack_2 at (409, 212)
	import AI.Compound.BasicAttack
	...
	#########################################
	#########################################
	# Creating PriorityListAI Biranu1Priority at (354, 269)
	...
	pBiranu1Priority.AddAI(pCloakAttack_2, 1)
