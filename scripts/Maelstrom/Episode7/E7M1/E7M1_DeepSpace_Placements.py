...
def LoadPlacements(TGObject = None, pEvent = None):
	...
	kThis = App.Waypoint_Create("Enterprise Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Attacker 3 Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Attacker 1 Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Attacker 2 Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Starbase Location", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Galor2 Return", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Galor2 Return End", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Akira Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Keldon Way1", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Galor1 Way1", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 101", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 105", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 100", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 106", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 107", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Nebula Start", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Nebula Way1", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 108", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Create("Placement 109", "Deep Space", None)
	kThis.SetStatic(0)
	...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Galor2 Return") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Galor2 Return End") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 101" after "Keldon Way1"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Keldon Way1") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 101") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 105" after "Placement 101"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 101") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 105") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 100" after "Placement 105"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 105") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 100") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 106" after "Placement 100"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 100") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 106") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 107" after "Placement 106"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 106") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 107") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 108" after "Nebula Way1"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Nebula Way1") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 108") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
	# Attaching object "Placement 109" after "Placement 108"...
	kThis = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 108") )
	kPrevious = App.Waypoint_Cast( App.PlacementObject_GetObjectBySetName("Deep Space", "Placement 109") )
	kThis.InsertAfterObj( kPrevious )
	kThis = kPrevious = None
