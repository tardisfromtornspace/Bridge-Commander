...
def CreateAI(pShip, lAllies):
	...
	#########################################
	#########################################
	# Creating CompoundAI AttackAll at (279, 52)
	import AI.Compound.BasicAttack
	pAttackAll = AI.Compound.BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule("Maelstrom.Episode8.E8M1.E8M1", "pEnemies"), Difficulty = 0.75, SmartTorpSelection = 1)
