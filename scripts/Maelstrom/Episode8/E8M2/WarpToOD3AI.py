import App
def CreateAI(pShip, iWait, sPlacement):
	...
	pTimePassed = App.ConditionScript_Create("Conditions.ConditionTimer", "ConditionTimer", iWait, 1)
	## Evaluation function:
	...
	pScript.SetDestinationSetName("Systems.OmegaDraconis.OmegaDraconis3")
