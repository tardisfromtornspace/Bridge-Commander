...
def CreateAI(pShip):
	...
	pAttack = Ai.Compound.BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule("Maelstrom.Episode8.E8M2.E8M2", "pFriendlies"), Difficulty = 0.4, ChooseSubsystemTargets = 0)
