import App
def CreateAI(pShip, fTime = 20.0, sShipToRunFrom = "player"):
	...
	pScript.SetFleeFromGroup(sShipToRunFrom)
	...
	pTimePassed = App.ConditionScript_Create("Conditions.ConditionTimer", "ConditionTimer", fTime, 1)
	## Evaluation function:
