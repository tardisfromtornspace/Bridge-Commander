...
def CreateAI(pShip):
	...
	pAttackTarget = AI.Compound.BasicAttack.CreateAI(pShip, App.ObjectGroup_FromModule("Maelstrom.Episode4.E4M6.E4M6", "g_pKlingons"), Difficulty = 0.0, DumbFireTorps = 1, InaccurateTorps = 1)
	# Done creating CompoundAI AttackTarget
	#########################################
	#########################################
	# Creating CompoundAI AttackPlayer at (209, 272)
	import AI.Compound.BasicAttack
