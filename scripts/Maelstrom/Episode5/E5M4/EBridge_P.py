...
def LoadPlacements(sSetName):
	...
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.132469, 0.031123, 0.990698)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.035761, 0.148537, 0.988260)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000652, 0.158948, 0.987287)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.188087, 0.070767, 0.979600)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.011406, -0.999935, 0.000000)
	kUp = App.TGPoint3()
	...
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.538768, -0.839264, -0.073247)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.031190, -0.067014, 0.997264)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.022115, -0.016660, 0.999617)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
	...
	kThis.SetStatic(0)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(-8.029396, 58.711884, 65.805656)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.947526, 0.301518, -0.106218)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.099864, 0.036458, 0.994333)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
