...
def CreateAI(pShip):
	...
	#### Condition LOS
	pLOS = App.ConditionScript_Create("Conditions.ConditionInLineOfSight", "ConditionInLineOfSight", pShip.GetName(), "player", "Alioth 4")
	## Evaluation function:
	...
	#########################################
	#########################################
	# Creating PlainAI Orbit_Alioth4 at (191, 81)
	pOrbit_Alioth4 = App.PlainAI_Create(pShip, "Orbit_Alioth4")
	pOrbit_Alioth4.SetScriptModule("CircleObject")
	pOrbit_Alioth4.SetInterruptable(1)
	pScript = pOrbit_Alioth4.GetScriptInstance()
	pScript.SetFollowObjectName("Alioth 4")
	...
	# Done creating PlainAI Orbit_Alioth4
	#########################################
	#########################################
	...
	pPriorityList.AddAI(pOrbit_Alioth4, 2)
