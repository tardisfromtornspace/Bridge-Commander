...
def CreateAI(pShip):
	...
	#### Condition LOS
	pLOS = App.ConditionScript_Create("Conditions.ConditionInLineOfSight", "ConditionInLineOfSight", pShip.GetName(), "player", "Alioth 2")
	## Evaluation function:
	...
	#########################################
	#########################################
	# Creating PlainAI Orbit_Alioth2 at (191, 81)
	pOrbit_Alioth2 = App.PlainAI_Create(pShip, "Orbit_Alioth2")
	pOrbit_Alioth2.SetScriptModule("CircleObject")
	pOrbit_Alioth2.SetInterruptable(1)
	pScript = pOrbit_Alioth2.GetScriptInstance()
	pScript.SetFollowObjectName("Alioth 2")
	pScript.SetNearFacingVector(App.TGPoint3_GetModelLeft())
	pScript.SetRoughDistances(fNearDistance = 350, fFarDistance = 400)
	pScript.SetCircleSpeed(fSpeed = 5.0)
	# Done creating PlainAI Orbit_Alioth2
	#########################################
	#########################################
	...
	pPriorityList.AddAI(pOrbit_Alioth2, 2)
