...
def CreateAI(pShip):
	...
	## Conditions:
	#### Condition Attacked
	pAttacked = App.ConditionScript_Create("Conditions.ConditionSingleShieldBelow", "ConditionSingleShieldBelow", "Galor1",  0.05, App.ShieldClass.NUM_SHIELDS)
	## Evaluation function:
	...
	#########################################
	#########################################
	# Creating CompoundAI AttackPlayer2 at (329, 97)
	import AI.Compound.BasicAttack
