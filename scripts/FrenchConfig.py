###############################################################################
#	Filename:	FrenchConfig.py
#	
#	Confidential and Proprietary, Copyright 2002 by Totally Games
#	
#	Maps French keyboard scancodes to Unicode.  For a French keyboard, this file
#	should replace the default US KeyConfig.py and be named as such.
#	
...
def MapScancodes():
	...
	# Map the first row
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_SQUARED, App.KY_BACKQUOTE, pDatabase, "^2")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AMPERSAND, App.KY_1, pDatabase, "&")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_ACUTE, App.KY_2, pDatabase, "e ACUTE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_DOUBLE_QUOTE, App.KY_3, pDatabase, "\"")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_4, pDatabase, "'")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_OPEN_PAREN, App.KY_5, pDatabase, "(")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_MINUS, App.KY_6, pDatabase, "-")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_GRAVE, App.KY_7, pDatabase, "e GRAVE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_UNDERSCORE, App.KY_8, pDatabase, "_")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_C_CEDILLA, App.KY_9, pDatabase, "C CEDILLA")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_GRAVE, App.KY_0, pDatabase, "a GRAVE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_PAREN, App.KY_MINUS, pDatabase, ")")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A, App.KY_Q, pDatabase, "a")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_Z, App.KY_W, pDatabase, "z")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_OPEN_BRACKET, pDatabase, "^")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_DOLLAR_SIGN, App.KY_CLOSE_BRACKET, pDatabase, "$")

	# Map third row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPSLOCK, App.KY_CAPSLOCK, pDatabase, "CAPS")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_Q, App.KY_A, pDatabase, "a")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_M, App.KY_SEMICOLON, pDatabase, "m")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_GRAVE, App.KY_QUOTE, pDatabase, "U GRAVE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ASTERISK, App.KY_EU_RIGHT, pDatabase, "*")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_LESS_THAN, App.KY_EU_LEFT, pDatabase, "<")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_W, App.KY_Z, pDatabase, "y")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COMMA, App.KY_M, pDatabase, ",")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEMICOLON, App.KY_COMMA, pDatabase, ";")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COLON, App.KY_PERIOD, pDatabase, ":")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EXCLAMATION, App.KY_SLASH, pDatabase, "!")
	...
	# ' has no character
	App.g_kInputManager.RegisterUnicodeKey(App.WC_1, App.KY_1, pDatabase, "1", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_2, App.KY_2, pDatabase, "2", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_3, App.KY_3, pDatabase, "3", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_4, App.KY_4, pDatabase, "4", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_5, App.KY_5, pDatabase, "5", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_6, App.KY_6, pDatabase, "6", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_7, App.KY_7, pDatabase, "7", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_8, App.KY_8, pDatabase, "8", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_9, App.KY_9, pDatabase, "9", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_0, App.KY_0, pDatabase, "0", App.KY_SHIFT)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_DEGREE, App.KY_MINUS, pDatabase, "º", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EQUALS, App.KY_EQUALS, pDatabase, "=", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_A, App.KY_Q, pDatabase, "A", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_Z, App.KY_W, pDatabase, "Z", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_DOUBLE_QUOTE, App.KY_OPEN_BRACKET, pDatabase, "INV \"", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_POUND_SIGN, App.KY_CLOSE_BRACKET, pDatabase, "POUND", App.KY_SHIFT)

	# Map third row, Shifted
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPSLOCK, App.KY_CAPSLOCK, pDatabase, "CAPS", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_Q, App.KY_A, pDatabase, "Q", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_M, App.KY_SEMICOLON, pDatabase, "M", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PERCENT, App.KY_QUOTE, pDatabase, "%", App.KY_SHIFT)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_MICRO_SIGN, App.KY_EU_RIGHT, pDatabase, "Micro Sign", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_LESS_THAN, App.KY_EU_LEFT, pDatabase, "<")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_W, App.KY_Z, pDatabase, "W", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUESTION, App.KY_M, pDatabase, "?", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PERIOD, App.KY_COMMA, pDatabase, ".", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SLASH, App.KY_PERIOD, pDatabase, "/", App.KY_SHIFT)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_SLASH, pDatabase, "Euro Sign", App.KY_SHIFT)
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_BACKQUOTE, pDatabase, "^", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_PAREN, App.KY_MINUS, pDatabase, ")", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_Z, App.KY_Y, pDatabase, "ALT-Z", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_DIAERESIS, App.KY_OPEN_BRACKET, pDatabase, "u DIAERESIS", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PLUS, App.KY_CLOSE_BRACKET, pDatabase, "+", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_DIAERESIS, App.KY_SEMICOLON, pDatabase, "o DIAERESIS", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_DIAERESIS, App.KY_QUOTE, pDatabase, "a DIAERESIS", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_EU_RIGHT, pDatabase, "#", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_LESS_THAN, App.KY_EU_LEFT, pDatabase, "<", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_Y, App.KY_Z, pDatabase, "ALT-Y", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_MINUS, App.KY_SLASH, pDatabase, "-", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F1, App.KY_F1, pDatabase, "CTRL-F1", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F2, App.KY_F2, pDatabase, "CTRL-F2", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F3, App.KY_F3, pDatabase, "CTRL-F3", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F4, App.KY_F4, pDatabase, "CTRL-F4", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F5, App.KY_F5, pDatabase, "CTRL-F5", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F6, App.KY_F6, pDatabase, "CTRL-F6", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F7, App.KY_F7, pDatabase, "CTRL-F7", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F8, App.KY_F8, pDatabase, "CTRL-F8", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F9, App.KY_F9, pDatabase, "CTRL-F9", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F10, App.KY_F10, pDatabase, "CTRL-F10", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F11, App.KY_F11, pDatabase, "CTRL-F11", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_F12, App.KY_F12, pDatabase, "CTRL-F12", App.KY_CTRL)

	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_BACKQUOTE, pDatabase, "^", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_1, App.KY_1, pDatabase, "CTRL-1", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_2, App.KY_2, pDatabase, "CTRL-2", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_3, App.KY_3, pDatabase, "CTRL-3", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_4, App.KY_4, pDatabase, "CTRL-4", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_5, App.KY_5, pDatabase, "CTRL-5", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_6, App.KY_6, pDatabase, "CTRL-6", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_7, App.KY_7, pDatabase, "CTRL-7", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_8, App.KY_8, pDatabase, "CTRL-8", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_9, App.KY_9, pDatabase, "CTRL-9", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_0, App.KY_0, pDatabase, "CTRL-0", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_PAREN, App.KY_MINUS, pDatabase, ")", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_A, App.KY_Q, pDatabase, "CTRL-A", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_Z, App.KY_W, pDatabase, "CTRL-Z", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_Z, App.KY_Y, pDatabase, "CTRL-Z", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_OPEN_BRACKET, pDatabase, "^", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_DOLLAR_SIGN, App.KY_CLOSE_BRACKET, pDatabase, "$", App.KY_CTRL)

	# Map third row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPSLOCK, App.KY_CAPSLOCK, pDatabase, "CAPS", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_Q, App.KY_A, pDatabase, "CTRL-Q", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_M, App.KY_SEMICOLON, pDatabase, "CTRL-M", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_GRAVE, App.KY_QUOTE, pDatabase, "U GRAVE", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ASTERISK, App.KY_EU_RIGHT, pDatabase, "*", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_LESS_THAN, App.KY_EU_LEFT, pDatabase, "<", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_W, App.KY_Z, pDatabase, "CTRL-Y", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COMMA, App.KY_M, pDatabase, ",", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEMICOLON, App.KY_COMMA, pDatabase, ";", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COLON, App.KY_PERIOD, pDatabase, ":", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EXCLAMATION, App.KY_SLASH, pDatabase, "!", App.KY_CTRL)
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_TILDE, App.KY_2, pDatabase, "~", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_3, pDatabase, "#", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_OPEN, App.KY_4, pDatabase, "{", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_OPEN_BRACKET, App.KY_5, pDatabase, "[", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEPARATOR, App.KY_6, pDatabase, "|", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_7, pDatabase, "`", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKSLASH, App.KY_8, pDatabase, "\\", App.KY_ALTGR)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_9, pDatabase, "^", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AT_SIGN, App.KY_0, pDatabase, "@", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_BRACKET, App.KY_MINUS, pDatabase, "]", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_CLOSE, App.KY_EQUALS, pDatabase, "}", App.KY_ALTGR)
	...
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_WEIRD_E, App.KY_E, pDatabase, "Weird E", App.KY_ALTGR)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_WEIRD_STAR, App.KY_EU_RIGHT, pDatabase, "Weird Star", App.KY_ALTGR)
	...
	### DEAD-KEY SUPPORT ###
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CARRET, App.WC_CARRET)

	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_A, App.WC_A_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_E, App.WC_E_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_I, App.WC_I_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_O, App.WC_O_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_U, App.WC_U_CIRCUMFLEX)

	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CAPS_A, App.WC_CAPS_A_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CAPS_E, App.WC_CAPS_E_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CAPS_I, App.WC_CAPS_I_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CAPS_O, App.WC_CAPS_O_CIRCUMFLEX)
	App.g_kInputManager.RegisterDeadKey(App.WC_CARRET, App.WC_CAPS_U, App.WC_CAPS_U_CIRCUMFLEX)

	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_ACUTE_ACCENT, App.WC_ACUTE_ACCENT)

	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_A, App.WC_A_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_E, App.WC_E_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_I, App.WC_I_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_O, App.WC_O_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_U, App.WC_U_ACUTE)

	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_A, App.WC_CAPS_A_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_E, App.WC_CAPS_E_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_I, App.WC_CAPS_I_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_O, App.WC_CAPS_O_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_U, App.WC_CAPS_U_ACUTE)
	App.g_kInputManager.RegisterDeadKey(App.WC_ACUTE_ACCENT, App.WC_CAPS_Y, App.WC_CAPS_Y_ACUTE)

	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_BACKQUOTE, App.WC_BACKQUOTE)

	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_A, App.WC_A_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_E, App.WC_E_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_I, App.WC_I_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_O, App.WC_O_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_U, App.WC_U_GRAVE)

	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_CAPS_A, App.WC_CAPS_A_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_CAPS_E, App.WC_CAPS_E_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_CAPS_I, App.WC_CAPS_I_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_CAPS_O, App.WC_CAPS_O_GRAVE)
	App.g_kInputManager.RegisterDeadKey(App.WC_BACKQUOTE, App.WC_CAPS_U, App.WC_CAPS_U_GRAVE)

	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_TILDE, App.WC_TILDE)

	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_A, App.WC_A_TILDE)
	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_N, App.WC_N_TILDE)
	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_O, App.WC_O_TILDE)

	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_CAPS_A, App.WC_CAPS_A_TILDE)
	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_CAPS_N, App.WC_CAPS_N_TILDE)
	App.g_kInputManager.RegisterDeadKey(App.WC_TILDE, App.WC_CAPS_O, App.WC_CAPS_O_TILDE)

	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_INVERTED_DOUBLE_QUOTE, App.WC_INVERTED_DOUBLE_QUOTE)

	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_A, App.WC_A_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_E, App.WC_E_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_I, App.WC_I_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_O, App.WC_O_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_U, App.WC_U_DIAERESIS)

	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_CAPS_A, App.WC_CAPS_A_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_CAPS_E, App.WC_CAPS_E_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_CAPS_I, App.WC_CAPS_I_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_CAPS_O, App.WC_CAPS_O_DIAERESIS)
	App.g_kInputManager.RegisterDeadKey(App.WC_INVERTED_DOUBLE_QUOTE, App.WC_CAPS_U, App.WC_CAPS_U_DIAERESIS)
