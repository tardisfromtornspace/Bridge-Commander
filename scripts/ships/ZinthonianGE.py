...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ZinthonianGE/ZinthonianGE.nif",
		"FilenameMed": "data/Models/Ships/ZinthonianGE/ZinthonianGE.nif",
		"FilenameLow": "data/Models/ships/ZinthonianGE/ZinthonianGE.nif",
		"Name": "ZinthonianGE",
		"HardpointFile": "ZinthonianGE",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 200.0, 15.0, 15.0, 525000, 650000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 15.0, 15.0, 525000, 650000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 800.0, 15.0, 30.0, 525000, 650000, "_glow", None, "_specular")
