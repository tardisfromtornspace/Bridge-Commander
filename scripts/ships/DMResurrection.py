...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/DMResurrection/DMresurrection.nif",
		"FilenameMed": "data/Models/Ships/DMResurrection/DMresurrection.nif",
		"FilenameLow": "data/Models/Ships/DMResurrection/DMresurrection.nif",
		"Name": "DMResurrection",
		"HardpointFile": "DMResurrection",
