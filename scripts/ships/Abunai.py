...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/Abunai/Abunai.nif",
		"FilenameMed": "data/Models/Ships/Abunai/Abunai.nif",
		"FilenameLow": "data/Models/Ships/Abunai/Abunai.nif",
		"Name": "Abunai",
		"HardpointFile": "Abunai",
