...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Surrok/surrok.nif",
		"FilenameMed": "data/Models/Ships/Surrok/surrok.nif",
		"FilenameLow": "data/Models/Ships/Surrok/surrok.nif",
		"Name": "Surrok",
		"HardpointFile": "surrok",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 1500.0, 25.0, 50.0, 400, 900, "_glow", "None", "_specular")
