...
def GetShipStats():
    kShipStats = {'FilenameHigh': 'data/Models/Ships/ZZKrios/ZZKrios.nif',
		  'FilenameMed': 'data/Models/Ships/ZZKrios/ZZKrios.nif',
		  'FilenameLow': 'data/Models/Ships/ZZKrios/ZZKrios.nif',
		  'Name': 'ZZKrios',
		  'HardpointFile': 'ZZKrios',
