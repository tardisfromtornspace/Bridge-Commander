...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradoOrderGC/TradoOrderGC.nif",
		"FilenameMed": "data/Models/Ships/TradoOrderGC/TradoOrderGC.nif",
		"FilenameLow": "data/Models/ships/TradoOrderGC/TradoOrderGC.nif",
		"Name": "TradoOrderGC",
		"HardpointFile": "TradoOrderGC",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 200.0, 15.0, 15.0, 3000000, 5750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 15.0, 15.0, 3000000, 5750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 800.0, 15.0, 30.0, 3000000, 5750000, "_glow", None, None)
