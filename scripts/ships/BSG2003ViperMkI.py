...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 120.0, 5.0, 5.0, 3, 900, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"], 10, 300.0, 5.0, 5.0, 3, 900, "_glow", None, "_specular")
