...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/MillionVoices/MillionVoices.nif",
		"FilenameMed": "data/Models/Ships/MillionVoices/MillionVoices.nif",
		"FilenameLow": "data/Models/Ships/MillionVoices/MillionVoices.nif",
		"Name": "MillionVoices",
		"HardpointFile": "MillionVoices",
