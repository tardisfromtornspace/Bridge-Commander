...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ProtostarProtowarp/LeftUnderPylonTail.nif",
		"FilenameMed": "data/Models/Ships/ProtostarProtowarp/LeftUnderPylonTail.nif",
		"FilenameLow": "data/Models/Ships/ProtostarProtowarp/LeftUnderPylonTail.nif",
		"Name": "USSProtostarPBC",
