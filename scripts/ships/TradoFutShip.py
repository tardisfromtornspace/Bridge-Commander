...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradoFutShip/TradoFutShip.nif",
		"FilenameMed": "data/Models/Ships/TradoFutShip/TradoFutShip.nif",
		"FilenameLow": "data/Models/ships/TradoFutShip/TradoFutShip.nif",
		"Name": "TradoFutShip",
		"HardpointFile": "TradoFutShip",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 200.0, 15.0, 15.0, 12000000, 23000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 15.0, 15.0, 12000000, 23000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 800.0, 15.0, 30.0, 12000000, 23000000, "_glow", None, None)
