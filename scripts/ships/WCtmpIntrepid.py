...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WCtmpenta/WCtmpenta.nif",
		"FilenameMed": "data/Models/Ships/WCtmpenta/WCtmpenta.nif",
		"FilenameLow": "data/Models/ships/WCtmpenta/WCtmpenta.nif",
		"Name": "WCtmpIntrepid",
		"HardpointFile": "WCtmpenta",
