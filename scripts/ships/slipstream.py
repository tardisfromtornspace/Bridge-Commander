...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/slipstream/outer.NIF",
		"FilenameMed": "data/Models/Bases/slipstream/outer.NIF",
		"FilenameLow": "data/Models/Bases/slipstream/outer.NIF",
		"Name": "slipstream",
		"HardpointFile": "slipstream",
