...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/DalekSaucer/DalekEmperorSaucer.nif",
		"FilenameMed": "data/Models/Ships/DalekSaucer/DalekEmperorSaucer.nif",
		"FilenameLow": "data/Models/Ships/DalekSaucer/DalekEmperorSaucer.nif",
		"Name": "DalekEmperorSaucer",
		"HardpointFile": "DalekEmperorSaucer",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 2000.0, 0.0, 0.0, 0, 0, "_glow", None, None)
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 4000.0, 0.0, 0.0, 0, 0, "_glow", None, None)
         	pLODModel.AddLOD(pStats["FilenameLow"],  10, 8000.0, 0.0, 0.0, 0, 0, "_glow", None, None)
