...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/aaCarrack/CARRACKCRUISER.nif",
		"FilenameMed": "data/Models/Ships/aaCarrack/CARRACKCRUISER.nif",
		"FilenameLow": "data/Models/Ships/aaCarrack/CARRACKCRUISER.nif",
		"Name": "Carrack Cruiser",
		"HardpointFile": "aaCarrack",
