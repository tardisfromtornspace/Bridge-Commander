...
def GetShipStats():
    kShipStats = {
        'FilenameHigh': 'data/Models/Ships/ZZRomulanOwl/ZZRomulanOwl.nif',
        'FilenameMed': 'data/Models/Ships/ZZRomulanOwl/ZZRomulanOwl.nif',
        'FilenameLow': 'data/Models/Ships/ZZRomulanOwl/ZZRomulanOwl.nif',
        'Name': 'ZZRomulanOwl',
        'HardpointFile': 'ZZRomulanOwl_HP',
