...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/Hope/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/Hope/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/Hope/CI_OLYMPIC.nif",
		"Name": "OCMPHope",
		"HardpointFile": "ocmphope",
