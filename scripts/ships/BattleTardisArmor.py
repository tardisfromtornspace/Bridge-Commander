...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Tardis/BattleTARDIS.nif",
		"FilenameMed": "data/Models/Ships/Tardis/BattleTARDIS.nif",
		"FilenameLow": "data/Models/Ships/Tardis/BattleTARDIS.nif",
		"Name": "BattleTardisArmor",
		"HardpointFile": "BattleTardisArmor",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 600.0, 15.0, 0.0, 4800000, 0, "_glow", None, None)
		pLODModel.AddLOD(pStats["FilenameMed"], 10, 1200.0, 15.0, 0.0, 4800000, 0, "_glow", None, None)
		pLODModel.AddLOD(pStats["FilenameLow"], 10, 1800.0, 15.0, 0.0, 4800000, 0, "_glow", None, None)
