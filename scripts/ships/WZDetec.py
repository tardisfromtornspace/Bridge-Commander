...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WZAndromedans/Detector/Detector.nif",
		"FilenameMed": "data/Models/Ships/WZAndromedans/Detector/Detector.nif",
		"FilenameLow": "data/Models/Ships/WZAndromedans/Detector/Detector.nif",
		"Name": "WZDetec",
		"HardpointFile": "WZDetec",
