...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TheExile/TheExile.nif",
		"FilenameMed": "data/Models/Ships/TheExile/TheExile.nif",
		"FilenameLow": "data/Models/Ships/TheExile/TheExile.nif",
		"Name": "TheExile",
