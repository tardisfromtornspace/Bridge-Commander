...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.1, 
		"DamageStrMod" : 0.1, 
		"FilenameHigh": "data/Models/Ships/JediStarfighter/JediStarfighter.nif",
		"FilenameMed": "data/Models/Ships/JediStarfighter/JediStarfighter.nif",
		"FilenameLow": "data/Models/Ships/JediStarfighter/JediStarfighter.nif",
		"Name": "JediStarfighter",
		"HardpointFile": "JediStarfighter",
