...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ProtostarProtowarp/RightUnderPylonTail.nif",
		"FilenameMed": "data/Models/Ships/ProtostarProtowarp/RightUnderPylonTail.nif",
		"FilenameLow": "data/Models/Ships/ProtostarProtowarp/RightUnderPylonTail.nif",
		"Name": "USSProtostarSBC",
