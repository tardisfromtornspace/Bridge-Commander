...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ProtostarProtowarp/SaucerLeftTriangle.nif",
		"FilenameMed": "data/Models/Ships/ProtostarProtowarp/SaucerLeftTriangle.nif",
		"FilenameLow": "data/Models/Ships/ProtostarProtowarp/SaucerLeftTriangle.nif",
		"Name": "USSProtostarLST",
