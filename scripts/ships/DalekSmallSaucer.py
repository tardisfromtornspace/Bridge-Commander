...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/DalekSaucer/DalekSmallSaucer.nif",
		"FilenameMed": "data/Models/Ships/DalekSaucer/DalekSmallSaucer.nif",
		"FilenameLow": "data/Models/Ships/DalekSaucer/DalekSmallSaucer.nif",
		"Name": "DalekSmallSaucer",
		"HardpointFile": "DalekSmallSaucer",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 2000.0, 15.0, 15.0, 400000, 4900000, "_glow", None, None)
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 4000.0, 15.0, 15.0, 400000, 4900000, "_glow", None, None)
         	pLODModel.AddLOD(pStats["FilenameLow"],  10, 8000.0, 15.0, 30.0, 400000, 4900000, "_glow", None, None)
