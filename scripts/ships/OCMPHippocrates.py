...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/Hippocrates/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/Hippocrates/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/Hippocrates/CI_OLYMPIC.nif",
		"Name": "OCMPHippocrates",
		"HardpointFile": "ocmphippocrates",
