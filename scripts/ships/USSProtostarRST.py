...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ProtostarProtowarp/SaucerRightTriangle.nif",
		"FilenameMed": "data/Models/Ships/ProtostarProtowarp/SaucerRightTriangle.nif",
		"FilenameLow": "data/Models/Ships/ProtostarProtowarp/SaucerRightTriangle.nif",
		"Name": "USSProtostarRST",
