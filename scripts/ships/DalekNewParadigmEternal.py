...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/NewParadigmDalek/NewParadigmDalekEternal.nif",
		"FilenameMed": "data/Models/Ships/NewParadigmDalek/NewParadigmDalekEternal.nif",
		"FilenameLow": "data/Models/Ships/NewParadigmDalek/NewParadigmDalekEternal.nif",
		"Name": "DalekNewParadigmEternal",
		"HardpointFile": "DalekNewParadigmEternal",
...
def GetArmouredModel(): # OPTIONAL: Select another scripts/ships/yourShip2.py with a adifferent model so when you are armored you change to this
	return "DalekNewParadigmEternal"
