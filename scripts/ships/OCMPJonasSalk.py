...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/JonasSalk/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/JonasSalk/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/JonasSalk/CI_OLYMPIC.nif",
		"Name": "OCMPJonasSalk",
		"HardpointFile": "ocmpjonassalk",
