...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradophianSC/TradophianSC.nif",
		"FilenameMed": "data/Models/Ships/TradophianSC/TradophianSC.nif",
		"FilenameLow": "data/Models/Ships/TradophianSC/TradophianSC.nif",
		"Name": "TradophianSC",
		"HardpointFile": "TradophianSC",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 200.0, 20.0, 15.0, 750000, 850000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 30.0, 15.0, 750000, 850000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 800.0, 30.0, 30.0, 750000, 850000, "_glow", None, "_specular")
