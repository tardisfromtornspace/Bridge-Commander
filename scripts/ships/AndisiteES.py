...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/AndisiteES/AndisiteES.nif",
		"FilenameMed": "data/Models/Ships/AndisiteES/AndisiteES.nif",
		"FilenameLow": "data/Models/Ships/AndisiteES/AndisiteES.nif",
		"Name": "AndisiteES",
		"HardpointFile": "AndisiteES",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 2, 120.0, 15.0, 15.0, 100000, 275000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  2, 300.0, 15.0, 15.0, 100000, 275000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  2, 600.0, 15.0, 30.0, 100000, 275000, "_glow", None, "_specular")
