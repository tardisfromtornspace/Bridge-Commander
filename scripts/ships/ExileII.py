...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/ExileII/ExileII.nif",
		"FilenameMed": "data/Models/Ships/ExileII/ExileII.nif",
		"FilenameLow": "data/Models/Ships/ExileII/ExileII.nif",
		"Name": "ExileII",
		"HardpointFile": "ExileII",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 120.0, 15.0, 15.0, 110000000, 130000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 300.0, 15.0, 15.0, 110000000, 130000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 600.0, 15.0, 30.0, 110000000, 130000000, "_glow", None, "_specular")
