...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/aaCorgun/corelliangunship.nif",
		"FilenameMed": "data/Models/Ships/aaCorgun/corelliangunship.nif",
		"FilenameLow": "data/Models/Ships/aaCorgun/corelliangunship.nif",
		"Name": "CorellianGunship",
		"HardpointFile": "aaCorgun",
