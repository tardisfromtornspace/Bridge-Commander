...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/aaModifiedNebulonB/modfrigate.nif",
		"FilenameMed": "data/Models/Ships/aaModifiedNebulonB/modfrigate.nif",
		"FilenameLow": "data/Models/Ships/aaModifiedNebulonB/modfrigate.nif",
		"Name": "NebulonB-2",
		"HardpointFile": "aaModifiedNebulonB",
