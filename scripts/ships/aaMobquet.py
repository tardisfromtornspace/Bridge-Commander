...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/aaMobquet/mobquettransport.nif",
		"FilenameMed": "data/Models/Ships/aaMobquet/mobquettransport.nif",
		"FilenameLow": "data/Models/Ships/aaMobquet/mobquettransport.nif",
		"Name": "MobquetTransport",
		"HardpointFile": "aaMobquet",
