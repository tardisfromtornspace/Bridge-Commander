...
def GetShipStats():
	kShipStats = {
		...
		"Name": "BattleTardisChamaleonArmor",
		"HardpointFile": "BattleTardisChamaleonArmor",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameLow"], 10, 28000.0, 0.0, 0.0, 0, 0, "_glow", None, None)
...
def GetArmouredModel(): # OPTIONAL: Select another scripts/ships/yourShip2.py with a adifferent model so when you are armored you change to this
	return "BattleTardisChamaleonArmor"
