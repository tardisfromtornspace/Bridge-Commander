...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WCtmpent/WCtmpent.nif",
		"FilenameMed": "data/Models/Ships/WCtmpent/WCtmpent.nif",
		"FilenameLow": "data/Models/ships/WCtmpent/WCtmpent.nif",
		"Name": "WCtmpent",
		"HardpointFile": "WCtmpent",
