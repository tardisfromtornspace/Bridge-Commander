...
def GetShipStats():
    kShipStats = {
        'FilenameHigh': 'data/Models/Ships/ZZBorgSC/ZZBCube.nif',
        'FilenameMed': 'data/Models/Ships/ZZBorgSC/ZZBCube.nif',
        'FilenameLow': 'data/Models/Ships/ZZBorgSC/ZZBCube.nif',
        "DamageRadMod" : 0.3,
        "DamageStrMod" : 0.1,
        'Name': 'ZZBCube',
        'HardpointFile': 'ZZBCubeHP',
