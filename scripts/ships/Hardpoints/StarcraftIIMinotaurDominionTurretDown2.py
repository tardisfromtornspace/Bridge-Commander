...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretDown2")
...
#################################################
StarDisruptor1 = App.PulseWeaponProperty_Create("Ventral Port Laser Battery")
...
StarDisruptor1.SetPosition(0.100000, 0.100000, 0.000000)
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Ventral Port Laser Battery 2")
...
StarDisruptor2.SetPosition(-0.100000, 0.000000, 0.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Ventral Port Laser Battery 2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)