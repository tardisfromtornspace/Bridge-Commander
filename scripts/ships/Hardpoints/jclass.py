# F:\Program Files\Activision\Bridge Commander Enemys Of Life\scripts\ships\Hardpoints\jclass.py
...
ImpulseEngines.SetMaxSpeed(1.000000)
...
Nacelle1.SetMaxCondition(200.000000)
Nacelle1.SetCritical(0)
Nacelle1.SetTargetable(1)
Nacelle1.SetPrimary(1)
Nacelle1.SetPosition(-0.401002, 0.066928, -0.128129)
Nacelle1.SetPosition2D(0.000000, 0.000000)
Nacelle1.SetRepairComplexity(1.000000)
Nacelle1.SetDisabledPercentage(0.500000)
Nacelle1.SetRadius(0.250000)
Nacelle1.SetEngineType(Nacelle1.EP_IMPULSE)
App.g_kModelPropertyManager.RegisterLocalTemplate(Nacelle1)
#################################################
Nacelle2 = App.EngineProperty_Create("Nacelle 2")

Nacelle2.SetMaxCondition(200.000000)
Nacelle2.SetCritical(0)
Nacelle2.SetTargetable(1)
Nacelle2.SetPrimary(1)
Nacelle2.SetPosition(0.401002, 0.066928, -0.128129)
Nacelle2.SetPosition2D(0.000000, 0.000000)
Nacelle2.SetRepairComplexity(1.000000)
Nacelle2.SetDisabledPercentage(0.500000)
Nacelle2.SetRadius(0.250000)
Nacelle2.SetEngineType(Nacelle2.EP_IMPULSE)
