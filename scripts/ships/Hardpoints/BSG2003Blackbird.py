...
# Local Templates
#################################################
BSG2003Blackbird = App.ShipProperty_Create("BSG2003Blackbird")

BSG2003Blackbird.SetGenus(1)
BSG2003Blackbird.SetSpecies(107)
BSG2003Blackbird.SetMass(10.000000)
BSG2003Blackbird.SetRotationalInertia(200.000000)
BSG2003Blackbird.SetShipName("BSG2003Blackbird")
BSG2003Blackbird.SetModelFilename("data/Models/Ships/Blackbird/Blackbird.nif")
BSG2003Blackbird.SetDamageResolution(0.000100)
BSG2003Blackbird.SetAffiliation(0)
BSG2003Blackbird.SetStationary(0)
BSG2003Blackbird.SetAIString("NonFedAttack")
BSG2003Blackbird.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(BSG2003Blackbird)
#################################################
...
#################################################
ManualPointDefence = App.ShieldProperty_Create("Manual Point Defence")

ManualPointDefence.SetMaxCondition(1.000000)
ManualPointDefence.SetCritical(0)
ManualPointDefence.SetTargetable(0)
ManualPointDefence.SetPrimary(1)
ManualPointDefence.SetPosition(0.000000, 0.000000, 0.000000)
ManualPointDefence.SetPosition2D(64.000000, 54.000000)
ManualPointDefence.SetRepairComplexity(1.000000)
ManualPointDefence.SetDisabledPercentage(0.500000)
ManualPointDefence.SetRadius(0.007500)
ManualPointDefence.SetNormalPowerPerSecond(0.000000)
ManualPointDefenceShieldGlowColor = App.TGColorA()
ManualPointDefenceShieldGlowColor.SetRGBA(0.000000, 0.000000, 0.000000, 0.000000)
ManualPointDefence.SetShieldGlowColor(ManualPointDefenceShieldGlowColor)
ManualPointDefence.SetShieldGlowDecay(1.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.FRONT_SHIELDS, 0.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.REAR_SHIELDS, 0.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.TOP_SHIELDS, 0.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.BOTTOM_SHIELDS, 0.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.LEFT_SHIELDS, 0.000000)
ManualPointDefence.SetMaxShields(ManualPointDefence.RIGHT_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.FRONT_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.REAR_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.TOP_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.BOTTOM_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.LEFT_SHIELDS, 0.000000)
ManualPointDefence.SetShieldChargePerSecond(ManualPointDefence.RIGHT_SHIELDS, 0.000000)
App.g_kModelPropertyManager.RegisterLocalTemplate(ManualPointDefence)
#################################################
KaraThraceStarbuck = App.RepairSubsystemProperty_Create("Kara Thrace Starbuck")

KaraThraceStarbuck.SetMaxCondition(3.000000)
KaraThraceStarbuck.SetCritical(1)
KaraThraceStarbuck.SetTargetable(1)
KaraThraceStarbuck.SetPrimary(1)
KaraThraceStarbuck.SetPosition(0.000000, 0.000000, 0.000000)
KaraThraceStarbuck.SetPosition2D(64.000000, 75.000000)
KaraThraceStarbuck.SetRepairComplexity(1.000000)
KaraThraceStarbuck.SetDisabledPercentage(0.500000)
KaraThraceStarbuck.SetRadius(0.002500)
KaraThraceStarbuck.SetNormalPowerPerSecond(1.000000)
KaraThraceStarbuck.SetMaxRepairPoints(0.001000)
KaraThraceStarbuck.SetNumRepairTeams(1)
App.g_kModelPropertyManager.RegisterLocalTemplate(KaraThraceStarbuck)
#################################################
TyliumReactor = App.PowerProperty_Create("Tylium Reactor")

TyliumReactor.SetMaxCondition(2.000000)
...
TyliumReactor.SetPosition2D(64.000000, 85.000000)
...
SublightEngines.SetMaxCondition(5.000000)
...
SublightEngines.SetMaxAngularAccel(2.950000)
SublightEngines.SetMaxAngularVelocity(2.950000)
...
Engine1.SetMaxCondition(4.000000)
...
Engine2.SetMaxCondition(4.000000)
...
RCSThruster1.SetMaxCondition(4.000000)
RCSThruster1.SetCritical(0)
RCSThruster1.SetTargetable(1)
RCSThruster1.SetPrimary(0)
RCSThruster1.SetPosition(0.056500, -0.060000, -0.005000)
RCSThruster1.SetPosition2D(83.000000, 100.000000)
RCSThruster1.SetRepairComplexity(1.000000)
RCSThruster1.SetDisabledPercentage(0.500000)
RCSThruster1.SetRadius(0.008500)
...
RCSThruster2.SetMaxCondition(4.000000)
RCSThruster2.SetCritical(0)
RCSThruster2.SetTargetable(1)
RCSThruster2.SetPrimary(0)
RCSThruster2.SetPosition(-0.056500, -0.060000, -0.005000)
RCSThruster2.SetPosition2D(64.000000, 65.000000)
RCSThruster2.SetRepairComplexity(1.000000)
RCSThruster2.SetDisabledPercentage(0.500000)
RCSThruster2.SetRadius(0.008500)
...
FTLDrive.SetMaxCondition(5.500000)
...
PortCannon.SetMaxCondition(5.000000)
...
StarCannon.SetMaxCondition(5.000000)
...
MissileSys.SetMaxCondition(3.000000)
...
PortLauncher.SetMaxCondition(3.140000)
PortLauncher.SetCritical(0)
PortLauncher.SetTargetable(1)
PortLauncher.SetPrimary(0)
PortLauncher.SetPosition(-0.015500, -0.020000, -0.007500)
...
StarLauncher.SetMaxCondition(3.140000)
StarLauncher.SetCritical(0)
StarLauncher.SetTargetable(1)
StarLauncher.SetPrimary(0)
StarLauncher.SetPosition(0.015500, -0.025000, -0.007500)
StarLauncher.SetPosition2D(68.000000, 60.000000)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("BSG2003Blackbird", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Manual Point Defence", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Kara Thrace Starbuck", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
