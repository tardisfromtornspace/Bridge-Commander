...
ViperMk7.SetRotationalInertia(2100.000000)
ViperMk7.SetShipName("BSG2003ViperMk7")
...
Pilot.SetPrimary(1)
Pilot.SetPosition(0.000000, 0.025000, 0.010000)
...
DRADISSystem.SetBaseSensorRange(540.000000)
...
SublightEngines.SetMaxAngularAccel(2.700000)
SublightEngines.SetMaxAngularVelocity(2.700000)
...
Engine1.SetMaxCondition(3.750000)
...
Engine2.SetMaxCondition(3.750000)
Engine2.SetCritical(0)
Engine2.SetTargetable(1)
Engine2.SetPrimary(0)
Engine2.SetPosition(-0.010000, -0.070000, -0.001650)
...
Engine3.SetMaxCondition(3.750000)
Engine3.SetCritical(0)
Engine3.SetTargetable(1)
Engine3.SetPrimary(0)
Engine3.SetPosition(0.010000, -0.070000, -0.001650)
...
Cannons.SetPosition2D(64.000000, 75.000000)
...
PortCannon.SetPosition2D(59.000000, 62.000000)
...
StarCannon.SetPosition2D(69.000000, 62.000000)
