# C:\Program Files\Activision\QBR 2.2\Bridge Commander\scripts\ships\Hardpoints\ViperMk1.py
...
IonDrive.SetNormalPowerPerSecond(150.000000)
...
TyliumReactor.SetPowerOutput(700.000000)
...
MegatronShield.SetNormalPowerPerSecond(150.000000)
...
MegatronShield.SetMaxShields(MegatronShield.FRONT_SHIELDS, 400.000000)
MegatronShield.SetMaxShields(MegatronShield.REAR_SHIELDS, 300.000000)
MegatronShield.SetMaxShields(MegatronShield.TOP_SHIELDS, 300.000000)
MegatronShield.SetMaxShields(MegatronShield.BOTTOM_SHIELDS, 300.000000)
MegatronShield.SetMaxShields(MegatronShield.LEFT_SHIELDS, 300.000000)
MegatronShield.SetMaxShields(MegatronShield.RIGHT_SHIELDS, 300.000000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.FRONT_SHIELDS, 2.500000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.REAR_SHIELDS, 2.500000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.TOP_SHIELDS, 2.500000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.BOTTOM_SHIELDS, 2.500000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.LEFT_SHIELDS, 2.500000)
MegatronShield.SetShieldChargePerSecond(MegatronShield.RIGHT_SHIELDS, 2.500000)
...
LaserTorpSys.SetMaxCondition(600.000000)
...
LaserTorpSys.SetNormalPowerPerSecond(200.000000)
...
PortLTCannon.SetMaxCondition(300.000000)
...
#################################################
ViperMk1 = App.ShipProperty_Create("ViperMk1")

ViperMk1.SetGenus(1)
ViperMk1.SetSpecies(107)
ViperMk1.SetMass(10.000000)
ViperMk1.SetRotationalInertia(2.000000)
ViperMk1.SetShipName("ViperMk1")
ViperMk1.SetModelFilename("data/Models/Ships/ViperMk1/ViperMk1.nif")
ViperMk1.SetDamageResolution(5.000000)
ViperMk1.SetAffiliation(0)
ViperMk1.SetStationary(0)
ViperMk1.SetAIString("NonFedAttack")
ViperMk1.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ViperMk1)
#################################################
Engine2 = App.EngineProperty_Create("Engine 2")

Engine2.SetMaxCondition(650.000000)
...
Engine3.SetMaxCondition(650.000000)
...
GravimetricInitiator.SetMaxCondition(600.000000)
...
Launcher.SetMaxCondition(600.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("ViperMk1", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
