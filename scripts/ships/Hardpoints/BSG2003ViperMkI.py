...
# Local Templates
#################################################
ViperMkI = App.ShipProperty_Create("ViperMkI")

ViperMkI.SetGenus(1)
ViperMkI.SetSpecies(107)
ViperMkI.SetMass(9.000000)
ViperMkI.SetRotationalInertia(800.000000)
ViperMkI.SetShipName("BSG2003ViperMkI")
ViperMkI.SetModelFilename("data/Models/Ships/Viper/Viper.nif")
ViperMkI.SetDamageResolution(0.000100)
ViperMkI.SetAffiliation(0)
ViperMkI.SetStationary(0)
ViperMkI.SetAIString("NonFedAttack")
ViperMkI.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ViperMkI)
#################################################
...
#################################################
PointDefence = App.ShieldProperty_Create("Point Defense")
...
TyliumReactor.SetMaxCondition(1.200000)
...
DRADISSystem.SetMaxCondition(2.500000)
...
SublightEngines.SetMaxAngularAccel(1.500000)
SublightEngines.SetMaxAngularVelocity(1.500000)
SublightEngines.SetMaxSpeed(5.300000)
...
PortCannon.SetPosition(-0.012048, 0.040938, -0.004071)
...
StarCannon.SetPosition(0.012153, 0.040857, -0.003980)
...
PortLauncher.SetPosition(-0.016500, -0.039671, -0.009619)
...
StarLauncher.SetPosition(0.016500, -0.039671, -0.009619)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("ViperMkI", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Point Defense", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
