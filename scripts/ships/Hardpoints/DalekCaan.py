...
ParentPropertyScript = "ships.Hardpoints.DalekSec"
if not ('g_bIsModelPropertyEditor' in dir(App)):
	ParentModule = __import__("ships.Hardpoints.DalekSec", globals(), locals(), ['*'])
	reload(ParentModule)
...
Dalek2005Black.SetShipName("DalekCaan")
Dalek2005Black.SetModelFilename("data/Models/Ships/Dalek2005/Dalek2005Gold.nif")
