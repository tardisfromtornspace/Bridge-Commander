# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\ThunderboltEcho.py
...
#################################################
ThunderboltEcho = App.ShipProperty_Create("ThunderboltEcho")

ThunderboltEcho.SetGenus(1)
ThunderboltEcho.SetSpecies(401)
ThunderboltEcho.SetMass(9.000000)
ThunderboltEcho.SetRotationalInertia(2000.000000)
ThunderboltEcho.SetShipName("ThunderboltEcho")
ThunderboltEcho.SetModelFilename("data/Models/Ships/Thunderbolt/Thunderbolt.nif")
ThunderboltEcho.SetDamageResolution(5.000000)
ThunderboltEcho.SetAffiliation(0)
ThunderboltEcho.SetStationary(0)
ThunderboltEcho.SetAIString("NonFedAttack")
ThunderboltEcho.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ThunderboltEcho)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("ThunderboltEcho", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
