...
ReactorModule.SetDisabledPercentage(0.200000)
...
ShieldGenerator.SetMaxCondition(1200.000000)
...
TelTakUpgrade.SetMass(500.000000)
...
SublightEngine.SetDisabledPercentage(0.400000)
...
CloakingDevice.SetDisabledPercentage(0.450000)
