...
Hull.SetMaxCondition(420.000000)
Hull.SetCritical(1)
...
SublightEngines.SetMaxCondition(130.000000)
...
SublightEngines.SetDisabledPercentage(0.300000)
...
DeathGlider.SetShipName("Haririr Death Glider")
...
MainEngine.SetRepairComplexity(1.500000)
MainEngine.SetDisabledPercentage(0.300000)
...
Staff1.SetDisabledPercentage(0.300000)
...
Staff1.SetRechargeRate(0.400000)
...
StaffWeapons.SetDisabledPercentage(0.100000)
...
Staff2.SetDisabledPercentage(0.300000)
...
Staff2.SetRechargeRate(0.400000)
...
MissileControl.SetDisabledPercentage(0.200000)
...
MissileControl.SetMaxTorpedoes(0, 8)
MissileControl.SetTorpedoScript(0, "Tactical.Projectiles.HaririrSmallMissiles")
...
Missile1.SetReloadDelay(18.000000)
...
Missile2.SetReloadDelay(18.000000)
...
Hyperdrive1.SetMaxCondition(100.000000)
...
Hyperdrive1.SetDisabledPercentage(0.100000)
Hyperdrive1.SetRadius(0.015000)
