# D:\GoG\Star Trek Bridge Commander\scripts\ships\Hardpoints\ZZMirMissHP.py
...
#################################################
ZZMirMiss = App.ShipProperty_Create("ZZMirMiss")

ZZMirMiss.SetGenus(3)
ZZMirMiss.SetSpecies(155)
ZZMirMiss.SetMass(1000.000000)
ZZMirMiss.SetRotationalInertia(1.000000)
ZZMirMiss.SetShipName("ZZMirMiss")
ZZMirMiss.SetModelFilename("data/Models/Ships/ZZMirMiss/ZZMirMiss.NIF")
ZZMirMiss.SetDamageResolution(10.000000)
ZZMirMiss.SetAffiliation(0)
ZZMirMiss.SetStationary(0)
ZZMirMiss.SetAIString("")
ZZMirMiss.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ZZMirMiss)
#################################################
...
Sensor.SetDisabledPercentage(0.000000)
Sensor.SetRadius(0.100000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("ZZMirMiss", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
