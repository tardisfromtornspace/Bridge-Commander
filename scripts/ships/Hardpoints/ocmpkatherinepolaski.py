# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpkatherinepolaski.py
...
Hull.SetMaxCondition(14087.000000)
Hull.SetCritical(1)
...
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.blackelmtype4quantum")
