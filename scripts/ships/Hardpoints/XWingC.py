# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\XWingC.py
...
Engine1.SetPosition(-0.012200, -0.050000, 0.000800)
...
Engine2.SetPosition(0.012200, -0.050000, 0.000800)
...
SensorArray.SetMaxCondition(20.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 23.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 21.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 21.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 21.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 21.000000)
...
Hyperdrive.SetMaxCondition(20.000000)
Hyperdrive.SetCritical(0)
Hyperdrive.SetTargetable(0)
Hyperdrive.SetPrimary(1)
Hyperdrive.SetPosition(0.000000, -0.035000, -0.008000)
...
Laser1.SetPrimary(1)
Laser1.SetPosition(-0.051200, 0.020500, -0.004900)
...
Laser2.SetPrimary(1)
Laser2.SetPosition(0.051200, 0.020500, -0.004900)
...
Laser3.SetPrimary(1)
Laser3.SetPosition(-0.051200, 0.020500, -0.012300)
...
Laser4.SetPrimary(1)
Laser4.SetPosition(0.051200, 0.020500, -0.012300)
