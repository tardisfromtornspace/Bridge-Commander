...
ForwardTorpeado3.SetDamageRadiusFactor(0.999999)
...
ForwardTorpeado4.SetDamageRadiusFactor(0.999999)
...
VentAFTsaucer1.SetDamageRadiusFactor(0.999999)
...
ventaftsaucer2.SetDamageRadiusFactor(0.999999)
