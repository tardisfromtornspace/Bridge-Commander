# C:\Users\Owner\Desktop\MICHAEL\Star Trek\BC\Game 2\scripts\ships\Hardpoints\WCID4captfighter.py
...
#################################################
WCID4captfighter = App.ShipProperty_Create("WCID4captfighter")

WCID4captfighter.SetGenus(1)
WCID4captfighter.SetSpecies(104)
WCID4captfighter.SetMass(51.000000)
WCID4captfighter.SetRotationalInertia(1000.000000)
WCID4captfighter.SetShipName("WCID4captfighter")
WCID4captfighter.SetModelFilename("data/Models/Ships/WCID4captfighter/WCID4captfighter.nif")
WCID4captfighter.SetDamageResolution(10.000000)
WCID4captfighter.SetAffiliation(0)
WCID4captfighter.SetStationary(0)
WCID4captfighter.SetAIString("FedAttack")
WCID4captfighter.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(WCID4captfighter)
#################################################
...
TorpedoSystem.SetMaxTorpedoes(0, 1)
TorpedoSystem.SetTorpedoScript(0, "Tactical.Projectiles.WCID4TacticalNuke")
TorpedoSystem.SetNumAmmoTypes(1)
App.g_kModelPropertyManager.RegisterLocalTemplate(TorpedoSystem)
#################################################
TacticalNuke = App.TorpedoTubeProperty_Create("Tactical Nuke")

TacticalNuke.SetMaxCondition(200.000000)
TacticalNuke.SetCritical(0)
TacticalNuke.SetTargetable(1)
TacticalNuke.SetPrimary(1)
TacticalNuke.SetPosition(0.139804, 0.057569, -0.032853)
TacticalNuke.SetPosition2D(0.000000, 0.000000)
TacticalNuke.SetRepairComplexity(1.000000)
TacticalNuke.SetDisabledPercentage(0.500000)
TacticalNuke.SetRadius(0.250000)
TacticalNuke.SetDumbfire(1)
TacticalNuke.SetWeaponID(0)
TacticalNuke.SetGroups(0)
TacticalNuke.SetDamageRadiusFactor(0.600000)
TacticalNuke.SetIconNum(0)
TacticalNuke.SetIconPositionX(0.000000)
TacticalNuke.SetIconPositionY(0.000000)
TacticalNuke.SetIconAboveShip(1)
TacticalNuke.SetImmediateDelay(0.250000)
TacticalNuke.SetReloadDelay(5.000000)
TacticalNuke.SetMaxReady(1)
TacticalNukeDirection = App.TGPoint3()
TacticalNukeDirection.SetXYZ(0.000000, 1.000000, 0.000000)
TacticalNuke.SetDirection(TacticalNukeDirection)
TacticalNukeRight = App.TGPoint3()
TacticalNukeRight.SetXYZ(1.000000, 0.000000, 0.000000)
TacticalNuke.SetRight(TacticalNukeRight)
App.g_kModelPropertyManager.RegisterLocalTemplate(TacticalNuke)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("WCID4captfighter", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Tactical Nuke", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
