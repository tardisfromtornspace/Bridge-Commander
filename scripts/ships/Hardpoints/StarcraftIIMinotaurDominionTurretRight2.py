...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretRight2")
...
#################################################
StarDisruptor1 = App.PulseWeaponProperty_Create("Port Laser Battery 2")
...
StarDisruptor1.SetPosition(-0.100000, 0.000000, 0.050000)
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Port Laser Battery 2B")
...
StarDisruptor2.SetPosition(-0.100000, 0.000000, -0.050000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Port Laser Battery 2B", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)