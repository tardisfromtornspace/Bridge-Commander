...
ReactorModule.SetMainBatteryLimit(2100000.000000)
ReactorModule.SetBackupBatteryLimit(120000.000000)
ReactorModule.SetMainConduitCapacity(3000.000000)
ReactorModule.SetBackupConduitCapacity(500.000000)
ReactorModule.SetPowerOutput(3500.000000)
...
RotationalThruster1.SetRadius(0.200000)
...
MainWeapon.SetDisabledPercentage(0.400000)
...
StarMissiles.SetReloadDelay(5.000000)
...
Missiles.SetTorpedoScript(0, "Tactical.Projectiles.XOverTollanQuantumTorpedo")
...
RotationalThruster2.SetRadius(0.200000)
...
RotationalThruster3.SetRadius(0.200000)
...
RotationalThruster4.SetRadius(0.200000)
...
CloakingDevice.SetPosition(0.000000, 0.00000, 0.000000)
...
CloakingDevice.SetCloakStrength(5000.000000)
