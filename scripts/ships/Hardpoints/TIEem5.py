# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\TIEem5.py
...
ShieldGenerator.SetPosition(0.000000, -0.006000, 0.005000)
...
MissileSystem.SetPosition(0.000000, 0.010000, -0.012000)
...
TIEEngine.SetPosition(0.000000, -0.005000, 0.000000)
TIEEngine.SetPosition2D(0.000000, 0.000000)
TIEEngine.SetRepairComplexity(1.000000)
TIEEngine.SetDisabledPercentage(0.500000)
TIEEngine.SetRadius(0.007500)
TIEEngine.SetNormalPowerPerSecond(90.000000)
TIEEngine.SetMaxAccel(6.000000)
...
Laser1.SetPrimary(1)
Laser1.SetPosition(-0.002600, 0.020000, -0.011500)
...
Laser2.SetPrimary(1)
Laser2.SetPosition(0.002600, 0.020000, -0.011500)
...
Laser2.SetIconPositionX(81)
Laser2.SetIconPositionY(57)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 0.025600, 0.000000)
...
#################################################
SublightBooster = App.EngineProperty_Create("Sublight Booster")

SublightBooster.SetMaxCondition(200.000000)
SublightBooster.SetCritical(0)
SublightBooster.SetTargetable(1)
SublightBooster.SetPrimary(1)
SublightBooster.SetPosition(0.000000, -0.044000, 0.000000)
SublightBooster.SetPosition2D(0, 0)
SublightBooster.SetRepairComplexity(1.000000)
SublightBooster.SetDisabledPercentage(0.500000)
SublightBooster.SetRadius(0.005000)
SublightBooster.SetEngineType(SublightBooster.EP_IMPULSE)
App.g_kModelPropertyManager.RegisterLocalTemplate(SublightBooster)
#################################################
...
Hyperdrive.SetPosition(0.000000, -0.035000, 0.000000)
Hyperdrive.SetPosition2D(0, 0)
Hyperdrive.SetRepairComplexity(1.000000)
Hyperdrive.SetDisabledPercentage(0.500000)
Hyperdrive.SetRadius(0.006500)
Hyperdrive.SetNormalPowerPerSecond(175.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Sublight Booster", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
