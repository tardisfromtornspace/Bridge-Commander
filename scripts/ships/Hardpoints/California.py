...
SensorArray.SetDisabledPercentage(0.001000)
...
WarpCore.SetDisabledPercentage(0.005000)
...
Phasers.SetDisabledPercentage(0.000001)
...
Torpedoes.SetDisabledPercentage(0.000001)
...
ForwardTube1.SetDisabledPercentage(0.001000)
...
ForwardTube2.SetDisabledPercentage(0.001000)
