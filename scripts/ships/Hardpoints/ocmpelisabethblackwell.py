# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpelisabethblackwell.py
...
Hull.SetMaxCondition(14211.000000)
Hull.SetCritical(1)
...
ImpulseEngines.SetMaxCondition(2074.000000)
...
ShieldGenerator.SetMaxCondition(2700.000000)
...
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.blackelmtype2quantum")
