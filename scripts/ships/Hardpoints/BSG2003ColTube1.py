...
# Local Templates
#################################################
Tanker = App.ShipProperty_Create("Tanker")

Tanker.SetGenus(1)
Tanker.SetSpecies(108)
Tanker.SetMass(220.000000)
Tanker.SetRotationalInertia(10000.000000)
Tanker.SetShipName("ColTube1")
Tanker.SetModelFilename("data/Models/Ships/ColTube1/ColTube1.nif")
Tanker.SetDamageResolution(0.001000)
Tanker.SetAffiliation(0)
Tanker.SetStationary(0)
Tanker.SetAIString("NonFedAttack")
Tanker.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(Tanker)
#################################################
...
Hull.SetMaxCondition(115.000000)
Hull.SetCritical(1)
...
#################################################
Module1 = App.HullProperty_Create("Module 1")

Module1.SetMaxCondition(34.000000)
Module1.SetCritical(0)
Module1.SetTargetable(1)
Module1.SetPrimary(0)
Module1.SetPosition(-1.250000, 0.000000, 0.000000)
Module1.SetPosition2D(64.000000, 64.000000)
Module1.SetRepairComplexity(3.000000)
Module1.SetDisabledPercentage(0.000000)
Module1.SetRadius(0.250000)
App.g_kModelPropertyManager.RegisterLocalTemplate(Module1)
#################################################
Module2 = App.HullProperty_Create("Module 2")

Module2.SetMaxCondition(34.000000)
Module2.SetCritical(0)
Module2.SetTargetable(1)
Module2.SetPrimary(0)
Module2.SetPosition(-0.500000, 0.000000, -0.750000)
Module2.SetPosition2D(64.000000, 64.000000)
Module2.SetRepairComplexity(3.000000)
Module2.SetDisabledPercentage(0.000000)
Module2.SetRadius(0.250000)
App.g_kModelPropertyManager.RegisterLocalTemplate(Module2)
#################################################
Module3 = App.HullProperty_Create("Module 3")

Module3.SetMaxCondition(34.000000)
Module3.SetCritical(0)
Module3.SetTargetable(1)
Module3.SetPrimary(0)
Module3.SetPosition(0.500000, 0.000000, -0.750000)
Module3.SetPosition2D(64.000000, 64.000000)
Module3.SetRepairComplexity(3.000000)
Module3.SetDisabledPercentage(0.000000)
Module3.SetRadius(0.250000)
App.g_kModelPropertyManager.RegisterLocalTemplate(Module3)
#################################################
Module4 = App.HullProperty_Create("Module 4")

Module4.SetMaxCondition(34.000000)
Module4.SetCritical(0)
Module4.SetTargetable(1)
Module4.SetPrimary(0)
Module4.SetPosition(1.250000, 0.000000, 0.000000)
Module4.SetPosition2D(64.000000, 64.000000)
Module4.SetRepairComplexity(3.000000)
Module4.SetDisabledPercentage(0.000000)
Module4.SetRadius(0.250000)
App.g_kModelPropertyManager.RegisterLocalTemplate(Module4)
#################################################
...
PowerCore.SetMaxCondition(72.000000)
...
Engine1.SetPosition(0.100000, -5.200000, 0.100000)
...
Engine2.SetPosition(-0.100000, -5.200000, 0.100000)
...
def LoadPropertySet(pObj):
	...
	prop = App.g_kModelPropertyManager.FindByName("Tanker", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Module 1", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Module 2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Module 3", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Module 4", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
