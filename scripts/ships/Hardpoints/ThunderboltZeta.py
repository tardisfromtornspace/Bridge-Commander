# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\ThunderboltZeta.py
...
#################################################
ThunderboltZeta = App.ShipProperty_Create("ThunderboltZeta")

ThunderboltZeta.SetGenus(1)
ThunderboltZeta.SetSpecies(401)
ThunderboltZeta.SetMass(9.000000)
ThunderboltZeta.SetRotationalInertia(2000.000000)
ThunderboltZeta.SetShipName("ThunderboltZeta")
ThunderboltZeta.SetModelFilename("data/Models/Ships/Thunderbolt/Thunderbolt.nif")
ThunderboltZeta.SetDamageResolution(5.000000)
ThunderboltZeta.SetAffiliation(0)
ThunderboltZeta.SetStationary(0)
ThunderboltZeta.SetAIString("NonFedAttack")
ThunderboltZeta.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(ThunderboltZeta)
#################################################
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("ThunderboltZeta", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
