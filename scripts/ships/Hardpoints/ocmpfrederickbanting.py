# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpfrederickbanting.py
...
Hull.SetMaxCondition(14010.000000)
Hull.SetCritical(1)
...
ImpulseEngines.SetMaxCondition(2100.000000)
...
RepairSystem.SetMaxCondition(290.000000)
...
ShieldGenerator.SetMaxCondition(2695.000000)
...
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.blackelmtype3quantum")
