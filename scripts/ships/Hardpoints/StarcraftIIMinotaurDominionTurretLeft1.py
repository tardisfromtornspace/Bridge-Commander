...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretLeft1")
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Star Laser Battery 1B")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Star Laser Battery 1B", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)