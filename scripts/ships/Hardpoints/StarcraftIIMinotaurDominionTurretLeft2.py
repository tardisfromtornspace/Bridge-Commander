...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretLeft2")
...
#################################################
StarDisruptor1 = App.PulseWeaponProperty_Create("Star Laser Battery 2")
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Star Laser Battery 2B")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Star Laser Battery 2B", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)