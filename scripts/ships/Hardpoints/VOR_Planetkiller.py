...
BioOrganicHull.SetMaxCondition(50000.000000)
BioOrganicHull.SetCritical(1)
BioOrganicHull.SetTargetable(0)
BioOrganicHull.SetPrimary(1)
BioOrganicHull.SetPosition(0.000000, 15.000000, -2.000000)
BioOrganicHull.SetPosition2D(65.000000, 65.000000)
BioOrganicHull.SetRepairComplexity(15.000000)
BioOrganicHull.SetDisabledPercentage(0.000000)
BioOrganicHull.SetRadius(200.000000)
...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.REAR_SHIELDS, 800.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.TOP_SHIELDS, 800.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.BOTTOM_SHIELDS, 800.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.LEFT_SHIELDS, 800.000000)
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.RIGHT_SHIELDS, 800.000000)
...
SensorArray.SetRadius(10.170000)
...
ImpulseEngines.SetPosition(0.000000, -15.000000, 0.000000)
...
ImpulseEngines.SetRadius(5.250000)
...
GraviticEngine.SetRadius(6.060000)
GraviticEngine.SetEngineType(GraviticEngine.EP_IMPULSE)
App.g_kModelPropertyManager.RegisterLocalTemplate(GraviticEngine)
#################################################
VOR_Cruiser = App.ShipProperty_Create("VOR_Planetkiller")

VOR_Cruiser.SetGenus(1)
VOR_Cruiser.SetSpecies(101)
VOR_Cruiser.SetMass(11000000.000000)
VOR_Cruiser.SetRotationalInertia(8000.000000)
VOR_Cruiser.SetShipName("VOR_Planetkiller")
VOR_Cruiser.SetModelFilename("data/Models/Ships/VOR_Planetkiller/VOR_Planetkiller.nif")
...
VorlonBeam.SetPosition(0.000000, 6.000000, 0.000000)
...
ForwardTractor.SetRadius(1.200000)
...
VortexGenerator.SetRadius(5.100000)
...
JumpspaceDriveA.SetRadius(8.200000)
