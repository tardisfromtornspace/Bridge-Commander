# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\TWing.py
...
Engine1.SetMaxCondition(60.000000)
Engine1.SetCritical(0)
Engine1.SetTargetable(1)
Engine1.SetPrimary(1)
Engine1.SetPosition(0.000000, -0.040000, 0.024600)
...
Engine2.SetMaxCondition(60.000000)
Engine2.SetCritical(0)
Engine2.SetTargetable(1)
Engine2.SetPrimary(1)
Engine2.SetPosition(0.032800, -0.029000, -0.013200)
...
Engine3.SetMaxCondition(60.000000)
Engine3.SetCritical(0)
Engine3.SetTargetable(1)
Engine3.SetPrimary(1)
Engine3.SetPosition(-0.032800, -0.029000, -0.013200)
...
IonEngines.SetMaxCondition(60.000000)
...
IonEngines.SetMaxAccel(3.200000)
IonEngines.SetMaxAngularAccel(1.450000)
IonEngines.SetMaxAngularVelocity(0.940000)
IonEngines.SetMaxSpeed(5.900000)
...
R5Astromech.SetMaxCondition(55.000000)
R5Astromech.SetCritical(0)
R5Astromech.SetTargetable(1)
R5Astromech.SetPrimary(1)
R5Astromech.SetPosition(0.000000, -0.008000, 0.015000)
...
R5Astromech.SetRadius(0.002000)
R5Astromech.SetNormalPowerPerSecond(30.000000)
R5Astromech.SetMaxRepairPoints(125.000000)
R5Astromech.SetNumRepairTeams(1)
App.g_kModelPropertyManager.RegisterLocalTemplate(R5Astromech)
#################################################
SensorArray = App.SensorProperty_Create("Sensor Array")

SensorArray.SetMaxCondition(60.000000)
...
ShieldGenerator.SetMaxShields(ShieldGenerator.FRONT_SHIELDS, 70.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.REAR_SHIELDS, 70.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.TOP_SHIELDS, 55.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 55.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.LEFT_SHIELDS, 55.000000)
ShieldGenerator.SetMaxShields(ShieldGenerator.RIGHT_SHIELDS, 55.000000)
...
#################################################
TWing = App.ShipProperty_Create("TWing")

TWing.SetGenus(0)
TWing.SetSpecies(401)
TWing.SetMass(9.100000)
TWing.SetRotationalInertia(2200.000000)
TWing.SetShipName("T Wing")
TWing.SetModelFilename("data/Models/Ships/T-Wing.nif")
TWing.SetDamageResolution(4.000000)
TWing.SetAffiliation(0)
TWing.SetStationary(0)
TWing.SetAIString("NonFedAttack")
TWing.SetDeathExplosionSound("g_lsDeathExplosions")
App.g_kModelPropertyManager.RegisterLocalTemplate(TWing)
#################################################
LaserEmiter = App.WeaponSystemProperty_Create("Laser Emiter")

LaserEmiter.SetMaxCondition(60.000000)
...
Torpedosystem.SetMaxCondition(60.000000)
...
TorpedoSystem.SetTargetable(1)
TorpedoSystem.SetPrimary(1)
TorpedoSystem.SetPosition(0.000000, 0.010000, -0.004000)
...
TorpedoSystem.SetNormalPowerPerSecond(80.000000)
TorpedoSystem.SetWeaponSystemType(TorpedoSystem.WST_TORPEDO)
...
Torpedo1.SetMaxCondition(60.000000)
Torpedo1.SetCritical(0)
Torpedo1.SetTargetable(0)
Torpedo1.SetPrimary(1)
Torpedo1.SetPosition(-0.008800, 0.001000, -0.002500)
...
Torpedo2.SetMaxCondition(60.000000)
Torpedo2.SetCritical(0)
Torpedo2.SetTargetable(0)
Torpedo2.SetPrimary(1)
Torpedo2.SetPosition(0.008800, 0.001000, -0.002500)
...
Laser1.SetMaxCondition(60.000000)
Laser1.SetCritical(0)
Laser1.SetTargetable(1)
Laser1.SetPrimary(1)
Laser1.SetPosition(0.001780, 0.064000, -0.002930)
...
Laser2.SetMaxCondition(60.000000)
Laser2.SetCritical(0)
Laser2.SetTargetable(1)
Laser2.SetPrimary(1)
Laser2.SetPosition(-0.001780, 0.064000, -0.002930)
...
Cockpit.SetMaxCondition(80.000000)
Cockpit.SetCritical(1)
Cockpit.SetTargetable(1)
Cockpit.SetPrimary(0)
Cockpit.SetPosition(0.000000, 0.003000, 0.009000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("TWing", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
