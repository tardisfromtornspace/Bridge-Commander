...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretBackRight")
...
#################################################
StarDisruptor1 = App.PulseWeaponProperty_Create("Dorsal Laser Battery 4")
...
StarDisruptor1.SetPosition(0.085000, -0.040000, 0.000000)
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Dorsal Laser Battery 4B")
...
StarDisruptor2.SetPosition(-0.085000, 0.040000, 0.000000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Dorsal Laser Battery 4B", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)