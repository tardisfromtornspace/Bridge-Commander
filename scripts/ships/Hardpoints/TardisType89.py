...
Hull.SetMaxCondition(6005000.000000)
Hull.SetCritical(1)
...
Tardis.SetShipName("TardisType89")
...
#################################################
ForwardTractor = App.TractorBeamProperty_Create("A tractor")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("A tractor", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
