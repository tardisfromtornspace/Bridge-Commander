...
ShieldGenerator.SetShieldChargePerSecond(ShieldGenerator.FRONT_SHIELDS, 400.000000)
...
BiobeamEmitter.SetPosition(0.000000, 5.440000, 0.000000)
...
BiobeamEmitter.SetMaxDamage(2000.000000)
