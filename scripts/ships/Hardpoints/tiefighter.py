# C:\Program Files\Activision\Bridge Commander\scripts\ships\Hardpoints\tiefighter.py
...
IonEngine1.SetPosition(-0.008700, -0.008300, 0.000200)
...
IonEngine2.SetPosition(0.008700, -0.008300, 0.000200)
...
Sensor.SetPrimary(1)
Sensor.SetPosition(0.000000, 0.005000, -0.009500)
...
Sensor.SetBaseSensorRange(920.000000)
...
TIEEngine.SetMaxAccel(3.000000)
...
Laser1.SetPrimary(1)
Laser1.SetPosition(-0.002100, 0.008300, -0.009000)
...
Laser2.SetPrimary(1)
Laser2.SetPosition(0.002100, 0.008300, -0.009000)
...
ViewscreenForwardPosition.SetXYZ(0.000000, 0.018500, 0.000000)
...
ViewscreenBackPosition.SetXYZ(0.000000, 0.068000, 0.000000)
...
Dummy.SetPrimary(1)
Dummy.SetPosition(0.000000, 0.000000, -0.011000)
