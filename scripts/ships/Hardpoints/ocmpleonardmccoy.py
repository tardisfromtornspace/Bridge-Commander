# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpleonardmccoy.py
...
Hull.SetMaxCondition(14052.000000)
Hull.SetCritical(1)
...
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.blackelmtype5quantum")
