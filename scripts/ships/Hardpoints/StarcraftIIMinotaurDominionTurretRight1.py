...
Ship.SetShipName("StarcraftIIMinotaurDominionTurretRight1")
...
#################################################
StarDisruptor1 = App.PulseWeaponProperty_Create("Port Laser Battery 1")
...
#################################################
StarDisruptor2 = App.PulseWeaponProperty_Create("Port Laser Battery 1B")
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Port Laser Battery 1B", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)