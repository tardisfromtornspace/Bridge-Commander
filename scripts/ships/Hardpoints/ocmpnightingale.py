# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpnightingale.py
...
Hull.SetMaxCondition(14078.000000)
Hull.SetCritical(1)
...
Torpedoes.SetTorpedoScript(0, "Tactical.Projectiles.DS9Photon")
