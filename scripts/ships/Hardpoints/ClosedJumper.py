...
Engines.SetMaxCondition(750.000000)
...
SensorArray.SetMaxCondition(650.000000)
...
PuddleJumper.SetMass(50.000000)
...
PortEngine.SetMaxCondition(700.000000)
...
StarEngine.SetMaxCondition(700.000000)
...
Repair.SetMaxCondition(750.000000)
...
#################################################
Drones = App.TorpedoSystemProperty_Create("Drones 2")

Drones.SetMaxCondition(450.000000)
...
Drones.SetNormalPowerPerSecond(0.000000)
...
CloakingDevice.SetMaxCondition(300.000000)
...
ShuttleBay.SetMaxCondition(60.000000)
...
ShuttleBay.SetDisabledPercentage(0.550000)
...
def LoadPropertySet(pObj):
	...
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
	prop = App.g_kModelPropertyManager.FindByName("Drones 2", App.TGModelPropertyManager.LOCAL_TEMPLATES)
	if (prop != None):
		pObj.AddToSet("Scene Root", prop)
