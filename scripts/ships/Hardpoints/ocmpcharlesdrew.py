# C:\Activison\Bridge Commander\scripts\ships\Hardpoints\ocmpcharlesdrew.py
...
Hull.SetMaxCondition(14030.000000)
Hull.SetCritical(1)
...
ImpulseEngines.SetMaxCondition(2030.000000)
...
WarpCore.SetMaxCondition(2070.000000)
...
RepairSystem.SetMaxCondition(245.000000)
...
RepairSystem.SetRepairComplexity(1.500000)
...
Phasers.SetMaxCondition(8030.000000)
...
Repair.SetMaxCondition(2123.000000)
...
WarpEngines.SetMaxCondition(1650.000000)
...
PortWarp.SetMaxCondition(825.000000)
...
StarWarp.SetMaxCondition(825.000000)
...
Torpedoes.SetTorpedoScript(0, "Tactical.Projectiles.TNGPhoton")
Torpedoes.SetMaxTorpedoes(1, 75)
Torpedoes.SetTorpedoScript(1, "Tactical.Projectiles.blackelmtype1quantum")
