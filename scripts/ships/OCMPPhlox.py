...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/Phlox/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/Phlox/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/Phlox/CI_OLYMPIC.nif",
		"Name": "OCMPPhlox",
		"HardpointFile": "ocmpphlox",
