...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/AndisitePS/AndisitePS.nif",
		"FilenameMed": "data/Models/Ships/AndisitePS/AndisitePS.nif",
		"FilenameLow": "data/Models/Ships/AndisitePS/AndisitePS.nif",
		"Name": "AndisitePS",
		"HardpointFile": "AndisitePS",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 2, 120.0, 15.0, 15.0, 135000, 300000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  2, 300.0, 15.0, 15.0, 135000, 300000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  2, 600.0, 15.0, 30.0, 135000, 300000, "_glow", None, "_specular")
