...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradoOrderBC/TradoOrderBC.nif",
		"FilenameMed": "data/Models/Ships/TradoOrderBC/TradoOrderBC.nif",
		"FilenameLow": "data/Models/Ships/TradoOrderBC/TradoOrderBC.nif",
		"Name": "TradoOrderBC",
		"HardpointFile": "TradoOrderBC",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 120.0, 15.0, 15.0, 20000000, 33750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 300.0, 15.0, 15.0, 20000000, 33750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 600.0, 15.0, 30.0, 20000000, 33750000, "_glow", None, "_specular")
