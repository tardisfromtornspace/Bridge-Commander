...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Solaria/GalaticaBS75.nif",
		"FilenameMed": "data/Models/Ships/Solaria/GalaticaBS75.nif",
		"FilenameLow": "data/Models/Ships/Solaria/GalaticaBS75.nif",
		"Name": "Solaria",
