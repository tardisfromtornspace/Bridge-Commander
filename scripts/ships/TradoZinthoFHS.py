...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradoZinthoFHS/TradoZinthoFHS.nif",
		"FilenameMed": "data/Models/Ships/TradoZinthoFHS/TradoZinthoFHS.nif",
		"FilenameLow": "data/Models/ships/TradoZinthoFHS/TradoZinthoFHS.nif",
		"Name": "TradoZinthoFHS",
		"HardpointFile": "TradoZinthoFHS",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 200.0, 15.0, 15.0, 16000000, 29000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 400.0, 15.0, 15.0, 16000000, 29000000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 800.0, 15.0, 30.0, 16000000, 29000000, "_glow", None, None)
