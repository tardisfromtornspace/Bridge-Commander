...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/TristanAdams/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/TristanAdams/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/TristanAdams/CI_OLYMPIC.nif",
		"Name": "OCMPTristanAdams",
		"HardpointFile": "ocmptristanadams",
