...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Bases/warpspace/outer.NIF",
		"FilenameMed": "data/Models/Bases/warpspace/outer.NIF",
		"FilenameLow": "data/Models/Bases/warpspace/outer.NIF",
		"Name": "warpspace",
		"HardpointFile": "warpspace",
