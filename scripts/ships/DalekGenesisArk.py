...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Dalek2005/DalekGenesisArk.nif",
		"FilenameMed": "data/Models/Ships/Dalek2005/DalekGenesisArk.nif",
		"FilenameLow": "data/Models/Ships/Dalek2005/DalekGenesisArk.nif",
		"Name": "DalekGenesisArk",
		"HardpointFile": "DalekGenesisArk",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 600.0, 0.0, 0.0, 0, 0, "_glow", None, None)
		pLODModel.AddLOD(pStats["FilenameMed"], 10, 1200.0, 0.0, 0.0, 0, 0, "_glow", None, None)
