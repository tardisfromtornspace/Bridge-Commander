...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/MBenga/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/MBenga/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/MBenga/CI_OLYMPIC.nif",
		"Name": "OCMPMBenga",
		"HardpointFile": "ocmpmbenga",
