...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WCExcelsior/WCds9excel.nif",
		"FilenameMed": "data/Models/Ships/WCExcelsior/WCds9excel.nif",
		"FilenameLow": "data/Models/ships/WCExcelsior/WCds9excel.nif",
		"Name": "WCexcelfrederickson",
		"HardpointFile": "WCexcelDS9",
