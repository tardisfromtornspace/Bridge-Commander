...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/WCExcelsior/WCexcelrefit.nif",
		"FilenameMed": "data/Models/Ships/WCExcelsior/WCexcelrefit.nif",
		"FilenameLow": "data/Models/ships/WCExcelsior/WCexcelrefit.nif",
		"Name": "WCexcelalbatani",
		"HardpointFile": "WCexcelrefitDS9",
