...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/CharlesDrew/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/CharlesDrew/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/CharlesDrew/CI_OLYMPIC.nif",
		"Name": "OCMPCharlesDrew",
		"HardpointFile": "ocmpcharlesdrew",
