...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/Protostar Pieces/ProtocoreFinTop.NIF",
		"FilenameMed": "data/Models/Ships/Protostar Pieces/ProtocoreFinTop.NIF",
		"FilenameLow": "data/Models/Ships/Protostar Pieces/ProtocoreFinTop.NIF",
