...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/TradophianBC/TradophianBC.nif",
		"FilenameMed": "data/Models/Ships/TradophianBC/TradophianBC.nif",
		"FilenameLow": "data/Models/Ships/TradophianBC/TradophianBC.nif",
		"Name": "TradophianBC",
		"HardpointFile": "TradophianBC",
...
def LoadModel(bPreLoad = 0):
	...
	if (not App.g_kLODModelManager.Contains(pStats["Name"])):
		...
		pLODModel.AddLOD(pStats["FilenameHigh"], 10, 120.0, 15.0, 15.0, 4000000, 6750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameMed"],  10, 300.0, 15.0, 15.0, 4000000, 6750000, "_glow", None, "_specular")
		pLODModel.AddLOD(pStats["FilenameLow"],  10, 600.0, 15.0, 30.0, 4000000, 6750000, "_glow", None, "_specular")
