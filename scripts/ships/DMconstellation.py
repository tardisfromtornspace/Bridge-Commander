...
def GetShipStats():
	kShipStats = {
		"DamageRadMod" : 0.75, 
		"DamageStrMod" : 0.75, 
		"FilenameHigh": "data/Models/Ships/DMconstellation/constellation.nif",
		"FilenameMed": "data/Models/Ships/DMconstellation/constellation.nif",
		"FilenameLow": "data/Models/Ships/DMconstellation/constellation.nif",
		"Name": "DMconstellation",
		"HardpointFile": "DMconstellation",
