...
def GetShipStats():
	kShipStats = {
		"FilenameHigh": "data/Models/Ships/OCMP/RogerKorby/CI_OLYMPIC.nif",
		"FilenameMed": "data/Models/Ships/OCMP/RogerKorby/CI_OLYMPIC.nif",
		"FilenameLow": "data/Models/Ships/OCMP/RogerKorby/CI_OLYMPIC.nif",
		"Name": "OCMPRogerKorby",
		"HardpointFile": "ocmprogerkorby",
