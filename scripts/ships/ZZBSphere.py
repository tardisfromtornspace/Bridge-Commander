...
def GetShipStats():
    kShipStats = {
        'FilenameHigh': 'data/Models/Ships/ZZBorgSC/ZZBSphere.nif',
        'FilenameMed': 'data/Models/Ships/ZZBorgSC/ZZBSphere.nif',
        'FilenameLow': 'data/Models/Ships/ZZBorgSC/ZZBSphere.nif',
        'Name': 'ZZBSphere',
        'HardpointFile': 'ZZBSphereHP',
