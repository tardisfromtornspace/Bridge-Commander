...
def MapScancodes():
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKSLASH, App.KY_SEPARATOR, pDatabase, "\\")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_TILDE, App.KY_BACKQUOTE, pDatabase, "~", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EXCLAMATION, App.KY_1, pDatabase, "!", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AT_SIGN, App.KY_2, pDatabase, "@", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_3, pDatabase, "#", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_DOUBLE_QUOTE, App.KY_QUOTE, pDatabase, "\"", App.KY_SHIFT)
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_BACKQUOTE, pDatabase, "`", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_1, App.KY_1, pDatabase, "ALT-1", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_2, App.KY_2, pDatabase, "ALT-2", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_3, App.KY_3, pDatabase, "ALT-3", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_4, App.KY_4, pDatabase, "ALT-4", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_5, App.KY_5, pDatabase, "ALT-5", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_6, App.KY_6, pDatabase, "ALT-6", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_7, App.KY_7, pDatabase, "ALT-7", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_8, App.KY_8, pDatabase, "ALT-8", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_9, App.KY_9, pDatabase, "ALT-9", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_0, App.KY_0, pDatabase, "ALT-0", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_MINUS, App.KY_MINUS, pDatabase, "-", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EQUALS, App.KY_EQUALS, pDatabase, "=", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_Q, App.KY_Q, pDatabase, "ALT-Q", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_W, App.KY_W, pDatabase, "ALT-W", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_E, App.KY_E, pDatabase, "ALT-E", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_R, App.KY_R, pDatabase, "ALT-R", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_T, App.KY_T, pDatabase, "ALT-T", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_Y, App.KY_Y, pDatabase, "ALT-Y", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_U, App.KY_U, pDatabase, "ALT-U", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_I, App.KY_I, pDatabase, "ALT-I", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_O, App.KY_O, pDatabase, "ALT-O", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_P, App.KY_P, pDatabase, "ALT-P", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_A, App.KY_A, pDatabase, "ALT-A", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_S, App.KY_S, pDatabase, "ALT-S", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_D, App.KY_D, pDatabase, "ALT-D", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_F, App.KY_F, pDatabase, "ALT-F", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_G, App.KY_G, pDatabase, "ALT-G", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_H, App.KY_H, pDatabase, "ALT-H", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_J, App.KY_J, pDatabase, "ALT-J", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_K, App.KY_K, pDatabase, "ALT-K", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_L, App.KY_L, pDatabase, "ALT-L", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEMICOLON, App.KY_SEMICOLON, pDatabase, ";", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_QUOTE, pDatabase, "'", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_Z, App.KY_Z, pDatabase, "ALT-Z", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_X, App.KY_X, pDatabase, "ALT-X", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_C, App.KY_C, pDatabase, "ALT-C", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_V, App.KY_V, pDatabase, "ALT-V", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_B, App.KY_B, pDatabase, "ALT-B", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_N, App.KY_N, pDatabase, "ALT-N", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ALT_M, App.KY_M, pDatabase, "ALT-M", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COMMA, App.KY_COMMA, pDatabase, ",", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PERIOD, App.KY_PERIOD, pDatabase, ".", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SLASH, App.KY_SLASH, pDatabase, "/", App.KY_ALTGR)
