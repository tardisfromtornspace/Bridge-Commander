...
Foundation.ShipDef.VOR_Fighter = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })
...
Foundation.ShipDef.VOR_Fighter.SubSubMenu = "Fighters"
