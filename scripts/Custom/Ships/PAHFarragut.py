...
longName = 'PAH U.S.S. Farragut'
shipFile = 'PAHFarragut' 
menuGroup = 'Fed Ships'
...
Foundation.ShipDef.PAHFarragut = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHFarragut.fMaxWarp = 7.5
Foundation.ShipDef.PAHFarragut.fCruiseWarp = 9.2
Foundation.ShipDef.PAHFarragut.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHFarragut.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHFarragut.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHFarragut.RegisterQBPlayerShipMenu(playerMenuGroup)