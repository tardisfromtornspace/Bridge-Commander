...
longName = 'PAH U.S.S. Yorktown'
shipFile = 'PAHYorktown' 
menuGroup = 'Fed Ships'
...
Foundation.ShipDef.PAHYorktown = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHYorktown.fMaxWarp = 7.5
Foundation.ShipDef.PAHYorktown.fCruiseWarp = 9.2
Foundation.ShipDef.PAHYorktown.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHYorktown.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHYorktown.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHYorktown.RegisterQBPlayerShipMenu(playerMenuGroup)
