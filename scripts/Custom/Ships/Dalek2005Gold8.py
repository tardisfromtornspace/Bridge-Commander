...
Foundation.ShipDef.Dalek2005Gold8 = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })
Foundation.ShipDef.Dalek2005Gold8.dTechs = {
	'Adv Armor Tech': 1,
