...
if menuGroup:           Foundation.ShipDef.TiconderogaA.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.TiconderogaA.RegisterQBPlayerShipMenu(playerMenuGroup)
