...
Foundation.ShipDef.DraziSkySerpent.dTechs = {
	'Simulated Point Defence' : { "Distance": 10.0, "InnerDistance": 3.0, "Effectiveness": 0.7, "LimitTurn": 4.5, "LimitSpeed": 70, "LimitDamage": "-150", "Period": 0.3, "MaxNumberTorps": 1, "Pulse": {"Priority": 1}},
	"Tachyon Sensors": 2.5
}
