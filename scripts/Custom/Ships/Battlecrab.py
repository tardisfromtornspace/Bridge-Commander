...
SubMenu = "The Shadows"
Foundation.ShipDef.Battlecrab = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })

Foundation.ShipDef.Battlecrab.dTechs = { "Phase Cloak": 10, 'Breen Drainer Immune': 1}
