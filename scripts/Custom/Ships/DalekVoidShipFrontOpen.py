...
abbrev = 'DalekVoidShipFrontOpen'
iconName = 'DalekVoidShipOpen'
longName = 'Open Dalek Void Ship'
shipFile = 'DalekVoidShipFrontOpen'
...
Foundation.ShipDef.DalekVoidShipFrontOpen = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })

Foundation.ShipDef.DalekVoidShipFrontOpen.dTechs = {
	'Adv Armor Tech': 1,
