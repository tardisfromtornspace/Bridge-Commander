...
longName = 'PAH U.S.S. Excalibur'
shipFile = 'PAHExcalibur' 
menuGroup = 'Fed Ships'
...
Foundation.ShipDef.PAHExcalibur = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHExcalibur.fMaxWarp = 7.5
Foundation.ShipDef.PAHExcalibur.fCruiseWarp = 9.2
Foundation.ShipDef.PAHExcalibur.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHExcalibur.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHExcalibur.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHExcalibur.RegisterQBPlayerShipMenu(playerMenuGroup)