...
Foundation.ShipDef.NarnFraziFighter.dTechs = {
	'Simulated Point Defence' : { "Distance": 10.0, "InnerDistance": 3.0, "Effectiveness": 0.7, "LimitTurn": 4.4, "LimitSpeed": 67, "LimitDamage": "-120", "Period": 0.5, "MaxNumberTorps": 1, "Pulse": {"Priority": 1}}
}
