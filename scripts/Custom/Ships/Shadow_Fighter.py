...
SubMenu = "The Shadows"
Foundation.ShipDef.Shadow_Fighter = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })
...
Foundation.ShipDef.Shadow_Fighter.SubSubMenu = "Fighters"
