...
abbrev = 'DalekVoidShipBackOpen'
iconName = 'DalekVoidShipOpen'
longName = 'Open Dalek Void Ship'
shipFile = 'DalekVoidShipBackOpen'
...
Foundation.ShipDef.DalekVoidShipBackOpen = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })

Foundation.ShipDef.DalekVoidShipBackOpen.dTechs = {
	'Adv Armor Tech': 1,
