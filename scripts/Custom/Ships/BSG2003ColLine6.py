...
#######################################################################################
#                                                                                     #
abbrev = 'BSG2003ColLine6'
iconName = 'ColLine6'
longName = 'Olympic Carrier'
shipFile = 'BSG2003ColLine6' 
...
#                                                                                     #
Foundation.ShipDef.BSG2003ColLine6 = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })

Foundation.ShipDef.BSG2003ColLine6.dTechs = {
	"Alternate-Warp-FTL": {
		"Setup": {
