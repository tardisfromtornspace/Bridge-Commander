...
#######################################################################################
#                                                                                     #
abbrev = 'BSG2003ColLine4'
iconName = 'ColLine4'
longName = 'Pan Galactic'
shipFile = 'BSG2003ColLine4' 
...
#                                                                                     #
Foundation.ShipDef.BSG2003ColLine4 = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })

Foundation.ShipDef.BSG2003ColLine4.dTechs = {
	"Alternate-Warp-FTL": {
		"Setup": {
