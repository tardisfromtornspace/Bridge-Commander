...
abbrev = 'DalekVoidShipCupOpen'
iconName = 'DalekVoidShipOpen'
longName = 'Open Dalek Void Ship'
shipFile = 'DalekVoidShipCupOpen'
...
Foundation.ShipDef.DalekVoidShipCupOpen = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })

Foundation.ShipDef.DalekVoidShipCupOpen.dTechs = {
	'Adv Armor Tech': 1,
