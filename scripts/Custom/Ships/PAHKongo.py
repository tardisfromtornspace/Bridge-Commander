...
Foundation.ShipDef.PAHKongo = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHKongo.fMaxWarp = 7.5
Foundation.ShipDef.PAHKongo.fCruiseWarp = 9.2
Foundation.ShipDef.PAHKongo.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHKongo.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHKongo.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHKongo.RegisterQBPlayerShipMenu(playerMenuGroup)