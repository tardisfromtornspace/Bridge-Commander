...
abbrev = 'BattleTardisChamaleon'
iconName = 'BattleTardis'
longName = 'Type 560 TARDIS (Chamaleon)'
shipFile = 'BattleTardisChamaleon'
...
Foundation.ShipDef.BattleTardisChamaleon = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": TimeLord })
Foundation.ShipDef.BattleTardisChamaleon.dTechs = {
	'Adv Armor Tech': 1,
