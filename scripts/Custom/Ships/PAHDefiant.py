...
Foundation.ShipDef.PAHDefiant = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHDefiant.fMaxWarp = 7.5
Foundation.ShipDef.PAHDefiant.fCruiseWarp = 9.2
Foundation.ShipDef.PAHDefiant.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHDefiant.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHDefiant.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHDefiant.RegisterQBPlayerShipMenu(playerMenuGroup)
