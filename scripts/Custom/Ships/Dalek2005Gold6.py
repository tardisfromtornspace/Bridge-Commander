...
Foundation.ShipDef.Dalek2005Gold6 = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })
Foundation.ShipDef.Dalek2005Gold6.dTechs = {
	'Adv Armor Tech': 1,
