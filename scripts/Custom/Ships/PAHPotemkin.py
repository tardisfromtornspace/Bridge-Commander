...
longName = 'PAH U.S.S. Potemkin'
shipFile = 'PAHPotemkin' 
menuGroup = 'Fed Ships'
...
Foundation.ShipDef.PAHPotemkin = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHPotemkin.fMaxWarp = 7.5
Foundation.ShipDef.PAHPotemkin.fCruiseWarp = 9.2
Foundation.ShipDef.PAHPotemkin.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHPotemkin.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHPotemkin.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHPotemkin.RegisterQBPlayerShipMenu(playerMenuGroup)
