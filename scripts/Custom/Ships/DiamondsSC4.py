...
abbrev = 'DiamondsSC4'
iconName = 'SC4'
longName = 'Endgame SC4'
shipFile = 'DiamondsSC4' 
menuGroup = 'Fed Ships'
...
#                                                                                     #
Foundation.ShipDef.DiamondsSC4 = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu })

Foundation.ShipDef.DiamondsSC4.dTechs = {
