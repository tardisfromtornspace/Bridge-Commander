...
Foundation.ShipDef.PAHHood = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHHood.fMaxWarp = 7.5
Foundation.ShipDef.PAHHood.fCruiseWarp = 9.2
Foundation.ShipDef.PAHHood.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHHood.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHHood.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHHood.RegisterQBPlayerShipMenu(playerMenuGroup)
