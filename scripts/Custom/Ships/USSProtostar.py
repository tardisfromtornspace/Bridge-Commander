...
Foundation.ShipDef.USSProtostar.dTechs = {
	...
	"Alternate-Warp-FTL": {
		"Setup": {
			...
			"AttackModel":          "USSProtostarProtoWarp", #shipFile, # TO-DO COMMENT AND FIX THE OTHERS
			#"BodySetScale": 1.0,
			#"NormalSetScale": 1.0,
			#"WarpSetScale": 1.0,
		...
		"Port Nacelle":     ["USSProtostarPN", {
			...
			"AttackPosition":       [0.005, 0.013, -0.2],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, 0, 0.001],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0, 0],
			"Proto-WarpPosition":       [0.005, 0.013, -0.2],
		...
		"Port Pylon":     ["USSProtostarPP", {
			...
			"Rotation":             [0.002, 0, 0],
			"AttackRotation":         [0, -0.65, 0],
			"AttackDuration":         150.0, # Value is 1/100 of a second
			"AttackPosition":         [0.075, 0.012, -0.05],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, 0, 0.001],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, -0.65, 0],
			"Proto-WarpPosition":       [0.075, 0.012, -0.05],
			"Proto-WarpDuration":       150.0,
			},
		],
		...
		"Port Back Central":     ["USSProtostarSBC", {
			"Experimental": 0,
			"SetScale": 1.4,
			"Position":             [-0.03, 0, 0], # TO-DO ADJUST THIS
			"Rotation":             [0, 0, 0],
			"AttackRotation":         [0, -0.3, 0],
			"AttackDuration":         150.0, # Value is 1/100 of a second
			"AttackPosition":         [-0.075, 0.033, -0.05],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, 0, 0.001],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, -0.3, 0],
			"Proto-WarpPosition":       [-0.075, 0.033, -0.05],
			"Proto-WarpDuration":       150.0,
			},
		],
		...
		"Starboard Back Central":     ["USSProtostarPBC", {
			...
			"AttackRotation":         [0, 0.3, 0],
			"AttackDuration":         150.0, # Value is 1/100 of a second
			"AttackPosition":         [0.075, 0.013, -0.05],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, 0, 0.001],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0.3, 0],
			"Proto-WarpPosition":       [0.075, 0.013, -0.05],
			"Proto-WarpDuration":       150.0,
			},
		],
		...
		"Port PylonP":     ["USSProtostarPDC", {
			...
			"AttackRotation":         [0, 0, 0],
			"AttackDuration":         150.0, # Value is 1/100 of a second
			"AttackPosition":         [0.005, 0.012, -0.015],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, 0, 0.001],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, -0.65, 0],
			"Proto-WarpPosition":       [0.005, 0.4, -0.015],
			"Proto-WarpDuration":       150.0,
			},
		],
		...
		"Starboard Central Body":     ["USSProtostarSD", {
			...
			"Position":             [0, 0, 0],
			"Rotation":             [0, 0, 0],
			"AttackPosition":       [-0.055, 0.01, 0],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, -0.01, 0],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0, 0],
			"Proto-WarpPosition":       [-0.055, 0.01, 0],
			"Proto-WarpDuration":       150.0,
		...
		"Protocore Nacelle":     ["USSProtostarCN", {
			...
			"Position":             [0, 0, 0],
			"Rotation":             [0, 0, 0],
			"AttackPosition":       [0, -0.252, 0.005],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, -0.01, 0],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0, 0],
			"Proto-WarpPosition":       [0, -0.152, 0.005],
		...
		"Central NacelleHU":     ["USSProtostarCNHU", {
			...
			"Position":             [0, 0, -0.005],
			"Rotation":             [0, 0, 0],
			"AttackPosition":       [0, -0.252, 0.015],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, -0.01, 0],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0, 0],
			"Proto-WarpPosition":       [0, -0.262, 0.015],
			"Proto-WarpDuration":       250.0,
			"Proto-WarpDelayEntry":       0.15,
			},
		],
		...
		"Central NacelleHD":     ["USSProtostarCNHD", {
			...
			"Position":             [0, 0, 0.005],
			"Rotation":             [0, 0, 0],
			"AttackPosition":       [0, -0.252, -0.012],
			#"WarpRotation":       [0, 0, 0],
			#"WarpPosition":       [0, -0.01, 0],
			#"WarpDuration":       150.0,
			"Proto-WarpRotation":       [0, 0, 0],
			"Proto-WarpPosition":       [0, -0.262, -0.012],
			"Proto-WarpDuration":       300.0,
			"Proto-WarpDelayEntry":       0.15,
			},
		],
