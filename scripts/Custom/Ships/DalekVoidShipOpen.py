...
Foundation.ShipDef.DalekVoidShipOpen = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "race": Dalek })

Foundation.ShipDef.DalekVoidShipOpen.dTechs = {
	'Adv Armor Tech': 1,
...
'SubModel': {
        "Setup":        {
                ...
                "WarpModel":            "DalekVoidShip",
                "AttackModel":          "DalekVoidShipWhenOpen",
                "Hardpoints":       {
        ...
        "Port Wing":     ["DalekVoidShipFrontOpen", {
                "Position":             [0, 0, 0.0],
                "Rotation":             [-0.4, 0, 0], # normal Rotation used if not Red Alert and if not Warp
                "AttackRotation":         [1.57, 0, 0],
                "AttackDuration":         200.0, # Value 200 is 1/100 of a second
        ...
        "Starboard Wing":     ["DalekVoidShipBackOpen", {
                "Position":             [0, 0, 0.0],
                "Rotation":             [0.4, 0, 0],
                "AttackRotation":         [-1.57, 0, 0],
