...
Foundation.ShipDef.PAHEssex = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHEssex.fMaxWarp = 7.5
Foundation.ShipDef.PAHEssex.fCruiseWarp = 9.2
Foundation.ShipDef.PAHEssex.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'

Foundation.ShipDef.PAHEssex.dTechs = {
...
if menuGroup:           Foundation.ShipDef.PAHEssex.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHEssex.RegisterQBPlayerShipMenu(playerMenuGroup)