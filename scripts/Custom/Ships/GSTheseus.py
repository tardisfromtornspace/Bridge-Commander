...
Foundation.ShipDef.GSTheseus.dTechs = {
	...
	'Drainer Immune': 1,
	"Fed Ablative Armor": {"Plates": ["Forward Ablative Armor", "Aft Ablative Armor", "Dorsal Ablative Armor", "Ventral Ablative Armor", "Port Nacelle Ablative Armor", "Star Nacelle Ablative Armor", "Organic Trimetalic Hull"]},
