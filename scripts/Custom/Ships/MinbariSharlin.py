...
Foundation.ShipDef.MinbariSharlin = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile })
...
Foundation.ShipDef.MinbariSharlin.SubMenu = "Minbari Federation"
Foundation.ShipDef.MinbariSharlin.SubSubMenu = "Capital Ships"
