...
#######################################################################################
#                                                                                     #
abbrev = 'PAHConstitution'
iconName = 'WCJJEnterprise'
longName = 'PAH U.S.S. Constitution'
shipFile = 'PAHConstitution' 
menuGroup = 'Fed Ships'
...
Foundation.ShipDef.PAHConstitution = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, 'SubMenu': SubMenu })

Foundation.ShipDef.PAHConstitution.fMaxWarp = 7.5
Foundation.ShipDef.PAHConstitution.fCruiseWarp = 9.2
Foundation.ShipDef.PAHConstitution.desc = 'This 23rd Century ship is featured in the film Star Trek 2009. The Prime Alternate Hybrid is a envisioned cr.2267 version.'
...
if menuGroup:           Foundation.ShipDef.PAHConstitution.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.PAHConstitution.RegisterQBPlayerShipMenu(playerMenuGroup)
