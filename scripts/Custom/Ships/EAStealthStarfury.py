...
Foundation.ShipDef.EAStealthStarfury.dTechs = {
	'Simulated Point Defence' : { "Distance": 10.0, "InnerDistance": 3.0, "Effectiveness": 0.9, "LimitTurn": 8.5, "LimitSpeed": 78, "LimitDamage": "-15", "Period": 0.3, "MaxNumberTorps": 2, "Pulse": {"Priority": 1}},
	"Tachyon Sensors": 2.18
}
#                                                                                     #
#######################################################################################
#                                                                                     #
