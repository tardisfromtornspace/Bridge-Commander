...
abbrev = 'VictoryTurretTwo'
iconName = 'Victory'
longName = 'VictoryTurretTwo'
shipFile = 'VictoryTurretTwo' 
menuGroup = "Babylon 5"
...
credits = {
	'modName': 'VictoryTurretTwo',   # The full name of your mod if applicable
...
Foundation.ShipDef.VictoryTurretTwo = Foundation.ShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile, "SubMenu": SubMenu, "SubSubMenu": SubSubMenu })
Foundation.ShipDef.VictoryTurretTwo.dTechs = {
...
#if menuGroup:           Foundation.ShipDef.VictoryTurretTwo.RegisterQBShipMenu(menuGroup)
#if playerMenuGroup:     Foundation.ShipDef.VictoryTurretTwo.RegisterQBPlayerShipMenu(playerMenuGroup)
