...
abbrev = 'EnterpriseJUniverse'				# Short name, no spaces, used as a preface for descriptions
iconName = 'EnterpriseJUniverse'					# Name of icon .tga file
longName = 'U.S.S. Enterprise J (Gravitic Lance)'					# Long name with spaces
shipFile = 'EnterpriseJUniverse'				# Name of the file in Scripts\Ships\ to use.
...
credits = {
	'modName': 'EnterpriseJUniverse',			# The full name of your mod if applicable
...
Foundation.ShipDef.EnterpriseJUniverse = Foundation.FedShipDef(abbrev, species, { 'name': longName, 'iconName': iconName, 'shipFile': shipFile })
Foundation.ShipDef.EnterpriseJUniverse.dTechs = {
...
Foundation.ShipDef.EnterpriseJUniverse.sBridge = 'defiantbridge'
Foundation.ShipDef.EnterpriseJUniverse.fMaxWarp = 9.995
Foundation.ShipDef.EnterpriseJUniverse.fWarpEntryDelayTime = 3.5
Foundation.ShipDef.EnterpriseJUniverse.SubMenu = SubMenu

Foundation.ShipDef.EnterpriseJUniverse.desc = 'The USS Enterprise NCC-1701-J was a 26th century Federation Universe-class starship operated by Starfleet in a possible future.\n\nThe Enterprise-J participated in the historic Battle of Procyon V, wherein the forces of the Federation successfully drove the Sphere-Builders back into their trans-dimensional realm.'

if menuGroup:           Foundation.ShipDef.EnterpriseJUniverse.RegisterQBShipMenu(menuGroup)
if playerMenuGroup:     Foundation.ShipDef.EnterpriseJUniverse.RegisterQBPlayerShipMenu(playerMenuGroup)
