...
# CustomTechsPhasicmatter ArmorExtras.py
...
extraVariables = {
	"g_kSubsystemFillColor" : {"kEmptyColor": ["Custom.Techs.Phasicmatter Armor"]},
	"CustomTechsPhasicmatterArmorFill" : {"kFillColor": ["Custom.Techs.Phasicmatter Armor"]},
}
...
AblativeArmour = None
try:
	AblativeArmour = __import__("Custom.Techs.Phasicmatter Armor")
except:
	AblativeArmour = None

if AblativeArmour != None:
	if hasattr(AblativeArmour, "kFillColor"):
		App.CustomTechsPhasicmatterArmorFill = AblativeArmour.kFillColor
...
sDefaultColors = { # Colors from App.py
	...
	"Foundation Technologies' colors" : {
		"CustomTechsPhasicmatterArmorFill": [None, []],
	},
}
