...
extraVariables = {
	"g_kSubsystemFillColor" : {"kHullFillColor" : ["FoundationTech"]}, # Variable which is also defined somewhere - attribute name - path to that file. Multiple paths can exist, then you make it as a list ["path1", "path2"]
