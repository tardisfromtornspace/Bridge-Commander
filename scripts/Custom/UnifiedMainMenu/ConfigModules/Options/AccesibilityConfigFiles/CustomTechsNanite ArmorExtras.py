...
# CustomTechsNanite ArmorExtras.py
...
extraVariables = {
	"g_kSubsystemFillColor" : {"kEmptyColor": ["Custom.Techs.Nanite Armor"]},
	"CustomTechsNaniteArmorFill" : {"kFillColor": ["Custom.Techs.Nanite Armor"]},
}
...
AblativeArmour = None
try:
	AblativeArmour = __import__("Custom.Techs.Nanite Armor")
except:
	AblativeArmour = None

if AblativeArmour != None:
	App.CustomTechsNaniteArmorFill = AblativeArmour.kFillColor
...
sDefaultColors = { # Colors from App.py
	...
	"Foundation Technologies' colors" : {
		"CustomTechsNaniteArmorFill": [None, []],
	},
}
