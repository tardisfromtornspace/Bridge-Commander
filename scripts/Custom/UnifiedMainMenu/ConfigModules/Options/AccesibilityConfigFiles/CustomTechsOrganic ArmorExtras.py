...
# CustomTechsOrganic ArmorExtras.py
...
extraVariables = {
	"g_kSubsystemFillColor" : {"kEmptyColor": ["Custom.Techs.Organic Armor"]},
	"CustomTechsOrganicArmorFill" : {"kFillColor": ["Custom.Techs.Organic Armor"]},
}
...
AblativeArmour = None
try:
	AblativeArmour = __import__("Custom.Techs.Organic Armor")
except:
	AblativeArmour = None

if AblativeArmour != None:
	App.CustomTechsOrganicArmorFill = AblativeArmour.kFillColor
...
sDefaultColors = { # Colors from App.py
	...
	"Foundation Technologies' colors" : {
		"CustomTechsOrganicArmorFill": [None, []],
	},
}
