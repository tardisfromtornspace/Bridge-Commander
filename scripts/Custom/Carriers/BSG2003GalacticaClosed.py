...
class BSG2003GalacticaClosed( Carrier.Carrier):
...
# "BSG2003GalacticaClosed" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "BSG2003GalacticaClosed", BSG2003GalacticaClosed)
