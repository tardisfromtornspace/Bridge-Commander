...
class DiamondsAMVoyager( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher = LauncherManager.GetLauncher( "Shuttle Bay", pShip)
        group.AddLauncher( "DiamondsSC4", launcher)
        launcher.AddLaunchable( "DiamondsSC4", "QuickBattle.QuickBattleFriendlyAI", 1)
...
ShipManager.RegisterShipClass( "DiamondsAMVoyager", DiamondsAMVoyager)
