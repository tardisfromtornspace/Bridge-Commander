...
class WZOblit( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "WZAggravS", "QuickBattle.ZZAndromedanAttackFriendlyAI", 1)
...
# "WZVindi" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "WZOblit", WZOblit)
