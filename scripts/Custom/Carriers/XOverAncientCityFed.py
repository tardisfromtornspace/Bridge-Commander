...
class XOverAncientCityFed( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "PuddleJumper", "ftb.friendlyAI", 24)

        LauncherManager = __import__( "ftb.LauncherManager")
        launcher = LauncherManager.GetLauncher( "Shuttle Bay 1", pShip)
        group.AddLauncher( "Shuttle Bay 1", launcher)
        launcher.AddLaunchable( "XOverAlteranWarship", "ftb.friendlyAI", 3)
...
ShipManager.RegisterShipClass( "XOverAncientCityFed", XOverAncientCityFed)
