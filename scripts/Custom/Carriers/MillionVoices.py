...
class MillionVoices( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "AndSlipFighter", "QuickBattle.QuickBattleFriendlyAI", 10)

        launcher = LauncherManager.GetLauncher( "Bay 2", pShip)
        group.AddLauncher( "Bay 2", launcher)
        launcher.AddLaunchable( "AndSlipFighterMK1", "QuickBattle.QuickBattleFriendlyAI",10)
 
        launcher = LauncherManager.GetLauncher( "Bay 3", pShip)
        group.AddLauncher( "Bay 3", launcher)
        launcher.AddLaunchable( "AndSlipFighterMK2", "QuickBattle.QuickBattleFriendlyAI", 10)

 	launcher = LauncherManager.GetLauncher( "Bay 4", pShip)
        group.AddLauncher( "Bay 4", launcher)
        launcher.AddLaunchable( "AndSlipFighterMK3", "QuickBattle.QuickBattleFriendlyAI", 10)
...
ShipManager.RegisterShipClass( "MillionVoices", MillionVoices)
