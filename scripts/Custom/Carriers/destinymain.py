...
class DestinyMain( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "ancientshuttle", "ftb.friendlyAI", 1)
...
# "DestinyMain" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "DestinyMain", DestinyMain)
