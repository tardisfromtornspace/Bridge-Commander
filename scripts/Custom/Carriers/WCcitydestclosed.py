...
class WCcitydestclosed( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "WCID4alienattacker", "ftb.friendlyAI", 15)
...
# "WCcitydestclosed" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "WCcitydestclosed", WCcitydestclosed)
