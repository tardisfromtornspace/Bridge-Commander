...
class BSG2003Pegasus( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "BSG2003Raptor", "ftb.friendlyAI", 4)
        launcher.AddLaunchable( "BSG2003Raptor2", "ftb.friendlyAI", 2)
        launcher.AddLaunchable( "BSG2003Raptor3", "ftb.friendlyAI", 2)
