...
class BSG2003Galactica( Carrier.Carrier):
...
# "BSG2003Galactica" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "BSG2003Galactica", BSG2003Galactica)
