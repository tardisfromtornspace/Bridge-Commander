...
class ZZQuD( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "ZZKomoFighter", "QuickBattle.ZZAndromedanAttackFriendlyAI", 2)
...
# "ZZKomoVal" is the "ShipProperty" name of the ship to be registered as
# defined in the Hardpoints PY file for your ship
ShipManager = __import__( "ftb.ShipManager")
ShipManager.RegisterShipClass( "ZZQuD", ZZQuD)
