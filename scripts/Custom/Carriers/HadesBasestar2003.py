# HadesBasestar2003.py    a Carrier File by MadJohn
#
# Based off.
# Dauntless.py
# April 11, 2002
...
class HadesBasestar2003( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "MkXRaider", "ftb.friendlyAI", 2)
...
ShipManager.RegisterShipClass( "HadesBasestar2003", HadesBasestar2003)
