...
class AncientCity( Carrier.Carrier):
    def __init__( self, pShip):
        ...
        launcher.AddLaunchable( "PuddleJumper", "ftb.friendlyAI", 25)

        LauncherManager = __import__( "ftb.LauncherManager")
        launcher = LauncherManager.GetLauncher( "Shuttle Bay 1", pShip)
        group.AddLauncher( "Shuttle Bay 1", launcher)
        launcher.AddLaunchable( "AncientWarship", "ftb.friendlyAI", 2)
...
ShipManager.RegisterShipClass( "AncientCity", AncientCity)
