...
kFillColor.SetRGBA(80.0/255.0, 85.0/255.0, 205.0/255.0, App.g_kSubsystemFillColor.a)
...
if AblativeArmour != None:
	class NeutroniumArmorDef(AblativeArmour.AblativeDef):
	...
	oNeutronium = NeutroniumArmorDef('Neutronium Armor')