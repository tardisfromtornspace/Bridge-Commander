...
kFillColor.SetRGBA(170.0/255.0, 255.0/255.0, 150.0/255.0, App.g_kSubsystemFillColor.a)
...
if AblativeArmour != None:
	class OrganicArmorDef(AblativeArmour.AblativeDef):
	...
	oOrganic = OrganicArmorDef('Organic Armor')