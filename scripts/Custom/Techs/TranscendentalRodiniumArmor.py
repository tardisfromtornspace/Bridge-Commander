...
# TranscendentalRodiniumArmor.py
...
kFillColor.SetRGBA(255.0/255.0, 150.0/255.0, 255.0/255.0, App.g_kSubsystemFillColor.a)

AblativeArmour = None
oTranscendentalRodinium = None
...
if AblativeArmour != None:
	class TranscendentalRodiniumArmorDef(AblativeArmour.AblativeDef):
	...
	oTranscendentalRodinium = TranscendentalRodiniumArmorDef('Transcendental Rodinium Armor')