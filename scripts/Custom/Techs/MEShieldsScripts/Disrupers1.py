...
# This file adds "Disrupers" to the list of guaranteed bleedthrough to ME Shields (according to the info about particle beam weapons from collectors "Being a particle beam weapon, it ignores kinetic barriers,"), according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script.
...
ProjectileName = "disruper"
ProjectileGuaranteedBleedthrough = 0.1
ProjectileWhitelistFilename = ["PhasedDisruper"]  # Case-sensitive
ProjectileBlacklistName = ["not a disruper", "not disruper", "no disruper", "not a phased disruper", "not phased disruper", "no phased disruper", "not a phase disruper", "not phase disruper", "no phase disruper",]  # Case-insensitive
...
BeamName = "disruper"
BeamGuaranteedBleedthrough = 0.1
BeamWhitelistHardname = ["Phased Disruper 1", "Phased Disruper 2", "Phased Disruper", "Lance phased Disruper"]
BeamBlacklistName = ["not a disruper", "not disruper", "no disruper", "not a phased disruper", "not a phased disruper", "no phased disruper", "not a phase disruper", "not phase disruper", "no phase disruper",]
