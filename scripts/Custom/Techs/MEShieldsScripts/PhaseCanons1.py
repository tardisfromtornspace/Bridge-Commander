...
ProjectileName = "phase canon"
ProjectileGuaranteedBleedthrough = 0.8
ProjectileWhitelistFilename = ["PhaseCanon"]  # Case-sensitive
ProjectileBlacklistName = ["not a phase canon", "not phase canon", "no phase canon", ]  # Case-insensitive
...
BeamName = "phase canon"
BeamGuaranteedBleedthrough = 0.8
BeamWhitelistHardname = ["Phase Canon 1", "Phase Canon 2", "Phase Canon", "Lance Phase canon"]
BeamBlacklistName = ["not a phase canon", "not phase canon", "no phase canon",]
