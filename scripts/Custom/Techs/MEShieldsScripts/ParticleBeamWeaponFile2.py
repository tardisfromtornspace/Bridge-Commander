...
# This file adds Particle (beam) Weapons to the list of guaranteed bleedthrough to ME Shields (according to the info aout particle beam weapons from collectors "Being a particle beam weapon, it ignores kinetic barriers,"), according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script.
...
BeamWhitelistHardname = ["Particle D1", "particle D2", "Death Ray"]
BeamBlacklistName = ["particle mass acceler", "mass particle", "neutron particle", "proton particle", "mass effect particle", "particle beam", " not a particle", " no particle",]
