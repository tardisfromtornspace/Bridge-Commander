...
# This file adds x-rays (a type of invisible laser, which ME barriers excluding reapers cannot even block partially) to the list of guaranteed bleedthrough to ME Shields, according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script
...
ProjectileName = "x-ray"
ProjectileGuaranteedBleedthrough = 1.0
ProjectileWhitelistFilename = ["x-ray", "xRay"]  # Case-sensitive
ProjectileBlacklistName = ["not an x-ray", " not x-ray", " no x-ray", " anti-x-ray", "antix-ray"]  # Case-insensitive
ProjectileBlacklistFilename = ["Antix-ray", "Notanx-ray", "Turbox-ray", "Turbox-Ray"]  # Case-sensitive
...
BeamWhitelistHardname = ["XRay 1", "XRay 2", "XRay 3", "XRay 4", "XRay 5", "XRay 6", "XRay 7", "XRay 8", "XRay 9", "XRay 10", "XRay 11", "XRay 12", "XRay 13", "XRay 14", "XRay 15", "XRay 16", "XRay 17", "XRay 18", "XRay 19", "XRay 20"]
BeamBlacklistName = ["not an x-ray", "notx-ray", "antix-ray", "nox-ray", "turbox-ray", "turbo-x-ray"]
