...
# This file adds Beams to the list of guaranteed bleedthrough to ME Shields (according to the info about particle beam weapons from collectors "Being a particle beam weapon, it ignores kinetic barriers,"), according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script.
...
BeamName = "beam"
BeamGuaranteedBleedthrough = 0.6
BeamWhitelistHardname = ["Particle Bank Beam 1", "beam 2", ]
BeamBlacklistName = ["particle beam", " not a beam", " not beam", " no beam", "gravity", "graviton"]
