...
# This file adds Phased Cannons to the list of guaranteed bleedthrough to ME Shields (according to the info about particle beam weapons from collectors "Being a particle beam weapon, it ignores kinetic barriers,"), according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script.
...
ProjectileName = "phased cannon"
ProjectileGuaranteedBleedthrough = 0.8
ProjectileWhitelistFilename = ["PhasedCannon"]  # Case-sensitive
ProjectileBlacklistName = ["not a phased cannon", "not phased cannon", "no phased cannon", ]  # Case-insensitive
...
BeamName = "phased cannon"
BeamGuaranteedBleedthrough = 0.8
BeamWhitelistHardname = ["Phased Cannon 1", "Phased Cannon 2", "Phased Cannon", "Lance phased cannon"]
BeamBlacklistName = ["not a phased cannon", "not phased cannon", "no phased cannon",]
