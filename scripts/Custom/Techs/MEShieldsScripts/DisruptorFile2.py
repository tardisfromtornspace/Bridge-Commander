...
BeamName = "disruptor array"
BeamGuaranteedBleedthrough = 0.75
BeamWhitelistHardname = ["Klingon Disruptor", "Romulan Disruptor"]
BeamBlacklistName = ["javelin disruptor", "me disruptor", "mass effect javelin", "mass effect", "antidisruptor", " no disruptor", "brain disruptor", "emp disruptor", "electric disruptor", "not a disruptor",]
