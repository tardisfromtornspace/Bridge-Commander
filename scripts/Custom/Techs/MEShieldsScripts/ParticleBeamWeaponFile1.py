...
BeamName = "particle beam"
BeamGuaranteedBleedthrough = 0.8
BeamWhitelistHardname = ["Particle Beam 1", "particle beam 2", ]
BeamBlacklistName = ["not a particle beam", " not particle beam", " no particle beam weapon",]
