...
# This file adds "QGD" ("Quantom Gravimetric Drive") to the list of guaranteed bleedthrough to ME Shields (according to the info about particle beam weapons from collectors "Being a particle beam weapon, it ignores kinetic barriers,"), according to MEShields in-script documentation. Due to the parent script implementation, we could add multiple files that add elements, and repeated elements on the lists will not be repeatedly included on the parent script.
...
#ProjectileWhitelistFilename = ["PhasedQGD"]  # Case-sensitive
#ProjectileBlacklistName = ["not a qgd", "not qgd", "no qgd", "not a phased qgd", "not phased qgd", "no phased qgd", "not a phase qgd", "not phase qgd", "no phase qgd",]  # Case-insensitive
...
BeamWhitelistHardname = ["QGD Cannon"]
BeamBlacklistName = ["not a qgd", "not qgd", "no qgd", "not a phased qgd", "not a phased qgd", "no phased qgd", "not a phase qgd", "not phase qgd", "no phase qgd",]
