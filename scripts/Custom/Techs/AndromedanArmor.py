...
# Andromedan.py
# 15th January 2026, by Alex SL Gato, based on a Cristalline armour adjusted for colors, fixed by Alex SL Gato (CharaToLoki), modified from Greystar's (which was likely an ftb AblativeArmour script copy)
...
Foundation.ShipDef.saturn.dTechs = {
	'Andromedan-type Armor': [485000, {"Beams": ["One phaser hardpoint name", "another laser hardpoint name"], "Pulses": ["One pulse hardpoint name", "Another disruptor hardpoint name"], "GlobalFactor": 1.0, "HealDepletes": 0}]
}

# If you want to do everything at once, do this:
Foundation.ShipDef.saturn.dTechs = {
	'Andromedan-type Armor': [485000, "Potato tasty chip", {"Beams": ["One phaser hardpoint name", "another laser hardpoint name"], "Pulses": ["One pulse hardpoint name", "Another disruptor hardpoint name"], "GlobalFactor": 1.0, "HealDepletes": 0}]
}
"""
