...
# This file takes care of how SW shielding is affected by SG Ori Beam Weapons.
# On this case, this one was left for future expansions and to clarify SW shields are not ST or SG ones.
