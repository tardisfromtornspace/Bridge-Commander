...
kFillColor.SetRGBA(150.0/255.0, 150.0/255.0, 150.0/255.0, App.g_kSubsystemFillColor.a)
...
if AblativeArmour != None:
	class NaniteArmorDef(AblativeArmour.AblativeDef):
	...
	oNanite = NaniteArmorDef('Nanite Armor')