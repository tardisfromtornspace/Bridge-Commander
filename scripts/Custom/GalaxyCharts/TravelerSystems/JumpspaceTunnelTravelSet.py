...
# JumpspaceTunnelTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "JumpspaceTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.JumpspaceTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.JumpspaceTunnelTravelSet", None, None)
