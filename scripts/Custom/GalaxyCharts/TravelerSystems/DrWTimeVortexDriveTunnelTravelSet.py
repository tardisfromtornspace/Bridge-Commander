...
# DrWTimeVortexDriveTunnelTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "DrWTimeVortexDriveTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.DrWTimeVortexDriveTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.DrWTimeVortexDriveTunnelTravelSet", None, None)

	# Create static objects for this set:
	# If you want to create static objects for this region, make a
	# "DrWTimeVortexDriveTunnelTravelSet_S.py" file with an Initialize function that creates them.
	try:
		import DrWTimeVortexDriveTunnelTravelSet_S
		DrWTimeVortexDriveTunnelTravelSet_S.Initialize(pSet)
	except ImportError:
...
def LoadPlacements(sSetName):
	...
	vLight = (0.0, 3000.0, 0.0)
	vLight2 = (0.0, -3000.0, 0.0)
	...
	kThis.ConfigAmbientLight(0.8, 0.8, 0.9, 0.4)
	kThis.Update(0)
	kThis = None
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.4, 0.6, 1.0, 0.80)
	kThis.Update(0)
	kThis = None
	...
	kUp.SetXYZ(0.0, 1.0, 0.0)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(1.0, 0.4, 0.4, 0.80)
	kThis.Update(0)
	kThis = None
	# End position "Sun Light"
