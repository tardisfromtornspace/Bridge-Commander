...
SET_NAME = "AIQuantumspaceTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.AIQuantumspaceTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.AIQuantumspaceTunnelTravelSet", None, None)
