...
# AIMycelialNetworkTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "AIMycelialNetworkTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.AIMycelialNetworkTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.AIMycelialNetworkTravelSet", None, None)

	# Create static objects for this set:
	# If you want to create static objects for this region, make a
	# "MycelialNetworkTravelSet_S.py" file with an Initialize function that creates them.
	try:
		import MycelialNetworkTravelSet_S
		MycelialNetworkTravelSet_S.Initialize(pSet)
	except ImportError:
...
def LoadPlacements(sSetName):
	...
	kThis.ConfigAmbientLight(0.8, 0.8, 1.0, 0.4)
	kThis.Update(0)
	kThis = None
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.8, 0.8, 1.0, 0.80)
	kThis.Update(0)
	kThis = None
	...
	kUp.SetXYZ(0.0, 1.0, 0.0)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.8, 0.4, 1.0, 0.80)
	kThis.Update(0)
	kThis = None
	# End position "Sun Light"
...
def LoadBackdrops(pSet):
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetTextureFileName("data/jahSeppback.tga")
	kThis.SetTargetPolyCount(256)
	kThis.SetHorizontalSpan(1.000000)
	kThis.SetVerticalSpan(1.000000)
	kThis.SetSphereRadius(35000.000000)
	kThis.SetTextureHTile(22.000000)
	kThis.SetTextureVTile(22.000000)
	kThis.Rebuild()
