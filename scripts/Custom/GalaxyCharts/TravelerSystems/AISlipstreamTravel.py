...
# Based on SlipstreamTravel TravelerSystem by BCXtreme (https://www.gamefront.com/games/bridge-commander/file/slipstream-for-galaxy-charts), to provide an AI-only alternative to regular SlipstreamTravel, by Alex SL Gato.
...
# Slipstream Module, which this system relies on, remains ALL RIGHTS RESERVED, by USS Sovereign.
...
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.AISlipstreamTravel")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.AISlipstreamTravel", None, None)
