...
def Initialize(pSet):
	...
	pNebula = App.MetaNebula_Create(255.0 / 255.0, 255.0 / 255.0, 255.0 / 255.0, 145.0, 1.5, "data/Backgrounds/nebulaoverlay.tga", "data/Backgrounds/nebulaexternal.tga")

	# Set nebula damage/sec to Hull/Shields.
	pNebula.SetupDamage(0.0, 0.001)
