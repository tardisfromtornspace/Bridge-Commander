...
# B5TransDimensionalDriveTunnelTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "B5TransDimensionalDriveTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.B5TransDimensionalDriveTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.B5TransDimensionalDriveTunnelTravelSet", None, None)
