...
# QuantumspaceTunnelTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "QuantumspaceTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.QuantumspaceTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.QuantumspaceTunnelTravelSet", None, None)

	# Create static objects for this set:
	# If you want to create static objects for this region, make a
	# "QuantumspaceTunnelTravelSet_S.py" file with an Initialize function that creates them.
	try:
		import QuantumspaceTunnelTravelSet_S
		QuantumspaceTunnelTravelSet_S.Initialize(pSet)
	except ImportError:
...
def LoadPlacements(sSetName):
	...
	kThis.ConfigAmbientLight(0.4, 0.0, 1.0, 0.4)
	kThis.Update(0)
	kThis = None
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.5, 0.5, 1.0, 0.80)
	kThis.Update(0)
	kThis = None
	...
	kUp.SetXYZ(0.0, 1.0, 0.0)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.1, 0.1, 0.4, 0.80)
	kThis.Update(0)
	kThis = None
	# End position "Sun Light"
