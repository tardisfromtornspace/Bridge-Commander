...
# AIJumpspaceTunnelTravelSet.py, file made by Alex SL Gato
...
SET_NAME = "AIJumpspaceTunnelTravelSet"
def Initialize():
	...
	pSet.SetRegionModule("Custom.GalaxyCharts.TravelerSystems.AIJumpspaceTunnelTravelSet")
	...
	Custom.GalaxyCharts.Cartographer.RegionManager.AddRegion(SET_NAME, "Custom.GalaxyCharts.TravelerSystems.AIJumpspaceTunnelTravelSet", None, None)

	# Create static objects for this set:
	# If you want to create static objects for this region, make a
	# "JumpspaceTunnelTravelSet_S.py" file with an Initialize function that creates them.
	try:
		import JumpspaceTunnelTravelSet_S
		JumpspaceTunnelTravelSet_S.Initialize(pSet)
	except ImportError:
...
def LoadPlacements(sSetName):
	...
	kThis.ConfigAmbientLight(1.0, 0.0, 0.4, 0.4)
	kThis.Update(0)
	kThis = None
	...
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(1.0, 0.5, 0.5, 0.80)
	kThis.Update(0)
	kThis = None
	...
	kUp.SetXYZ(0.0, 1.0, 0.0)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(0.4, 0.1, 0.1, 0.80)
	kThis.Update(0)
	kThis = None
	# End position "Sun Light"
