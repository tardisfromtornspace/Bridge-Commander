...
lShipsPDWhiteList = ["AdOberth", "Aegean", "Aegian", "AlphaWing", "Ambassador", "Ambassadortp", "AMVoyager", "AncientCity", "AncientSatellite", "Andromeda", "ArmoredVoyager", "Atlantis", "B5Station", "Battlecrab", "Battlestar", "CA8472", "C2Valdore", "C2excelsiorII", "CardHybrid", "CN_FedStarbase", "CylonBasestar", "DanielJackson", "DCMPDefiant", "Defiant", "DeltaWing", "DJEnterpriseG", "DJEnterpriseGDrive", "DJEnterpriseGSaucer", "DJEnterpriseGThunderbird", "ds9", "DyExcalibur", "EAOmega", "EAStarfury", "EchoWing", "Enterprise", "EnterpriseF", "EnterpriseJ", "Excalibur Transwarp", "Excalibur Uprated", "Excalibur", "ExcelsiorP81", "exeter", "Eximius", "Firebird", "FTBNeghvar", "Galactica", "Galaxy", "GalaxySaucer", "GalaxyStardrive", "GalaxyX", "Galor", "GQuan", "HadesBasestar", "HadesBasestar2003", "HalcyonPromise", "Hutet", "JediStarfighter", "Keldon", "KlingonImperialStarbase", "KTinga", "Kvort", "LCIntrepid", "LC_Excalibur", "LC_Excaliburtp", "LCIntrepid_warp", "LCRaptor", "lintsktinga", "MillionVoices", "MPneghvar", "MvamPrometheus", "MvamPrometheusDorsal", "MvamPrometheusSaucer", "MvamPrometheusVentral", "MvamVoyager", "MvamVoyagerSep", "NebulaX", "norway", "Nova", "novaII", "PaxMagellanic", "Pegasus", "PlanetExpress", "Praetor", "PsExcelsiorRefitTNG1", "pulsemine", "RomulanOutpost", "SonaB", "Steamrunner", "Tardis", "Tholian", "Thunderbolt", "TOSColDefender", "TWSB5StationUpgrade", "USSOrville", "ValdoreG", "VasKholhr", "Victory", "VOR_Cruiser", "VulcanXRT55D", "Warbird", "Vorcha", "Warlock", "WCneghvar", "WCNemEntEnoyacht", "WCSonaBattleship", "XOversMinbariAshenShuumtian", "XOverAncientCityFed", "XOverAncientSatelliteFed", "Sovereign", "Nebula", "Phoenix", "USSLennox"]
