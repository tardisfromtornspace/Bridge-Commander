...
def SetupSequenceISI(pShip=None):
	...
	#pStretchAction = App.TGScriptAction_Create(__name__, "setTheStretchyState", pShipID, App.WarpEngineSubsystem.WES_WARP_INITIATED)
	...
	## THIS WAS AN EXTRA ADDED TO RESTORE WARP STRETCHINESS
	#pStretchEAction = App.TGScriptAction_Create(__name__, "setTheStretchyState", pShipID, App.WarpEngineSubsystem.WES_DEWARP_INITIATED)
