...
Foundation.MusicDef.default.dMain = {
		...
		'sfx/Music/AAAA- Firefly Main Title.mp3': 	'AAAA- Firefly Main Title',
		'sfx/Music/ZZZZ -andromeda aud.mp3': 	'ZZZZ -andromeda aud',
		'sfx/Music/AAEO-Babylon 5 - Season 1 End Titles': 	'AAEO-Babylon 5 - Season 1 End Titles',
		'sfx/Music/AAGH-Babylon 5 - Season 5 Main Titles (Instrumental)': 	'AAGH-Babylon 5 - Season 5 Main Titles (Instrumental)',
		'sfx/Music/Doctor Who Theme [Album Version]': 	'Doctor Who Theme [Album Version]',
		'sfx/Music/Star_Trek_TNG_Theme.mp3': 	'Star_Trek_TNG_Theme',
		'sfx/Music/ZBAA-Doctor Who Theme [1985].mp3': 	'ZBAA-Doctor Who Theme [1985]',
		'sfx/Music/ZZZM-YANA (Excerpt).mp3': 	'ZZZM-YANA (Excerpt)',
		'sfx/Music/AAFJ-Babylon 5 - Season 3 Main Titles (Instrumental).mp3': 	'AAFJ-Babylon 5 - Season 3 Main Titles (Instrumental)',
		'sfx/Music/Star_Trek_TNG_Theme_-_Boston_Pops_Orchestra.mp3': 	'Star_Trek_TNG_Theme_-_Boston_Pops_Orchestra',
		'sfx/Music/AAHB-Futurama intro.mp3': 	'AAHB-Futurama intro',
		'sfx/Music/AAHC-Galactica 1978': 	'AAHC-Galactica 1978',
		'sfx/Music/AAIW-Kara Remembers': 	'AAIW-Kara Remembers',
}

Foundation.MusicDef.default.dStates = {
	'Combat Confident': ( 'Confident-11a', 'AAIW-Kara Remembers', 'AAHC-Galactica 1978', 'Confident-11b', 'Confident-11c', 'Confident-11d', 'Confident-11e', 'Confident-11f', 'Confident-11g', 'AAAA- Firefly Main Title', 'AAGH-Babylon 5 - Season 5 Main Titles (Instrumental)', 'ZZZZ -andromeda aud', 'AAHB-Futurama intro' ),
	'Combat Neutral': ( 'Neutral-10i', 'AAIW-Kara Remembers', 'Neutral-10b', 'Neutral-10c', 'Neutral-10d', 'Neutral-10e', 'Neutral-10f', 'Neutral-10g', 'Neutral-10h', 'Neutral-10a', 'ZZZM-YANA (Excerpt)', 'Doctor Who Theme [Album Version]', 'AAHC-Galactica 1978', 'Star_Trek_TNG_Theme_-_Boston_Pops_Orchestra' ),
	'Combat Panic': ( 'Panic-9a', 'Panic-9b', 'Panic-9c', 'Panic-9d', 'Panic-9e', 'Panic-9f', 'Panic-9g', 'AAIW-Kara Remembers', 'AAFJ-Babylon 5 - Season 3 Main Titles (Instrumental)' ),
}
