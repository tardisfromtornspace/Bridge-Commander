...
MvamShips = ["jclass", "jclasstug", "jclasspod"]
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "jclasstug")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "jclasstug")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "jclasspod")
