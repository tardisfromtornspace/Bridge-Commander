...
MvamShips = ["MvamFusionCube", "CubeA", "CubeB", "CubeC", "CubeD", "CubeE", "CubeF", "CubeG", "CubeH"]
...
IconNames = ["Seperate CubeA", "Seperate CubeB", "Seperate CubeC", "Seperate CubeD", "Seperate CubeE", "Seperate CubeF", "Seperate CubeG", "Seperate CubeH", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(-4.530166, -4.948499, 4.506173)
MvamDistances[1].SetXYZ(5.042616, -4.529312, 4.933591)
MvamDistances[2].SetXYZ(5.156435, -4.137786, -4.533401)
MvamDistances[3].SetXYZ(-4.239033, -4.546962, -4.40376)
MvamDistances[4].SetXYZ(-4.646575, 5.192169, 5.425391)
MvamDistances[5].SetXYZ(5.117606, 4.520686, 4.731453)
MvamDistances[6].SetXYZ(4.590323, 4.345572, -4.439018)
MvamDistances[7].SetXYZ(-4.324315, 4.485721, -4.225318)
...
MvamDirections[0].SetXYZ(0.0, -2.0, -0.40)
MvamDirections[1].SetXYZ(0.0, -4.0, 1.65)
MvamDirections[2].SetXYZ(0.0, -2.0, -0.40)
MvamDirections[3].SetXYZ(0.0, -4.0, 1.65)
MvamDirections[4].SetXYZ(0.0, 4.0, -1.0)
MvamDirections[5].SetXYZ(0.0, 2.0, 0.50)
MvamDirections[6].SetXYZ(0.0, 4.0, -1.0)
MvamDirections[7].SetXYZ(0.0, 2.0, 0.50)
...
MvamSpeeds = [3.9, 5.9, 4.9, 1.9, 2.9, 3.9, 3.9, 4.9]
...
MvamReinDistances[0].SetXYZ(0.0, -3.0, -1.70)
MvamReinDistances[1].SetXYZ(0.0, -3.0, 0.77)
MvamReinDistances[2].SetXYZ(0.0, -3.34, 0.77)
MvamReinDistances[3].SetXYZ(0.0, -3.34, 0.77)
MvamReinDistances[4].SetXYZ(0.0, 2.0, 1.10)
MvamReinDistances[5].SetXYZ(0.0, 2.0, -1.50)
MvamReinDistances[6].SetXYZ(0.0, 2.0, -0.50)
MvamReinDistances[7].SetXYZ(0.0, 2.0, -0.50)
...
MvamReinDirections[0].SetXYZ(1.0, 2.0, -0.10)
MvamReinDirections[1].SetXYZ(1.9, 2.0, -0.20)
MvamReinDirections[2].SetXYZ(1.9, 2.0, -0.30)
MvamReinDirections[3].SetXYZ(1.9, 2.0, -0.40)
MvamReinDirections[4].SetXYZ(1.9, 2.0, -0.50)
MvamReinDirections[5].SetXYZ(1.9, 2.0, -0.60)
MvamReinDirections[6].SetXYZ(1.9, 2.0, -0.70)
MvamReinDirections[7].SetXYZ(1.9, 2.0, -0.80)
...
MvamReinSpeeds = [0.5, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05]
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeA")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeB")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeC")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeD")


	pObject.CallNextHandler(pEvent)

###TO CHANGE: dont forget to change this name too.
def CubeE(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeE")


	pObject.CallNextHandler(pEvent)
###TO CHANGE: dont forget to change this name too.
def CubeF(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeF")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeG")


	pObject.CallNextHandler(pEvent)

###To CHANGE: dont forget to change this name too.
def CubeH(p0bject, pEvent):

  
      # get the player   
      pGame = App.Game_GetCurrentGame()
      pPlayer = pGame.GetPlayer()
      snkMvamModule = _import_ (_name)
      # check if its our full ship
      if (pPlayer.GetScript() == "ships." + snkMvamModule.ReturnMvamShips()[0]):
            import Custom.Sneaker.Mvam.Seperation

      
###To CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvanGalaxySaucer")
            Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "CubeH")


      p0bject.CallNextHandler(pEvent)
...
def CheckSeperate (pShip):
	#this means if the ship's hull is at or below 90%, we seperate
	if (pShip.GetHull().GetConditionPercentage() <= 0.80):
		return 1
	else:
		return 0
