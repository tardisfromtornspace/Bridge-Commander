...
MvamShips = ["HestiaClass", "HestiaSaucer", "HestiaDorsal", "HestiaVentral"]
...
MvamDistances[0].SetXYZ(0.0, 1.45, 0.14)
MvamDistances[1].SetXYZ(0.0, -0.705, 0.08)
MvamDistances[2].SetXYZ(0.0, -0.41, -0.18)
...
MvamReinDistances[0].SetXYZ(0.0, -3.62, 0.6226)
MvamReinDistances[1].SetXYZ(0.0, -5.51, -1.15)
MvamReinDistances[2].SetXYZ(0.0, -4.75, -2.77)
...
def HestiaSaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HestiaSaucer")
...
def HestiaDorsal(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HestiaDorsal")
...
###TO CHANGE: dont forget to change this name too.
def HestiaVentral(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HestiaVentral")
