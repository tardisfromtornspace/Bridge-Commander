...
MvamShips = ["SOTICosmosasto", "SOTICosmosastoUp"]
...
IconNames = ["Vertical Mode", "Horizontal Mode$Rein"]
...
def SOTICosmosastoUp(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "SOTICosmosastoUp")
