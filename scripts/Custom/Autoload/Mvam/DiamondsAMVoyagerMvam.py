...
MvamShips = ["DiamondsAMVoyager", "DiamondsArmoredVoyager"]
...
def DiamondsArmoredVoyager(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "ArmoredVoyager")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "DiamondsArmoredVoyager")
