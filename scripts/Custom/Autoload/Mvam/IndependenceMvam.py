...
MvamShips = ["Independence", "IndependenceNoYacht", "IndependenceYacht"]
...
IconNames = ["Launch Yacht", "Fly Yacht", "Reintegrate$Rein"]
...
def IndependenceNoYacht(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "IndependenceNoYacht")
...
def IndependenceYacht(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "IndependenceYacht")
