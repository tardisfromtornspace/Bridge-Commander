...
MvamShips = ["ArsenalIntegrated", "ArsenalSeperated", "Gladiator"]
...
IconNames = ["Launch Gladiator", "Board Gladiator", "Dock Gladiator$Rein"]
...
MvamDistances[1].SetXYZ(0.0, 3.5, 0.0)
...
MvamDirections[1].SetXYZ(0.0, 1.0, -1.0)
...
MvamReinDistances[0].SetXYZ(0.0, -2.4868316651, 0.0)
MvamReinDistances[1].SetXYZ(0.0, 1.52, -1.5)
#MvamReinDistances[1].SetXYZ(0.0, 1.7582702637, -1.758850097)
...
MvamReinDirections[1].SetXYZ(0.0, 1.0, 1.0)
...
def ArsenalSeperated(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "ArsenalSeperated")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "ArsenalSeperated")
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "Gladiator")
...
#	print 'PRE'
#	print 'Gladiator'
#	pShip1 = App.ShipClass_GetObject (pSet, "Gladiator")
#	print 'X=', pShip1.GetWorldLocation().GetX(), 'Y=', pShip1.GetWorldLocation().GetY(), 'Z=', pShip1.GetWorldLocation().GetZ()
#	print 'Arsenal'
#	pShip1 = App.ShipClass_GetObject (pSet, "Player")
#	print 'X=', pShip1.GetWorldLocation().GetX(), 'Y=', pShip1.GetWorldLocation().GetY(), 'Z=', pShip1.GetWorldLocation().GetZ()
