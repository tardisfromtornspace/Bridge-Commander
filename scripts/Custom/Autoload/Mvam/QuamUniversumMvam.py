...
MvamShips = ["QuamUniversum", "QuamUniversumSaucer", "QuamUniversumSecondary"]
...
IconNames = ["Seperate - Saucer", "Seperate - Secondary", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(0.0, 6.0, 0.505)
MvamDistances[1].SetXYZ(0.0, -3.05, 0.0)
...
MvamDirections[0].SetXYZ(0.0, 1.0, 0.35)
...
MvamReinDistances[0].SetXYZ(0.0, 6.0, 2.75)
MvamReinDistances[1].SetXYZ(0.0, -3.05, 0.0)
...
MvamReinDirections[0].SetXYZ(0.0, 1.0, -0.35)
...
SoundName = "QuamUniversumSeparate"
...
BridgeSoundName = "27thCBridgeSplit"
...
def QuamUniversumSaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "QuamUniversumSaucer")
...
def QuamUniversumSecondary(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "QuamUniversumSecondary")
