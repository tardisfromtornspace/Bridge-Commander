...
MvamShips = ["Barrier", "BarrierMain", "BarrierWing"]
...
IconNames = ["Main Hull Seperate", "Wing Seperate", "Reintegrate$Rein"]
...
MvamDistances[1].SetXYZ(0.0, -1.2255, 0.49412)
...
MvamReinDistances[0].SetXYZ(0.0, -6.24425, 0.0)
MvamReinDistances[1].SetXYZ(0.0, -9.0, 0.495)
...
############# file too, if you decide to have one. Leave blank ("") if you don't want a sound
BridgeReinSoundName = "collision2"
...
def BarrierMain(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "BarrierMain")
...
def BarrierWing(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "BarrierWing")
