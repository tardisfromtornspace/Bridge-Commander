...
MvamShips = ["TardisType89", "TardisType89Chamaleon"]
...
def TardisType89Chamaleon(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "TardisType89Chamaleon")
