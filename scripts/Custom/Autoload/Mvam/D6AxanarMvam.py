...
MvamShips = ["D6Axanar", "D6AxanarBoom", "D6AxanarEngineering"]
...
IconNames = ["Boom Section Seperate", "Engineering Section Seperate", "Reintegrate$Rein"]
...
MvamDistances[0].SetXYZ(0.0, 0.642624, 0.0)
...
MvamDirections[1].SetXYZ(0.0, -0.1, 0.0)
...
MvamReinDistances[0].SetXYZ(0.0, 7.481, 0.0)
MvamReinDistances[1].SetXYZ(0.0, -3.211024, 0.0) #-3.2105+0.642624
...
MvamReinDirections[1].SetXYZ(0.0, 0.1, 0.0)
...
BridgeSoundName = "D6AxanarSepSFX"
...
def D6AxanarBoom(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "D6AxanarBoom")
...
def D6AxanarEngineering(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "D6AxanarEngineering")
