...
MvamShips = ["BattleTardis", "BattleTardisChamaleon"]
...
IconNames = ["Activate Chamaleon Circuit", "Deactivate$Rein"]
...
def BattleTardisChamaleon(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "BattleTardisChamaleon")
