...
MvamShips = ["DalekSmallSaucer", "DalekSmallSaucer", "Dalek2005Gold" , "Dalek2005Gold2" , "Dalek2005Gold3" , "Dalek2005Gold4" , "Dalek2005Gold5", "Dalek2005Gold6", "Dalek2005Gold7", "Dalek2005Gold8", "Dalek2005Gold9", "Dalek2005Gold10"]
...
MvamDistances[1].SetXYZ(0.000000, 4.75, 1.350000)
MvamDistances[2].SetXYZ(-0.050000, 4.60, 1.350000)
MvamDistances[3].SetXYZ(0.000000, 4.60, 1.350000)
MvamDistances[4].SetXYZ(0.050000, 4.60, 1.350000)
MvamDistances[5].SetXYZ(-0.050000, 4.50, 1.350000)
MvamDistances[6].SetXYZ(0.000000, 4.50, 1.350000)
MvamDistances[7].SetXYZ(0.050000, 4.50, 1.350000)
MvamDistances[8].SetXYZ(-0.050000, 4.40, 1.350000)
MvamDistances[9].SetXYZ(0.000000, 4.40, 1.350000)
MvamDistances[10].SetXYZ(0.050000, 4.40, 1.350000)
...
MvamReinDistances[1].SetXYZ(0.000000, -4.75, 1.550000)
MvamReinDistances[2].SetXYZ(-0.050000, -4.80, 1.550000)
MvamReinDistances[3].SetXYZ(0.000000, -4.80, 1.550000)
MvamReinDistances[4].SetXYZ(0.050000, -4.80, 1.550000)
MvamReinDistances[5].SetXYZ(-0.050000, -4.90, 1.550000)
MvamReinDistances[6].SetXYZ(0.000000, -4.90, 1.550000)
MvamReinDistances[7].SetXYZ(0.050000, -4.90, 1.550000)
MvamReinDistances[8].SetXYZ(-0.050000, -5.00, 1.550000)
MvamReinDistances[9].SetXYZ(0.000000, -5.00, 1.550000)
MvamReinDistances[10].SetXYZ(0.050000, -5.00, 1.550000)
...
def DalekSmallSaucer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "DalekSmallSaucer")
...
def CheckSeperate (pShip):
	...
	if (pEnemies.IsNameInGroup(pShip.GetName())):
		...
		if (pEnemies.GetNumActiveObjects() <= 4):
			return 1
	#the ship is a friendly or neutral
	else:
		#separate if there are not enough of our team
		if (pFriendlies.GetNumActiveObjects() <= 4):
			return 1
	return 0
