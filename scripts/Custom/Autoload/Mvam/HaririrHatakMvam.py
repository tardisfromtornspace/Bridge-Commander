...
MvamShips = ["HaririrHatak", "HaririrHatak", "HaririrDeathGlider1", "HaririrDeathGlider2", "HaririrDeathGlider3", "HaririrDeathGlider4", "HaririrDeathGlider5", "HaririrDeathGlider6"]
...
MvamReinSpeeds = [0.0, 0.1, 0.1, 0,1]
...
def HaririrHatak(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HaririrHatak")
...
def HaririrDeathGlider1(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HaririrDeathGlider1")
...
###TO CHANGE: dont forget to change this name too.
def HaririrDeathGlider2(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HaririrDeathGlider2")
...
###TO CHANGE: dont forget to change this name too.
def HaririrDeathGlider3(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "HaririrDeathGlider3")
