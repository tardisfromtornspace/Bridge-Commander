...
Foundation.BridgeDef('TOSBerlin', 'TOSBerlinBridge', dict = {
	...
	"bridgeSound": {
			...
			"RedAlertSound": {"volume": 1.0,"file": "sfx/TOS/mary-redalert-tos.wav", "group": "BridgeGeneric"},
		...
		'GreenMaps':{'def_alarm1': 'data/Models/Sets/TOSBerlinBridge/def_alarm1.tga','red_alert1': 'data/Models/Sets/TOSBerlinBridge/red_alert1.tga'},
		'YellowMaps':{'def_alarm1': 'data/Models/Sets/TOSBerlinBridge/def_alarm1YELLOW.tga','red_alert1': 'data/Models/Sets/TOSBerlinBridge/red_alert1.tga'},
		'RedMaps':{'def_alarm1': 'data/Models/Sets/TOSBerlinBridge/def_alarm1RED.tga','red_alert1': 'data/Models/Sets/TOSBerlinBridge/red_alert3.tga'},
		'NormalMaps':{'def_alarm1': 'data/Models/Sets/TOSBerlinBridge/def_alarm1.tga','red_alert1': 'data/Models/Sets/TOSBerlinBridge/red_alert1.tga'}
		},
