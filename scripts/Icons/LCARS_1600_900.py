...
SCREEN_PIXEL_HEIGHT		= 900.0

DEFAULT_ST_INDENT_HORIZ	= 6		/ SCREEN_PIXEL_WIDTH # 7
DEFAULT_ST_INDENT_VERT	= 3		/ SCREEN_PIXEL_HEIGHT
MARKER_INDENT_HORIZ		= 2		/ SCREEN_PIXEL_WIDTH
TAC_WEAPONS_CTRL_INDENT_HORIZ = 8 / SCREEN_PIXEL_WIDTH # 7
