...
SCREEN_PIXEL_WIDTH		= 1920.0 *1.5
SCREEN_PIXEL_HEIGHT		= 1080.0 *1.5
...
# Pane dimensions.
TACTICAL_MENU_WIDTH		= 146 * 3	/ SCREEN_PIXEL_WIDTH
TACTICAL_MENU_HEIGHT	= 250 *1.5	/ SCREEN_PIXEL_HEIGHT
								
SHIELDS_DISPLAY_WIDTH	= 146 *1.5	/ SCREEN_PIXEL_WIDTH
SHIELDS_DISPLAY_HEIGHT	= 121 *1.6	/ SCREEN_PIXEL_HEIGHT

DAMAGE_DISPLAY_WIDTH	= 146 *1.5	/ SCREEN_PIXEL_WIDTH
DAMAGE_DISPLAY_HEIGHT	= 121 *1.5	/ SCREEN_PIXEL_HEIGHT

WEAPONS_PANE_WIDTH		= 155 *2	/ SCREEN_PIXEL_WIDTH
WEAPONS_PANE_HEIGHT		= 137 *2	/ SCREEN_PIXEL_HEIGHT

WEAPONS_PANE_PIXEL_WIDTH	= 155 *2
WEAPONS_PANE_PIXEL_HEIGHT	= 131 *2

WEAPONS_CTRL_PANE_WIDTH = 153 *2	/ SCREEN_PIXEL_WIDTH
WEAPONS_CTRL_PANE_HEIGHT = 137 *2	/ SCREEN_PIXEL_HEIGHT

# Picard pane dimensions
PICARD_MENU_WIDTH		= 170 *2	/ SCREEN_PIXEL_WIDTH
PICARD_MENU_HEIGHT		= 250 *2	/ SCREEN_PIXEL_HEIGHT

# Display placement offsets
WEAPONS_DISPLAY_GAP_X	= 2 *2		/ SCREEN_PIXEL_WIDTH

# Radar display variables.
RADAR_SCOPE_WIDTH		= 146 *2	/ SCREEN_PIXEL_WIDTH
RADAR_SCOPE_HEIGHT		= 146 *2	/ SCREEN_PIXEL_HEIGHT

# Radar toggle variables
RADAR_TOGGLE_WIDTH		= 60 *2	/ SCREEN_PIXEL_WIDTH
RADAR_TOGGLE_HEIGHT		= 14 *2	/ SCREEN_PIXEL_HEIGHT

# Shield arc positions.
TOP_SHIELD_Y			= 17 *1.5	/ SCREEN_PIXEL_HEIGHT
BOTTOM_SHIELD_Y			= 53 *1.5	/ SCREEN_PIXEL_HEIGHT
FRONT_SHIELD_Y			=  5 *1.5	/ SCREEN_PIXEL_HEIGHT
REAR_SHIELD_Y			= 93 *1.5	/ SCREEN_PIXEL_HEIGHT
SIDE_SHIELDS_Y			= 22 *1.5	/ SCREEN_PIXEL_HEIGHT
SIDE_SHIELDS_X_OFFSET		= 2  *1.5	/ SCREEN_PIXEL_WIDTH

# Weapons display variables.
SHIP_Y_OFFSET			= 7		/ SCREEN_PIXEL_HEIGHT

# LeftSeparator window style variables.
PRETITLE_BAR_WIDTH		= 13 *2	/ SCREEN_PIXEL_HEIGHT
LEFT_SEPARATOR_BOTTOM_GAP = 4 *2	/ SCREEN_PIXEL_HEIGHT
...
# Tool-tip sizes
TOOL_TIP_WIDTH				= 250 *2 / SCREEN_PIXEL_WIDTH
TOOL_TIP_HEIGHT				= 80 *2 / SCREEN_PIXEL_HEIGHT
...
def LoadLCARS_640(LCARS = None):
	...
	# White block
	LCARS.SetIconLocation(200, kTextureHandle, 12*3, 3, 8, 8)
