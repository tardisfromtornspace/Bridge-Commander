...
def SetupSmokeTrail(pTorpedo):
    ...
    pSequence.AddAction(CreateSmokeHigh('data/Textures/Effects/ExplosionC.tga', 0.01, 0.2, pTorpedo.GetRadius() * 3, pEmitFrom, App.NiPoint3(0, 0, 0), App.NiPoint3(0, 0, 0), pEffectRoot))
    pSequence.Play()
