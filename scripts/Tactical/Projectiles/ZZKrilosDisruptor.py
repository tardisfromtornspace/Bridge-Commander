...
def AttachSmoke(self, pEvent = None):
    ...
    trails.OriBeam.SetupSmokeTrail(pTorpedo, sTexture = 'data/Textures/Effects/ZZPDTrailY.tga', fFrequency = 0.01, fVelocity = 0.01, evVar = 0.1, fSize = pTorpedo.GetRadius() * 1.0, sEmitLife = 0.075, elVar = 0.1, sEffectLifetime = 6.0, leDamp = 0.2, inhVel = -1, sAngleVariance = 360.0, kEmitPos = App.NiPoint3(0, 0, 0), kEmitDir = App.NiPoint3(0, 1, 0), pEffectRoot = pTorpedo, pFunction = trails.ZZKrilosDis.DefaultColorKeyFunc)
    return 0
