...
def Create(pTorp):
	...
	kCoreColor.SetRGBA(225.0 / 255.0, 255.0 / 255.0, 255.0 / 255.0, 1.000000)
	kGlowColor = App.TGColorA()
	kGlowColor.SetRGBA(225.0 / 255.0, 255.0 / 255.0, 255.0 / 255.0, 1.000000)	
...
def GetLaunchSound():
	return("ExistentialUnteatheringDevice")
