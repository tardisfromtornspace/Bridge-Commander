...
def Create(pTorp):
	...
	kFlareColor.SetRGBA(205.0 / 255.0, 250.0 / 255.0, 255.0 / 255.0, 1.000000)
	...
	pTorp.CreateTorpedoModel(
					...
					0.2,
					4.0,	 
					"data/Textures/Tactical/EctoplasmaticTorpedo.tga", 
					kGlowColor,
					1.0,	
					0.80,	 
					1.5,	
...
def GetLaunchSound():
	return("EctoplasmaticTorpedo")

def GetPowerCost():
	return(30.0)

def GetName():
	return("Ectoplasmatic Torpedo")
