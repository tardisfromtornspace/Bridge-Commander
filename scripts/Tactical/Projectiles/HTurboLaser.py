...
##
##	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 8.0, 0.15)
	...
	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 5.5, 0.12) 
...
global lImmuneShips   #In this case Immune is used for those NOT IMMUNE
lImmuneShips = (
                "ancientshuttle",
                "AndArchlike",
                "AndSlipfighter",
...
### LJ INSERTS - CHECK FOR NOT IMMUNE SHIP
	global lImmuneShips
