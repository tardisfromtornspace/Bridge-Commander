...
def CreateSmokeHigh(sTexture, fFrequency, fVelocity, fSize, pEmitFrom, kEmitPos, kEmitDir, pAttachTo):
    ...
    pSmoke.AddSizeKey(0.0, 0.07 * fSize)
    pSmoke.AddSizeKey(0.2, 0.33 * fSize)
    pSmoke.AddSizeKey(0.3, 0.66 * fSize)
...
def SetupSmokeTrail(pTorpedo):
    ...
    pSequence.AddAction(CreateSmokeHigh('data/Textures/Effects/ExplosionB.tga', 0.01, 0.2, pTorpedo.GetRadius() * 1.25, pEmitFrom, App.NiPoint3(0, 0, 0), App.NiPoint3(0, 0, 0), pEffectRoot))
    pSequence.Play()
