...
def Create(pTorp):
    ...
    kCoreColor.SetRGBA(145.0 / 155.0, 15.0 / 20.0, 255.0 / 255.0, 1.0)
    kGlowColor = App.TGColorA()
    kGlowColor.SetRGBA(222.0 / 232.0, 255.0 / 255.0, 15.0 / 25.0, 1.0)
    kFlareColor = App.TGColorA()
    kFlareColor.SetRGBA(15.0 / 20.0, 255.0 / 255.0, 175.0 /180.0, 1.0)
...
def GetLaunchSound():
    return 'EnergyDiffusingTorp'

def GetPowerCost():
    return 10.0

def GetName():
    return 'Energy Diffusing Torp'
