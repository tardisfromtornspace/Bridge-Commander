...
def Create(pTorp):
    ...
    kCoreColor.SetRGBA(0.0 / 255.0, 255.0 / 255.0, 40.0 / 255.0, 1.0)
    kGlowColor = App.TGColorA()
    kGlowColor.SetRGBA(78.0 / 255.0, 0.0 / 255.0, 255.0 / 255.0, 1.0)
    kFlareColor = App.TGColorA()
    kFlareColor.SetRGBA(168.0 / 255.0, 0.0 / 255.0, 255.0 / 255.0, 1.0)
...
def GetLaunchSound():
	return("KeneticChronomorphic")

def GetPowerCost():
	return(10.0)

def GetName():
	return("Kenetic Chronomorphic")
