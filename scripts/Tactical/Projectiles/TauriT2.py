...
def Create(pTorp):
	...
	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 1.0, 0.4)
	...
	pTorp.SetNetType (Multiplayer.SpeciesToTorp.DISRUPTOR)
        ...
        trails.TauriT2.AddCreationHandler(pTorp, __name__ + ".AttachSmoke")
        return(0)
...
def AttachSmoke(self, pEvent = None):
    ...
    trails.TauriT2.SetupSmokeTrail(pTorpedo)
    return (0)
