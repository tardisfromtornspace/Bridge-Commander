...
def Create(pTorp):
	...
	kGlowColor.SetRGBA(255.0 / 255.0, 82.0 / 255.0, 0.0 / 255.0, 1.000000)	#Red, Green, Blue, Alpha - all values other than alpha are devided by 255
	kFlareColor = App.TGColorA()
	kFlareColor.SetRGBA(255.0 / 255.0, 0.0 / 255.0, 0.0 / 255.0, 1.000000)	#Red, Green, Blue, Alpha - all values other than alpha are devided by 255
...
def GetLaunchSound():
	return("InvertedDimensionalImplosionDevice")

def GetPowerCost():
	return(10000.0)

def GetName():
	return("Inverted Dimensional Implosion Device")
