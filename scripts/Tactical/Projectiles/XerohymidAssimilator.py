...
def Create(pTorp):
	...
	kOuterCoreColor.SetRGBA(1.0 / 255.0, 1.0 / 255.0, 1.0 / 255.0, 1.000000)

	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 1.5, 0.5) 	
...
def GetLaunchSound():
	return("XerohymidAssimilator")

def GetPowerCost():
        return (10.0)

def GetName():
	return("Xerohymid Assimilator")
