...
def Create(pTorp):
	...
	kOuterShellColor.SetRGBA(0.0, 0.0, 1.0, 1.0)
	kOuterCoreColor = App.TGColorA()
	kOuterCoreColor.SetRGBA(0.8, 0.8, 1.0, 1.000000)
	pTorp.CreateDisruptorModel(kOuterShellColor,kOuterCoreColor, 0.4, 0.0075) 	
...
oFire = ftb.Tech.EMPProjectile.oEMPProjectile
