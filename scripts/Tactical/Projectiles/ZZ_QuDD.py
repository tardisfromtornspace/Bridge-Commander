...
def AttachSmoke(self, pEvent = None):
    ...
    trails.OriBeam.SetupSmokeTrail(pTorpedo, sTexture = 'data/Textures/Effects/ZZPDTrail.tga', fFrequency = 0.005, fVelocity = 0.01, evVar = 0.1, fSize = pTorpedo.GetRadius() * 0.5, sEmitLife = 0.075, elVar = 0.1, sEffectLifetime = 8.0, leDamp = 0.2, inhVel = -1, sAngleVariance = 360.0, kEmitPos = App.NiPoint3(0, 0, 0), kEmitDir = App.NiPoint3(0, 1, 0), pEffectRoot = pTorpedo, pFunction = trails.ZZPDTrail.DefaultColorKeyFunc)
    return 0
