...
def Initialize():
	# Create the set ("Voltair2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Voltair2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Voltair.Voltair2")
	...
	# "Voltair2_S.py" file with an Initialize function that creates them.
	try:
		import Voltair2_S
		Voltair2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Voltair2")

def Terminate():
	App.g_kSetManager.DeleteSet("Voltair2")
