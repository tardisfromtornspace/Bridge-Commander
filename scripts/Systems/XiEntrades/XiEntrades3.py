...
def Initialize():
	# Create the set ("XiEntrades3")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.XiEntrades.XiEntrades3")

	App.g_kSetManager.AddSet(pSet, "XiEntrades3")
	...
	# "XiEntrades2_S.py" file with an Initialize function that creates them.
	try:
		import XiEntrades3_S
		XiEntrades3_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("XiEntrades3")

def Terminate():
	App.g_kSetManager.DeleteSet("XiEntrades3")
