...
def Initialize():
	# Create the set ("XiEntrades1")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.XiEntrades.XiEntrades1")

	App.g_kSetManager.AddSet(pSet, "XiEntrades1")
	...
	# "XiEntrades1_S.py" file with an Initialize function that creates them.
	try:
		import XiEntrades1_S
		XiEntrades1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("XiEntrades1")

def Terminate():
	App.g_kSetManager.DeleteSet("XiEntrades1")
