...
def Initialize():
	# Create the set ("XiEntrades5")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.XiEntrades.XiEntrades5")

	App.g_kSetManager.AddSet(pSet, "XiEntrades5")
	...
	# "XiEntrades5_S.py" file with an Initialize function that creates them.
	try:
		import XiEntrades5_S
		XiEntrades5_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("XiEntrades5")

def Terminate():
	App.g_kSetManager.DeleteSet("XiEntrades5")
