...
def Initialize():
	# Create the set ("Itari1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Itari1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Itari.Itari1")
	...
	# "Itari1_S.py" file with an Initialize function that creates them.
	try:
		import Itari1_S
		Itari1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Itari1")

def Terminate():
	App.g_kSetManager.DeleteSet("Itari1")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-1000.000000, 1000.000000, 1000.000000)
	kForward = App.TGPoint3()
