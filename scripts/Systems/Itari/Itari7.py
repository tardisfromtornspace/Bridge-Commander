...
def Initialize():
	# Create the set ("Itari7")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Itari7")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Itari.Itari7")
	...
	# "Itari7_S.py" file with an Initialize function that creates them.
	try:
		import Itari7_S
		Itari7_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Itari7")

def Terminate():
	App.g_kSetManager.DeleteSet("Itari7")
