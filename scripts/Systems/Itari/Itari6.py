...
def Initialize():
	# Create the set ("Itari6")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Itari6")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Itari.Itari6")
	...
	# "Itari6_S.py" file with an Initialize function that creates them.
	try:
		import Itari6_S
		Itari6_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Itari6")

def Terminate():
	App.g_kSetManager.DeleteSet("Itari6")
...
def LoadPlacements(sSetName):
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(2000.0, -65000.0, -5000.0)
	kForward = App.TGPoint3()
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(1000.000000, -1500.000000, 350.000000)
	kForward = App.TGPoint3()
