...
def Initialize():
	# Create the set ("Itari2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Itari2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Itari.Itari2")
	...
	# "Itari2_S.py" file with an Initialize function that creates them.
	try:
		import Itari2_S
		Itari2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Itari2")

def Terminate():
	App.g_kSetManager.DeleteSet("Itari2")
