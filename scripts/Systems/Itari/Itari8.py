...
def Initialize():
	# Create the set ("Itari8")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Itari8")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Itari.Itari8")
	...
	# "Itari8_S.py" file with an Initialize function that creates them.
	try:
		import Itari8_S
		Itari8_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Itari8")

def Terminate():
	App.g_kSetManager.DeleteSet("Itari8")
...
# Position "Planet"
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-800.000000, 1000.000000, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.332255, -0.942401, -0.038562)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.002558, -0.041785, 0.999123)
