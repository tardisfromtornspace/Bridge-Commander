...
def Initialize():
	# Create the set ("Belaruz2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Belaruz2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Belaruz.Belaruz2")
	...
	# "Belaruz2_S.py" file with an Initialize function that creates them.
	try:
		import Belaruz2_S
		Belaruz2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Belaruz2")

def Terminate():
	App.g_kSetManager.DeleteSet("Belaruz2")
