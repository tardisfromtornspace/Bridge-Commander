...
def Initialize():
	# Create the set ("OmegaDraconis1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "OmegaDraconis1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.OmegaDraconis.OmegaDraconis1")
	...
	# "OmegaDraconis1_S.py" file with an Initialize function that creates them.
	try:
		import OmegaDraconis1_S
		OmegaDraconis1_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "OmegaDraconis1"

def GetSet():
	return App.g_kSetManager.GetSet("OmegaDraconis1")

def Terminate():
	App.g_kSetManager.DeleteSet("OmegaDraconis1")
...
def LoadPlacements(sSetName):
	...
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	kThis.AlignToVectors(kForward, kUp)
	kThis.ConfigDirectionalLight(1, 1, .4, 1)
	kThis.Update(0)
	kThis = None
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(0.000000, 1680.000000, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(200.000000, -1000.000000, -100.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
