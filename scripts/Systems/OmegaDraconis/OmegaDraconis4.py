...
def Initialize():
	# Create the set ("OmegaDraconis4")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "OmegaDraconis4")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.OmegaDraconis.OmegaDraconis4")
	...
	# "OmegaDraconis4_S.py" file with an Initialize function that creates them.
	try:
		import OmegaDraconis4_S
		OmegaDraconis4_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "OmegaDraconis4"

def GetSet():
	return App.g_kSetManager.GetSet("OmegaDraconis4")

def Terminate():
	App.g_kSetManager.DeleteSet("OmegaDraconis4")

def LoadPlacements(sSetName):
	# Position "Planet1"
	kThis = App.Waypoint_Create("Planet1", sSetName, None)
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(50.000000, 800.000000, 100.000000)
