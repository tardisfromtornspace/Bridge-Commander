...
def Initialize():
	# Create the set ("OmegaDraconis3")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "OmegaDraconis3")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.OmegaDraconis.OmegaDraconis3")
	...
	# "OmegaDraconis3_S.py" file with an Initialize function that creates them.
	try:
		import OmegaDraconis3_S
		OmegaDraconis3_S.Initialize(pSet)
	except ImportError:
...
def GetSetName():
	return "OmegaDraconis3"

def GetSet():
	return App.g_kSetManager.GetSet("OmegaDraconis3")
