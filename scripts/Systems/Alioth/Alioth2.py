...
def Initialize():
	# Create the set ("Alioth2")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Alioth.Alioth2")

	App.g_kSetManager.AddSet(pSet, "Alioth2")
	...
	# "Alioth2_S.py" file with an Initialize function that creates them.
	try:
		import Alioth2_S
		Alioth2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Alioth2")

def Terminate():
	App.g_kSetManager.DeleteSet("Alioth2")
