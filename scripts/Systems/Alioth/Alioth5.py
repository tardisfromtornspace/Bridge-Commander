...
def Initialize():
	# Create the set ("Alioth5")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Alioth.Alioth5")

	App.g_kSetManager.AddSet(pSet, "Alioth5")
	...
	# "Alioth5_S.py" file with an Initialize function that creates them.
	try:
		import Alioth5_S
		Alioth5_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Alioth5")

def Terminate():
	App.g_kSetManager.DeleteSet("Alioth5")
