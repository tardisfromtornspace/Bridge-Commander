...
def Initialize():
	# Create the set ("Alioth1")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Alioth.Alioth1")

	App.g_kSetManager.AddSet(pSet, "Alioth1")
	...
	# "Alioth1_S.py" file with an Initialize function that creates them.
	try:
		import Alioth1_S
		Alioth1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Alioth1")

def Terminate():
	App.g_kSetManager.DeleteSet("Alioth1")
