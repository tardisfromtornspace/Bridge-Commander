...
def Initialize():
	# Create the set ("Alioth4")
	pSet = App.SetClass_Create()

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Alioth.Alioth4")

	App.g_kSetManager.AddSet(pSet, "Alioth4")
	...
	# "Alioth4_S.py" file with an Initialize function that creates them.
	try:
		import Alioth4_S
		Alioth4_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Alioth4")

def Terminate():
	App.g_kSetManager.DeleteSet("Alioth4")
