...
def Initialize():
	# Create the set ("Nepenthe3")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Nepenthe3")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Nepenthe.Nepenthe3")
	...
	# "Nepenthe3_S.py" file with an Initialize function that creates them.
	try:
		import Nepenthe3_S
		Nepenthe3_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Nepenthe3")

def Terminate():
	App.g_kSetManager.DeleteSet("Nepenthe3")
