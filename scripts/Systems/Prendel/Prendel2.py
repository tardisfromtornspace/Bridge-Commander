...
def Initialize():
	# Create the set ("Prendel2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Prendel2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Prendel.Prendel2")
	...
	# "Prendel2_S.py" file with an Initialize function that creates them.
	try:
		import Prendel2_S
		Prendel2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Prendel2")

def Terminate():
	App.g_kSetManager.DeleteSet("Prendel2")
