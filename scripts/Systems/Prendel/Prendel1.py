...
def Initialize():
	# Create the set ("Prendel1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Prendel1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Prendel.Prendel1")
	...
	# "Prendel1_S.py" file with an Initialize function that creates them.
	try:
		import Prendel1_S
		Prendel1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Prendel1")

def Terminate():
	App.g_kSetManager.DeleteSet("Prendel1")
