...
def Initialize():
	# Create the set ("Prendel4")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Prendel4")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Prendel.Prendel4")
	...
	# "Prendel4_S.py" file with an Initialize function that creates them.
	try:
		import Prendel4_S
		Prendel4_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Prendel4")

def Terminate():
	App.g_kSetManager.DeleteSet("Prendel4")
