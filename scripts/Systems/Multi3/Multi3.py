...
def CreateMenus():
	...
	return Systems.Utils.CreateSystemMenu("MRegion3", "Systems.Multi3.Multi3",
										  "Systems.Multi3.Multi3")

def Initialize():
	# Create the set ("Multi3")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Multi3")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Multi3.Multi3")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("Multi3")
	LoadBackdrops(pSet)
	...
	# "Multi3_S.py" file with an Initialize function that creates them.
	try:
		import multi3_S
		multi3_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Multi3")

def Terminate():
	App.g_kSetManager.DeleteSet("Multi3")
