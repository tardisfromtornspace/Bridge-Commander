...
def CreateMenus():
	...
	return Systems.Utils.CreateSystemMenu("MRegion5", "Systems.Multi5.Multi5",
										  "Systems.Multi5.Multi5")

def Initialize():
	# Create the set ("Multi5")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Multi5")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Multi5.Multi5")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("Multi5")
	LoadBackdrops(pSet)
	...
	# "Multi5_S.py" file with an Initialize function that creates them.
	try:
		import Multi5_S
		Multi5_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Multi5")

def Terminate():
	App.g_kSetManager.DeleteSet("Multi5")
