...
def Initialize():
	# Create the set ("Artrus2")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Artrus2")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Artrus.Artrus2")

	# Activate the proximity manager for our set.
	pSet.SetProximityManagerActive(1)

	# Load the placements and backdrops for this set.
	LoadPlacements("Artrus2")
	LoadBackdrops(pSet)
	...
	# "Artrus2_S.py" file with an Initialize function that creates them.
	try:
		import Artrus2_S
		Artrus2_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Artrus2")

def Terminate():
	App.g_kSetManager.DeleteSet("Artrus2")
...
def LoadPlacements(sSetName):
	...
	kThis.SetTranslateXYZ(0.000000, 0.000000, 0.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.881930, 0.212259, 0.420888)
	kUp = App.TGPoint3()
	kUp.SetXYZ(-0.433988, 0.017100, 0.900756)
	kThis.AlignToVectors(kForward, kUp)
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(-58500.000000, -14000.000000, -28000.000000)
	kForward = App.TGPoint3()
	kForward.SetXYZ(0.000000, 1.000000, 0.000000)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.000000, 0.000000, 1.000000)
	...
	kThis.SetStatic(1)
	kThis.SetNavPoint(0)
	kThis.SetTranslateXYZ(475.527557, 494.708191, -52.228016)
	kForward = App.TGPoint3()
	kForward.SetXYZ(-0.037757, 0.986141, -0.161554)
	kUp = App.TGPoint3()
	kUp.SetXYZ(0.235873, 0.165896, 0.957519)
	kThis.AlignToVectors(kForward, kUp)
	kThis.SetSpeed(25.000000)
	kThis.Update(0)
	kThis = None
...
def LoadBackdrops(pSet):
	...
	kThis.SetVerticalSpan(0.109877)
	kThis.SetSphereRadius(300.000000)
