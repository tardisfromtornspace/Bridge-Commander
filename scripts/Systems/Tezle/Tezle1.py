...
def Initialize():
	# Create the set ("Tezle1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Tezle1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Tezle.Tezle1")
	...
	# "Tezle1_S.py" file with an Initialize function that creates them.
	try:
		import Tezle1_S
		Tezle1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Tezle1")

def Terminate():
	App.g_kSetManager.DeleteSet("Tezle1")
...
def LoadPlacements(sSetName):
	...
	kThis.ConfigAmbientLight(1.000000, 1.000000, 1.00000, 0.1)
	kThis.Update(0)
	kThis = None
	...
	kThis.SetStatic(1)
	kThis.SetTranslateXYZ(3.299058, 185.813141, -2.081728)
	kForward = App.TGPoint3()
