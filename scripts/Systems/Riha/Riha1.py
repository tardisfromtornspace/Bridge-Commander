...
def Initialize():
	# Create the set ("Riha1")
	pSet = App.SetClass_Create()
	App.g_kSetManager.AddSet(pSet, "Riha1")

	# Save the name of the region file that's creating the set.
	pSet.SetRegionModule("Systems.Riha.Riha1")
	...
	# "Riha1_S.py" file with an Initialize function that creates them.
	try:
		import Riha1_S
		Riha1_S.Initialize(pSet)
	except ImportError:
...
def GetSet():
	return App.g_kSetManager.GetSet("Riha1")

def Terminate():
	App.g_kSetManager.DeleteSet("Riha1")
