###############################################################################
#	Filename:	ItalianConfig.py
#	
#	Confidential and Proprietary, Copyright 2002 by Totally Games
#	
#	Maps Italian keyboard scancodes to Unicode.  For an Italian keyboard, this file
...
def MapScancodes():
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKSLASH, App.KY_BACKQUOTE, pDatabase, "\\")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_GRAVE, App.KY_OPEN_BRACKET, pDatabase, "e GRAVE")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_GRAVE, App.KY_SEMICOLON, pDatabase, "o GRAVE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_GRAVE, App.KY_QUOTE, pDatabase, "a GRAVE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_GRAVE, App.KY_EU_RIGHT, pDatabase, "u GRAVE")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEPARATOR, App.KY_BACKQUOTE, pDatabase, "|", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_EQUALS, pDatabase, "^", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_ACUTE, App.KY_OPEN_BRACKET, pDatabase, "e ACUTE", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_C_CEDILLA, App.KY_SEMICOLON, pDatabase, "c CEDILLA", App.KY_SHIFT)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_HIGH_CIRCLE, App.KY_QUOTE, pDatabase, "circle thing", App.KY_SHIFT)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_EU_RIGHT, pDatabase, "Euro Sign", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_GRAVE, App.KY_OPEN_BRACKET, pDatabase, "e GRAVE", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_GRAVE, App.KY_SEMICOLON, pDatabase, "o GRAVE", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_GRAVE, App.KY_QUOTE, pDatabase, "a GRAVE", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_GRAVE, App.KY_EU_RIGHT, pDatabase, "u GRAVE", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_E_GRAVE, App.KY_OPEN_BRACKET, pDatabase, "e GRAVE", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_GRAVE, App.KY_SEMICOLON, pDatabase, "o GRAVE", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_GRAVE, App.KY_QUOTE, pDatabase, "a GRAVE", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_GRAVE, App.KY_EU_RIGHT, pDatabase, "u GRAVE", App.KY_CTRL)
...
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_E, pDatabase, "Euro Sign", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AT_SIGN, App.KY_SEMICOLON, pDatabase, "@", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_QUOTE, pDatabase, "#", App.KY_ALTGR)
