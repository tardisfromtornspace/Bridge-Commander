###############################################################################
#	Filename:	SpanishConfig.py
#	
#	Confidential and Proprietary, Copyright 2002 by Totally Games
#	
#	Maps Spanish keyboard scancodes to Unicode.  For a Spanish keyboard, this file
...
def MapScancodes():
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_MINUS, pDatabase, "'")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_EXCLAMATION, App.KY_EQUALS, pDatabase, "INV !")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_OPEN_BRACKET, pDatabase, "`")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_N_TILDE, App.KY_SEMICOLON, pDatabase, "n TILDE")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ACUTE_ACCENT, App.KY_QUOTE, pDatabase, "ACUTE ACCENT")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_C_CEDILLA, App.KY_EU_RIGHT, pDatabase, "c CEDILLA")
	...
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_HIGH_A, App.KY_BACKQUOTE, pDatabase, "HIGH a", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PERIOD, App.KY_3, pDatabase, ".", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_QUESTION_MARK, App.KY_EQUALS, pDatabase, "INV ?", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_OPEN_BRACKET, pDatabase, "^", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_N_TILDE, App.KY_SEMICOLON, pDatabase, "N TILDE", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_DOUBLE_QUOTE, App.KY_QUOTE, pDatabase, "INV \"", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_C_CEDILLA, App.KY_EU_RIGHT, pDatabase, "C CEDILLA", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_MINUS, pDatabase, "'", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_EXCLAMATION, App.KY_EQUALS, pDatabase, "INV !", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_OPEN_BRACKET, pDatabase, "`", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_N_TILDE, App.KY_SEMICOLON, pDatabase, "n TILDE", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ACUTE_ACCENT, App.KY_QUOTE, pDatabase, "ACUTE ACCENT", App.KY_ALT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_C_CEDILLA, App.KY_EU_RIGHT, pDatabase, "c CEDILLA", App.KY_ALT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_MINUS, pDatabase, "'", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_INVERTED_EXCLAMATION, App.KY_EQUALS, pDatabase, "INV !", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_OPEN_BRACKET, pDatabase, "`", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_N_TILDE, App.KY_SEMICOLON, pDatabase, "n TILDE", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ACUTE_ACCENT, App.KY_QUOTE, pDatabase, "ACUTE ACCENT", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_C_CEDILLA, App.KY_EU_RIGHT, pDatabase, "c CEDILLA", App.KY_CTRL)
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKSLASH, App.KY_BACKQUOTE, pDatabase, "\\", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEPARATOR, App.KY_1, pDatabase, "|", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AT_SIGN, App.KY_2, pDatabase, "@", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_3, pDatabase, "#", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_TILDE, App.KY_4, pDatabase, "~", App.KY_ALTGR)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_5, pDatabase, "Euro Sign", App.KY_ALTGR)
	#App.g_kInputManager.RegisterUnicodeKey(App.WC_BRACKET, App.KY_1, pDatabase, "Bracket", App.KY_ALTGR)
...
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_E, pDatabase, "Euro Sign", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_OPEN_BRACKET, App.KY_OPEN_BRACKET, pDatabase, "[", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_BRACKET, App.KY_CLOSE_BRACKET, pDatabase, "]", App.KY_ALTGR)

	# Map third row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPSLOCK, App.KY_CAPSLOCK, pDatabase, "CAPS", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_OPEN, App.KY_SEMICOLON, pDatabase, "{", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_CLOSE, App.KY_QUOTE, pDatabase, "}", App.KY_ALTGR)
