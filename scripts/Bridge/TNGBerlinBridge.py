...
#	It is only called by LoadBridge.Initialize("TNGBerlinBridge"), so don't
...
#	CreateBridgeModel()
#
#	Create the TNGBerlinBridge model, viewscreen and main camera, attaching them
...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/TNGBerlinBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/TNGBerlinBridge/Yamaguchi.NIF", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/TNGBerlinBridge/YamaguchiViewScreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/TNGBerlinBridge/YamaguchiViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/TNGBerlinBridge/Yamaguchi.NIF")
...
#	debug("Loading Galaxy red alert sound")
	...
	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/TNGBerlinBridge/RedAlert.wav",  "RedAlertSound", "BridgeGeneric")
