...
def CreateBridgeModel(pBridgeSet):
	...
	App.g_kModelManager.LoadModel("data/Models/Sets/Constitution/TASConstitution.NIF", None, pcEnvPath)
	...
	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/Constitution/TASConstitution.NIF")
