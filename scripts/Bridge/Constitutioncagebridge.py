...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/Constitutioncage/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/Constitutioncage/Constitutioncage.NIF", None, pcEnvPath)
	...
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/Constitutioncage/ConstitutioncageViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/Constitutioncage/Constitutioncage.NIF")
