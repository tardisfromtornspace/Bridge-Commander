...
#	CreateBridgeModel()
#
#	Create the Berlin bridge model, viewscreen and main camera, attaching them
...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/BerlinBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/BerlinBridge/EnterpriseC.NIF", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/BerlinBridge/EnterpriseCViewScreen.NIF", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/BerlinBridge/EnterpriseCViewScreen.NIF")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/BerlinBridge/EnterpriseC.NIF")
...
#	debug("Loading Galaxy red alert sound")

	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/mary-RedAlert.wav",  "RedAlertSound", "BridgeGeneric")

#	debug("Loading Galaxy green alert sound")

	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/mary-green.wav",  "greenAlertSound", "BridgeGeneric")

#	debug("Loading Galaxy yellow alert sound")

	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/mary-yellow.wav",  "yellowAlertSound", "BridgeGeneric")

#	debug("Loading Galaxy hail sound")

	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/TMP-hail.wav",  "Hail", "BridgeGeneric")

#	debug("Loading Galaxy Ambient sound")

	pGame = App.Game_GetCurrentGame()
	pGame.LoadSoundInGroup("sfx/TMP-ambient.wav",  "AmbBridge", "BridgeGeneric")
