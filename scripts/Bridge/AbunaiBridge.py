...
def CreateBridgeModel(pBridgeSet):
	...
	pcEnvPath = "data/Models/Sets/CenturyBridge/" + pcDetail[iDetail]

	# Pre-load the Bridge model and viewscreen
	App.g_kModelManager.LoadModel("data/Models/Sets/AbunaiBridge/EBridge.nif", None, pcEnvPath)
	App.g_kModelManager.LoadModel("data/Models/Sets/AbunaiBridge/EBridgeViewScreen.nif", None, pcEnvPath)

	# Load the viewscreen and set it up specially with SetViewScreen()
	pViewScreen = App.ViewScreenObject_Create("data/Models/Sets/AbunaiBridge/EBridgeViewScreen.nif")
	pBridgeSet.SetViewScreen(pViewScreen, "viewscreen")

	# Setup bridge object
	pBridgeObject = App.BridgeObjectClass_Create("data/Models/Sets/AbunaiBridge/EBridge.nif")
