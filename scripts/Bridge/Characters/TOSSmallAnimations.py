...
def TOSPlaceAtE(pCharacter):
	kAM = App.g_kAnimationManager
	kAM.LoadAnimation ("data/animations/TOS_stand_e_s.nif", "TOS_stand_e_s")
	pCharacter = App.CharacterClass_Cast(pCharacter)
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimPosition_Create(pAnimNode, "TOS_stand_e_s")
	pSequence.AddAction(pAction)
	return pSequence

	# Seat at E
def TOSSeatedE(pCharacter):
	kAM = App.g_kAnimationManager
	kAM.LoadAnimation ("data/animations/TOS_seated_e_s.nif", "TOS_seated_e_s")
	pCharacter = App.CharacterClass_Cast(pCharacter)
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimAction_Create(pAnimNode, "TOS_seated_e_s", 0, 0)
	pSequence.AddAction(pAction)
	return pSequence

def TOSPlaceAtS(pCharacter):
	kAM = App.g_kAnimationManager
	kAM.LoadAnimation ("data/animations/TOS_stand_S_S.nif", "TOS_stand_s_s")
	pCharacter = App.CharacterClass_Cast(pCharacter)
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimPosition_Create(pAnimNode, "TOS_stand_s_s")
	pSequence.AddAction(pAction)
	return pSequence
...
def TOSPlaceAtL1(pCharacter):
	kAM = App.g_kAnimationManager
	kAM.LoadAnimation ("data/animations/Exc_L1toG3_S.nif", "TOS_L1toG3_S")
	pSequence = App.TGSequence_Create()
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pCharacter.GetAnimNode(), "TOS_L1toG3_S", 0, 0), pOpenEyes)
	return pSequence

	# Seat at S
def TOSSeatedS(pCharacter):
	kAM = App.g_kAnimationManager
	kAM.LoadAnimation ("data/animations/TOS_stand_S_S.nif", "TOS_seated_s_s")
	pCharacter = App.CharacterClass_Cast(pCharacter)
	pSequence = App.TGSequence_Create()
	pAnimNode = pCharacter.GetAnimNode()
	pAction = App.TGAnimAction_Create(pAnimNode, "TOS_seated_s_s", 0, 0)
	pSequence.AddAction(pAction)
	return pSequence

	# Turn towards captain from Science
def TOSTurnAtSTowardsCaptain(pCharacter):
	kAM = App.g_kAnimationManager
	...
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pCharacter.GetAnimNode(), "TOS_face_capt_s", 0, 0, 1), pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pBridgeNode, "TOS_chair_s_face_capt", 0, 0), pOpenEyes)
	return pSequence

def TOSTurnBackAtSFromCaptain(pCharacter):
	kAM = App.g_kAnimationManager
	...
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pCharacter.GetAnimNode(), "TOS_face_capt_s_reverse", 0, 0, 1), pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pBridgeNode, "TOS_chair_s_face_capt_reverse", 0, 0), pOpenEyes)
	return pSequence

def TOSTurnAtETowardsCaptain(pCharacter):
	kAM = App.g_kAnimationManager
	...
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pCharacter.GetAnimNode(), "TOS_face_capt_e", 0, 0, 1), pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pBridgeNode, "TOS_chair_e_face_capt", 0, 0), pOpenEyes)
	return pSequence

def TOSTurnBackAtEFromCaptain(pCharacter):
	kAM = App.g_kAnimationManager
	...
	pOpenEyes = Bridge.Characters.CommonAnimations.EyesOpenMouthClosed(pCharacter)
	pSequence.AddAction(pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pCharacter.GetAnimNode(), "TOS_face_capt_e_reverse", 0, 0, 1), pOpenEyes)
	pSequence.AddAction(App.TGAnimAction_Create(pBridgeNode, "TOS_chair_e_face_capt_reverse", 0, 0), pOpenEyes)
	return pSequence
...
def TOSSConsoleInteraction(pCharacter):
	pCharacter = App.CharacterClass_Cast(pCharacter)
	if not (pCharacter):
		return None
...
def TOSEConsoleInteraction(pCharacter):
	pCharacter = App.CharacterClass_Cast(pCharacter)
	if not (pCharacter):
		return None
