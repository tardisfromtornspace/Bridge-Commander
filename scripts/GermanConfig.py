###############################################################################
#	Filename:	GermanConfig.py
#	
#	Confidential and Proprietary, Copyright 2002 by Totally Games
#	
#	Maps German keyboard scancodes to Unicode.  For a German keyboard, this file
#	should replace the default US KeyConfig.py and be named as such.
#	
#	Created:	1/14/02 -	David Litwin
###############################################################################
...
def MapScancodes():
	...
	# Map the first row
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_BACKQUOTE, pDatabase, "^")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SHARP_S, App.KY_MINUS, pDatabase, "SHARP S")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ACUTE_ACCENT, App.KY_EQUALS, pDatabase, "ACUTE ACCENT")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_Z, App.KY_Y, pDatabase, "z")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_DIAERESIS, App.KY_OPEN_BRACKET, pDatabase, "u DIAERESIS")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PLUS, App.KY_CLOSE_BRACKET, pDatabase, "+")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_DIAERESIS, App.KY_SEMICOLON, pDatabase, "o DIAERESIS")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_DIAERESIS, App.KY_QUOTE, pDatabase, "a DIAERESIS")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_Y, App.KY_Z, pDatabase, "y")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_MINUS, App.KY_SLASH, pDatabase, "-")
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CARRET, App.KY_BACKQUOTE, pDatabase, "^", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AMPERSAND, App.KY_6, pDatabase, "&", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SLASH, App.KY_7, pDatabase, "/", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_OPEN_PAREN, App.KY_8, pDatabase, "(", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_PAREN, App.KY_9, pDatabase, ")", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_EQUALS, App.KY_0, pDatabase, "=", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUESTION, App.KY_MINUS, pDatabase, "?", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKQUOTE, App.KY_EQUALS, pDatabase, "`", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_Z, App.KY_Y, pDatabase, "Z", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_U_DIAERESIS, App.KY_OPEN_BRACKET, pDatabase, "U DIAERESIS", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ASTERISK, App.KY_CLOSE_BRACKET, pDatabase, "*", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_O_DIAERESIS, App.KY_SEMICOLON, pDatabase, "O DIAERESIS", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_A_DIAERESIS, App.KY_QUOTE, pDatabase, "A DIAERESIS", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_QUOTE, App.KY_EU_RIGHT, pDatabase, "'", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_GREATER_THAN, App.KY_EU_LEFT, pDatabase, ">")
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CAPS_Y, App.KY_Z, pDatabase, "Y", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEMICOLON, App.KY_COMMA, pDatabase, ";", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_COLON, App.KY_PERIOD, pDatabase, ":", App.KY_SHIFT)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_UNDERSCORE, App.KY_SLASH, pDatabase, "_", App.KY_SHIFT)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SHARP_S, App.KY_MINUS, pDatabase, "SHARP S", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_ACUTE_ACCENT, App.KY_EQUALS, pDatabase, "ACUTE ACCENT", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_U_DIAERESIS, App.KY_OPEN_BRACKET, pDatabase, "u DIAERESIS", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_PLUS, App.KY_CLOSE_BRACKET, pDatabase, "+", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_O_DIAERESIS, App.KY_SEMICOLON, pDatabase, "o DIAERESIS", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_A_DIAERESIS, App.KY_QUOTE, pDatabase, "a DIAERESIS", App.KY_CTRL)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_NUMBER_SIGN, App.KY_EU_RIGHT, pDatabase, "#", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CTRL_Y, App.KY_Z, pDatabase, "CTRL-Y", App.KY_CTRL)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_MINUS, App.KY_SLASH, pDatabase, "-", App.KY_CTRL)
	...
	# Map the first row
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_POWER_2, App.KY_2, pDatabase, "^2", App.KY_ALTGR)
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_POWER_3, App.KY_3, pDatabase, "^3", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_OPEN, App.KY_7, pDatabase, "{", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_OPEN_BRACKET, App.KY_8, pDatabase, "[", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CLOSE_BRACKET, App.KY_9, pDatabase, "]", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_CURLY_BRACE_CLOSE, App.KY_0, pDatabase, "}", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_BACKSLASH, App.KY_MINUS, pDatabase, "\\", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_AT_SIGN, App.KY_Q, pDatabase, "@", App.KY_ALTGR)
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_EURO_SIGN, App.KY_E, pDatabase, "Euro Sign", App.KY_ALTGR)
	App.g_kInputManager.RegisterUnicodeKey(App.WC_TILDE, App.KY_CLOSE_BRACKET, pDatabase, "~", App.KY_ALTGR)
	...
	App.g_kInputManager.RegisterUnicodeKey(App.WC_SEPARATOR, App.KY_EU_LEFT, pDatabase, "|", App.KY_ALTGR)
#	App.g_kInputManager.RegisterUnicodeKey(App.WC_MICRO_SIGN, App.KY_M, pDatabase, "Micro Sign", App.KY_ALTGR)
