...
def CreateAI(pShip, *lsTargets):
	...
	Target1 = pAllTargetsGroup.GetNameTuple()[0]
	#########################################
	...
	#########################################
	#########################################
	# Creating PriorityListAI PriorityList at (35, 243)
	...
	#########################################
	#########################################
	# Creating PreprocessingAI SelectTarget at (35, 317)
	## Setup:
	import AI.Preprocessors
	pSelectionPreprocess = AI.Preprocessors.MultSelectTarget(pAllTargetsGroup)
	pSelectionPreprocess.ForceCurrentTargetString(Target1)
	## The PreprocessingAI:
