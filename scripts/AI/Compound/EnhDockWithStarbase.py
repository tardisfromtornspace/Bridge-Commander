...
#	Disabling this now...since we're not in a cutscene it's bad to suddenly teleport the ship across the set
#
#	vZero = App.TGPoint3()
#	vZero.SetXYZ(0, 0, 0)
...
#		debug("Tried to dock with a starbase with no docking point: " + str(pStarbase.GetName()))
	...
	#########################################
	#########################################
	# Creating PlainAI SetupDockPositions at (31, 97)
	...
	#########################################
	#########################################
	# Creating PlainAI EnterStarbase at (161, 235)
