...
def CreateAI(pShip, *lpTargets, **dKeywords):
	...
	pBuilderAI.AddAIBlock("StationaryAttack_2", "BuilderCreate3")
	pBuilderAI.AddAIBlock("EvadeTorps_2", "BuilderCreate4")
	...
	pBuilderAI.AddAIBlock("StillClose", "BuilderCreate11")
	...
	pBuilderAI.AddAIBlock("SlowRearTorpRun", "BuilderCreate12")
	pBuilderAI.AddDependencyObject("SlowRearTorpRun", "sInitialTarget", sInitialTarget)
	pBuilderAI.AddAIBlock("PriorityList_3", "BuilderCreate13")
	pBuilderAI.AddDependency("PriorityList_3", "StillClose")
	pBuilderAI.AddDependency("PriorityList_3", "SlowRearTorpRun")
	pBuilderAI.AddAIBlock("RearTorpsReadySortaCloseNotInterruptable", "BuilderCreate14")
	...
	pBuilderAI.AddAIBlock("ICOMoveAround", "BuilderCreate15")
	...
	pBuilderAI.AddAIBlock("CloseRangePriorities", "BuilderCreate16")
	pBuilderAI.AddDependency("CloseRangePriorities", "StationaryAttack_2")
	...
	pBuilderAI.AddAIBlock("FireAll", "BuilderCreate17")
	...
	pBuilderAI.AddAIBlock("CloseRange", "BuilderCreate18")
	...
	pBuilderAI.AddAIBlock("StationaryAttack_3", "BuilderCreate19")
	...
	pBuilderAI.AddDependency("MidRangePriorities", "StationaryAttack_3")
...
def BuilderCreate2(pShip):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate3(pShip):
	########## AI Builder End ##########
	#########################################
	# Creating PlainAI StationaryAttack_2 at (42, 259)
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate4(pShip, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate5(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate6(pShip, pTorpRun_2, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate7(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate8(pShip, pNoStopping, pStationaryAttack):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate9(pShip, pPriorityList_2, dKeywords):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate10(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate11(pShip, pRearTorpRun, fCloseRange, sInitialTarget):
	########## AI Builder End ##########
	#########################################
...
def BuilderCreate12(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate13(pShip, pStillClose, pSlowRearTorpRun):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate14(pShip, pPriorityList_3, fCloseRange, fMidRange, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate15(pShip, dKeywords, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate16(pShip, pStationaryAttack_2, pEvadeTorps_2, pFwdTorpsOrPulseReady, pRearTorpsReadySortaCloseNotInterruptable, pICOMoveAround):
	########## AI Builder End ##########
	#########################################
	...
	pCloseRangePriorities.AddAI(pStationaryAttack_2, 1)
	pCloseRangePriorities.AddAI(pEvadeTorps_2, 2)
	pCloseRangePriorities.AddAI(pFwdTorpsOrPulseReady, 3)
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate17(pShip, pCloseRangePriorities, sInitialTarget, dKeywords):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate18(pShip, pFireAll, fCloseRange, sInitialTarget):
	########## AI Builder End ##########
	#########################################
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate19(pShip):
	########## AI Builder End ##########
	#########################################
	# Creating PlainAI StationaryAttack_3 at (676, 285)
	pStationaryAttack_3 = App.PlainAI_Create(pShip, "StationaryAttack_3")
	pStationaryAttack_3.SetScriptModule("StationaryAttack")
	pStationaryAttack_3.SetInterruptable(1)
	pScript = pStationaryAttack_3.GetScriptInstance()
	pScript.SetTargetObjectName(sInitialTarget)
	# Done creating PlainAI StationaryAttack_3
	#########################################
	######### AI Builder Begin #########
	return pStationaryAttack_3  # Builder Return
	########## AI Builder End ##########
	######### AI Builder Begin #########
...
def BuilderCreate25(pShip, sInitialTarget):
	...
	########## AI Builder End ##########
	######### AI Builder Begin #########
def BuilderCreate26(pShip, pStationaryAttack_3, pEvadeTorps_3, pFwdTorpsOrPulseReady_2, pFwdShieldsLow, pFollow):
	########## AI Builder End ##########
	#########################################
	...
	pMidRangePriorities.AddAI(pStationaryAttack_3, 1)
	pMidRangePriorities.AddAI(pEvadeTorps_3, 2)
	pMidRangePriorities.AddAI(pFwdTorpsOrPulseReady_2, 3)
	pMidRangePriorities.AddAI(pFwdShieldsLow, 4)
	pMidRangePriorities.AddAI(pFollow, 5)
