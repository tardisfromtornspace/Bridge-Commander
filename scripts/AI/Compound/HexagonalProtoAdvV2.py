...
def CreateAI(pShip):
	...
	pBattleShieldsUp = AI.Compound.BSGAttackShieldsUP.CreateAI(pShip, *lpTargets, **dKeywords)
	...
	pBattleShieldsDown = AI.Compound.BSGAttackShieldsDOWN.CreateAI(pShip, *lpTargets, **dKeywords)
