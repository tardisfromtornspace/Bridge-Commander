...
#                                                                                     #
Foundation.ShipDef.GalacticaClosed = Foundation.FedShipDef(abbrev, species, { 'iconName': GalacticaClosed, 'shipFile': GalacticaClosed })
#                                                                                     #
...
#                                                                                     #
Foundation.ShipDef.GalacticaClosed.desc = 'From the Twelve Colonies of Kobol'
#                                                                                     #
#######################################################################################
#                                                                                     #
