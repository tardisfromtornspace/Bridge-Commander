...
MvamShips = ["MvamVoyager", "MvamVoyagerSep", "MvamDeltaFlyer"]
...
IconNames = ["Voyager Seperate", "DeltaFlyer Seperate", "Reintegrate$Rein"]
...
MvamDistances[1].SetXYZ(0.0, -1.3, 0.0)
...
MvamDirections[0].SetXYZ(0.0, 8.0, -0.1)
MvamDirections[1].SetXYZ(-1.0, -3.0, 0.5)
...
MvamReinDistances[1].SetXYZ(0.0, -5.0, 0.0)
...
MvamReinDirections[0].SetXYZ(0.0, 0.0, 0.0)
MvamReinDirections[1].SetXYZ(0.0, 0.4, -0.007)
...
def MvamVoyagerSep(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def. (ie: "MvamGalaxySaucer")
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MvamVoyagerSep")
...
def MvamDeltaFlyer(pObject, pEvent):
...
###TO CHANGE: change the last word in quotes in the next line to the name of the def
		Custom.Sneaker.Mvam.Seperation.Seperation(snkMvamModule, "MvamDeltaFlyer")
